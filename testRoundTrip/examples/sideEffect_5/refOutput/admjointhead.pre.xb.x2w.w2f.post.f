...
C adjoint
      ...
      do while (INT(OpenAD_Symbol_3).LE.INT(OpenAD_Symbol_2))
        ...
        OpenAD_prop_0%d = OpenAD_prop_0%d+A(INT(OpenAD_Symbol_14))%d*(2.
     +0D00)
        A(INT(OpenAD_Symbol_14))%d = 0.0d0
        A(INT(OpenAD_Symbol_14))%d = A(INT(OpenAD_Symbol_14))%d+OpenAD_p
     +rop_0%d
...
C adjoint
      ...
      do while (INT(OpenAD_Symbol_9).LE.INT(OpenAD_Symbol_8))
        ...
        X(INT(OpenAD_Symbol_15))%d = X(INT(OpenAD_Symbol_15))%d+Y(1)%d
        Y(1)%d = 0.0d0
