...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_92)
          ...
          CALL sax(OpenAD_Symbol_83, __deriv__(PTL), __deriv__(FVEC(K))
     > )
          CALL saxpy(OpenAD_Symbol_84, __deriv__(P), __deriv__(FVEC(K))
     > )
          CALL saxpy(OpenAD_Symbol_85, __deriv__(PBR), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_86, __deriv__(P), __deriv__(FVEC(K))
     > )
          CALL saxpy(OpenAD_Symbol_87, __deriv__(PL), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_88, __deriv__(PB), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_89, __deriv__(PLL), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_90, __deriv__(PBL), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_91, __deriv__(PBL), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_92, __deriv__(PBB), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_83, __deriv__(PTR), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_84, __deriv__(PTT), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_85, __deriv__(PTR), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_86, __deriv__(PRR), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_87, __deriv__(PR), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_88, __deriv__(PT), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_89, __deriv__(P), __deriv__(FVEC(K))
     > )
          CALL saxpy(OpenAD_Symbol_90, __deriv__(PTL), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_91, __deriv__(PBR), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_92, __deriv__(P), __deriv__(FVEC(K))
     > )
          CALL saxpy(OpenAD_Symbol_95, __deriv__(PT), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_96, __deriv__(PT), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_97, __deriv__(PR), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_98, __deriv__(PR), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_99, __deriv__(P), __deriv__(FVEC(K))
     > )
          CALL saxpy(OpenAD_Symbol_100, __deriv__(P), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_101, __deriv__(PL), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_102, __deriv__(PL), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_103, __deriv__(PB), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_104, __deriv__(PB), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_93, __deriv__(PR), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_105, __deriv__(PL), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_94, __deriv__(PT), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_106, __deriv__(PB), __deriv__(FVEC(K
     > )))
        END DO
      END DO
      END SUBROUTINE
