...
C$OPENAD XXX Template ad_template.f
     ...
     > )))
          CALL saxpy(OpenAD_Symbol_180, __deriv__(PT), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_181, __deriv__(PR), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_182, __deriv__(PR), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_183, __deriv__(P), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_184, __deriv__(P), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_185, __deriv__(PL), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_186, __deriv__(PL), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_187, __deriv__(PB), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_188, __deriv__(PB), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_177, __deriv__(PR), __deriv__(FVEC(K
     > )))
          CALL saxpy(OpenAD_Symbol_189, __deriv__(PL), __deriv__(FVEC(K
     > )))
