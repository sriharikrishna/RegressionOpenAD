...
C$OPENAD XXX Template ad_template.f
      ...
      IF(ALLOCATED(A)) THEN
        ...
        OpenAD_Symbol_2 = __value__(A(2))
        OpenAD_Symbol_3 = __value__(A(1))
        CALL sax(OpenAD_Symbol_2, __deriv__(A(1)), __deriv__(Y(1)))
        CALL saxpy(OpenAD_Symbol_3, __deriv__(A(2)), __deriv__(Y(1)))
      ELSE
        __value__(Y(1)) = 0
