...
C     $OpenAD$ INLINE push_i(subst)
      ...
      GO TO 16
16    CONTINUE
      OpenAD_Symbol_4 = (__value__(X(1)) * 3.0D00)
      __value__(X(1)) = OpenAD_Symbol_4
      GO TO 17
17    CONTINUE
...
C     $OpenAD$ INLINE push_i(subst)
      ...
      GO TO 18
18    CONTINUE
      OpenAD_Symbol_6 = (__value__(X(1)) * 2.0D00)
      __value__(X(1)) = OpenAD_Symbol_6
      GO TO 19
19    CONTINUE
...
C     $OpenAD$ INLINE pop_i(subst)
      ...
      DO WHILE(INT(OpenAD_Symbol_13) .ne. INT(0_w2f__i8))
        IF ( OpenAD_Symbol_13  .EQ.  1)  GO TO  44
        IF ( OpenAD_Symbol_13  .EQ.  2)  GO TO  45
        IF ( OpenAD_Symbol_13  .EQ.  3)  GO TO  46
        IF ( OpenAD_Symbol_13  .EQ.  4)  GO TO  47
        IF ( OpenAD_Symbol_13  .EQ.  5)  GO TO  48
44      CONTINUE
        GO TO 41
45      CONTINUE
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_prop_1))
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_22, __deriv__(X(1)), __deriv__(
     > OpenAD_prop_0))
...
C     $OpenAD$ INLINE pop_i(subst)
      ...
      DO WHILE(INT(OpenAD_Symbol_20) .ne. INT(0_w2f__i8))
        IF ( OpenAD_Symbol_20  .EQ.  1)  GO TO  167
        IF ( OpenAD_Symbol_20  .EQ.  2)  GO TO  168
        IF ( OpenAD_Symbol_20  .EQ.  3)  GO TO  169
        IF ( OpenAD_Symbol_20  .EQ.  4)  GO TO  170
        IF ( OpenAD_Symbol_20  .EQ.  5)  GO TO  171
167     CONTINUE
        GO TO 164
168     CONTINUE
C       $OpenAD$ INLINE Pop(subst)
