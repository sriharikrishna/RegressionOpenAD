...
C$OPENAD XXX Template ad_template.f
     ...
     > )
      ...
      CALL sax(1_w2f__i8,F,OpenAD_Symbol_22)
      CALL saxpy(-1_w2f__i8,A,OpenAD_Symbol_22)
      CALL sax(1_w2f__i8,D,OpenAD_Symbol_23)
      CALL saxpy(-1_w2f__i8,A,OpenAD_Symbol_23)
