...
C$OPENAD XXX Template ad_template.f
     ...
     >  __value__(E))
      ...
      CALL setderiv(__deriv__(OpenAD_Symbol_22), __deriv__(F))
      CALL dec_deriv(__deriv__(OpenAD_Symbol_22), __deriv__(A))
      CALL setderiv(__deriv__(OpenAD_Symbol_23), __deriv__(D))
      CALL dec_deriv(__deriv__(OpenAD_Symbol_23), __deriv__(A))
