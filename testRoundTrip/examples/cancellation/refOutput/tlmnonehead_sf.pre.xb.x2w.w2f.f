...
C$OPENAD XXX Template ad_template.f
      OpenAD_lin_0 = (__value__(X1) / __value__(X2))
      __value__(A) = (1.0D00 / OpenAD_lin_0)
      OpenAD_lin_3 = (INT(1_w2f__i8) / __value__(X2))
      OpenAD_lin_4 = (-(__value__(X1) /(__value__(X2) * __value__(X2)))
     > )
      OpenAD_lin_2 = (-(1.0D00 /(OpenAD_lin_0 * OpenAD_lin_0)))
      __value__(B) = (__value__(X2) * __value__(A))
      OpenAD_lin_5 = __value__(A)
      OpenAD_lin_6 = __value__(X2)
      ...
      CALL sax(OpenAD_lin_5, __deriv__(X2), __deriv__(B))
      CALL saxpy(OpenAD_lin_6, __deriv__(A), __deriv__(B))
      OpenAD_dly_0 = SIN(__value__(C))
      OpenAD_lin_7 = COS(__value__(C))
      __value__(C) = OpenAD_dly_0
      __value__(D) = __value__(A)
      __value__(F) = __value__(A)
      CALL setderiv(__deriv__(OpenAD_prp_0), __deriv__(C))
      CALL sax(OpenAD_lin_7, __deriv__(OpenAD_prp_0), __deriv__(C))
      CALL setderiv(__deriv__(D), __deriv__(A))
      CALL setderiv(__deriv__(F), __deriv__(A))
      OpenAD_lin_8 = (__value__(F) - __value__(A))
      __value__(F) = (OpenAD_lin_8 * 5.0D-01)
      OpenAD_lin_10 = (__value__(D) - __value__(A))
      __value__(E) = (OpenAD_lin_10 * 5.0D-01)
      __value__(Y) = (__value__(B) * __value__(F) + __value__(C) *
     >  __value__(E))
      OpenAD_lin_12 = __value__(F)
      OpenAD_lin_13 = __value__(B)
      OpenAD_lin_14 = __value__(E)
      OpenAD_lin_15 = __value__(C)
      ...
      CALL sax(OpenAD_lin_12, __deriv__(B), __deriv__(Y))
      CALL saxpy(OpenAD_acc_2, __deriv__(OpenAD_prp_1), __deriv__(Y))
      CALL saxpy(OpenAD_lin_14, __deriv__(C), __deriv__(Y))
