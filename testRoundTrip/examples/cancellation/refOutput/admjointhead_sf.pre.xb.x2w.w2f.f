...
C$OPENAD XXX Template ad_template.f
      OpenAD_tmp_0 = (__value__(X1) / __value__(X2))
      __value__(A) = (1.0D00 / OpenAD_tmp_0)
      OpenAD_lin_2 = (INT(1_w2f__i8) / __value__(X2))
      OpenAD_lin_3 = (-(__value__(X1) /(__value__(X2) * __value__(X2)))
     > )
      OpenAD_lin_1 = (-(1.0D00 /(OpenAD_tmp_0 * OpenAD_tmp_0)))
      __value__(B) = (__value__(X2) * __value__(A))
      OpenAD_lin_4 = __value__(A)
      OpenAD_lin_5 = __value__(X2)
      __value__(C) = __value__(X2)
...
C     $OpenAD$ INLINE push(subst)
      ...
      OpenAD_Symbol_0 = SIN(__value__(C))
      OpenAD_lin_6 = COS(__value__(C))
      __value__(C) = OpenAD_Symbol_0
      __value__(D) = __value__(A)
      __value__(F) = __value__(A)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_6)
      OpenAD_tmp_1 = (__value__(F) - __value__(A))
      __value__(F) = (OpenAD_tmp_1 * 5.0D-01)
      OpenAD_tmp_2 = (__value__(D) - __value__(A))
      __value__(E) = (OpenAD_tmp_2 * 5.0D-01)
      __value__(Y) = (__value__(B) * __value__(F) + __value__(C) *
     >  __value__(E))
      OpenAD_lin_9 = __value__(F)
      OpenAD_lin_10 = __value__(B)
      OpenAD_lin_11 = __value__(E)
      OpenAD_lin_12 = __value__(C)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_1, __deriv__(Y), __deriv__(OpenAD_prop_2
     > ))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_2, __deriv__(Y), __deriv__(C))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_3, __deriv__(Y), __deriv__(OpenAD_prop_1
     > ))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_4, __deriv__(Y), __deriv__(B))
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_5, __deriv__(C), __deriv__(OpenAD_prop_0
     > ))
C     $OpenAD$ INLINE ZeroDeriv(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_6, __deriv__(B), __deriv__(A))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_7, __deriv__(B), __deriv__(X2))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(B))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_8, __deriv__(A), __deriv__(X2))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_9, __deriv__(A), __deriv__(X1))
C     $OpenAD$ INLINE ZeroDeriv(subst)
