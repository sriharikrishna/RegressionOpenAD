...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_8, __deriv__(Y(J)), __deriv__(X(I)))
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_9, __deriv__(Y(J)), __deriv__(X(I)))
C       $OpenAD$ INLINE IncDeriv(subst,subst)
        CALL IncDeriv(__deriv__(Y(J)), __deriv__(OpenAD_Symbol_2))
C       $OpenAD$ INLINE ZeroDeriv(subst)
        CALL ZeroDeriv(__deriv__(Y(J)))
C       $OpenAD$ INLINE IncDeriv(subst,subst)
        CALL IncDeriv(__deriv__(OpenAD_Symbol_2), __deriv__(Y(J)))
C       $OpenAD$ INLINE ZeroDeriv(subst)
...
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_9)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_8, __deriv__(Y(INT(OpenAD_Symbol_7))),
     >  __deriv__(X(INT(OpenAD_Symbol_6))))
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_9, __deriv__(Y(INT(OpenAD_Symbol_7))),
     >  __deriv__(X(INT(OpenAD_Symbol_6))))
C       $OpenAD$ INLINE IncDeriv(subst,subst)
        CALL IncDeriv(__deriv__(Y(INT(OpenAD_Symbol_7))), __deriv__(
     > OpenAD_Symbol_2))
C       $OpenAD$ INLINE ZeroDeriv(subst)
        CALL ZeroDeriv(__deriv__(Y(INT(OpenAD_Symbol_7))))
C       $OpenAD$ INLINE IncDeriv(subst,subst)
        CALL IncDeriv(__deriv__(OpenAD_Symbol_2), __deriv__(Y(INT(
     > OpenAD_Symbol_7))))
C       $OpenAD$ INLINE ZeroDeriv(subst)
        CALL ZeroDeriv(__deriv__(OpenAD_Symbol_2))
