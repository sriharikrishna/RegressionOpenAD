...
C$OPENAD XXX Template ad_template.f
      ...
      OpenAD_lin_1 = SQRT3
      MATR2%v = (X05%v-X04%v)
      OpenAD_lin_2 = (X06%v*2.0D00-X05%v-X04%v)
     ...
     +_lin_26)
      ...
      OpenAD_lin_120 = (G_OBJ2%v*2.0D00-G_OBJ1%v-G_OBJ2%v)
      MATR1%v = (SQRT3*OpenAD_lin_120)
      OpenAD_lin_121 = SQRT3
      MATR2%v = (G_OBJ4%v-G_OBJ3%v)
      OpenAD_lin_122 = (G_OBJ5%v*2.0D00-G_OBJ4%v-G_OBJ3%v)
      MATR3%v = (SQRT3*OpenAD_lin_122)
      OpenAD_lin_123 = SQRT3
      M03%v = (MATR0%v*MATR3%v)
      OpenAD_lin_124 = MATR3%v
      OpenAD_lin_125 = MATR0%v
      M12%v = (MATR1%v*MATR2%v)
      OpenAD_lin_126 = MATR2%v
      OpenAD_lin_127 = MATR1%v
      G%v = (M03%v-M12%v)
      D00%v = (M03%v*2.0D00)
      D11%v = (M12%v*2.0D00)
      M00%v = (MATR0%v*MATR0%v)
      OpenAD_lin_128 = MATR0%v
      OpenAD_lin_129 = MATR0%v
      M11%v = (MATR1%v*MATR1%v)
      OpenAD_lin_130 = MATR1%v
      OpenAD_lin_131 = MATR1%v
      M22%v = (MATR2%v*MATR2%v)
      OpenAD_lin_132 = MATR2%v
      OpenAD_lin_133 = MATR2%v
      M33%v = (MATR3%v*MATR3%v)
      OpenAD_lin_134 = MATR3%v
      OpenAD_lin_135 = MATR3%v
      D12%v = (M00%v*M33%v)
      OpenAD_lin_136 = M33%v
      OpenAD_lin_137 = M00%v
      D03%v = (M11%v*M22%v)
      OpenAD_lin_138 = M22%v
      OpenAD_lin_139 = M11%v
      ...
      CALL sax(OpenAD_lin_119,OpenAD_prp_12,F)
      ...
      CALL sax(OpenAD_lin_121,OpenAD_prp_13,MATR1)
      CALL sax(OpenAD_lin_123,OpenAD_prp_14,MATR3)
      CALL sax(OpenAD_lin_124,MATR0,M03)
      CALL saxpy(OpenAD_lin_125,MATR3,M03)
      CALL sax(OpenAD_lin_126,MATR1,M12)
      CALL saxpy(OpenAD_lin_127,MATR2,M12)
      CALL setderiv(G,M03)
      CALL dec_deriv(G,M12)
      CALL sax(2.0D00,M03,D00)
      CALL sax(2.0D00,M12,D11)
      ...
      CALL sax(OpenAD_lin_136,M00,D12)
      CALL saxpy(OpenAD_lin_137,M33,D12)
      CALL sax(OpenAD_lin_138,M11,D03)
      CALL saxpy(OpenAD_lin_139,M22,D03)
      F%v = (D03%v+D12%v)
      OpenAD_lin_140 = (1.0D00/G%v)
      LOC1%v = (A*OpenAD_lin_140)
      OpenAD_lin_142 = (-(1.0D00/(G%v*G%v)))
      OpenAD_lin_141 = A
      OBJ%v = (F%v*LOC1%v)
      OpenAD_lin_143 = LOC1%v
      OpenAD_lin_144 = F%v
      OpenAD_lin_147 = (G%v*G%v)
      OpenAD_lin_145 = (1.0D00/OpenAD_lin_147)
      LOC2%v = (AB*OpenAD_lin_145)
      OpenAD_lin_149 = G%v
      OpenAD_lin_150 = G%v
      OpenAD_lin_148 = (-(1.0D00/(OpenAD_lin_147*OpenAD_lin_147)))
      OpenAD_lin_146 = AB
      OpenAD_lin_151 = (AB*B)
      OpenAD_lin_156 = (G%v*G%v)
      OpenAD_lin_154 = (G%v*OpenAD_lin_156)
      OpenAD_lin_152 = (1.0D00/OpenAD_lin_154)
      GG%v = (OpenAD_lin_151*OpenAD_lin_152)
      ...
      OpenAD_acc_23 = ((OpenAD_lin_157+(OpenAD_lin_159+OpenAD_lin_160)*O
     +penAD_lin_158)*OpenAD_lin_155*OpenAD_lin_153)
      OpenAD_acc_24 = ((OpenAD_lin_149+OpenAD_lin_150)*OpenAD_lin_148*Op
     +enAD_lin_146)
      CALL setderiv(OpenAD_prp_15,G)
      CALL setderiv(F,D03)
      CALL inc_deriv(F,D12)
      CALL sax(OpenAD_acc_22,OpenAD_prp_15,LOC1)
      CALL sax(OpenAD_lin_143,F,OBJ)
      CALL saxpy(OpenAD_lin_144,LOC1,OBJ)
      CALL sax(OpenAD_acc_24,OpenAD_prp_15,LOC2)
      CALL sax(OpenAD_lin_161,F,G)
      CALL saxpy(OpenAD_lin_162,LOC2,G)
      CALL sax(OpenAD_acc_23,OpenAD_prp_15,GG)
      F%v = (LOC1%v*2.0D00)
      ADJ_M0%v = (F%v*MATR0%v+G%v*MATR3%v)
      OpenAD_lin_163 = MATR0%v
      OpenAD_lin_164 = F%v
      OpenAD_lin_165 = MATR3%v
      OpenAD_lin_166 = G%v
      ADJ_M1%v = (F%v*MATR1%v-G%v*MATR2%v)
      OpenAD_lin_167 = MATR1%v
      OpenAD_lin_168 = F%v
      OpenAD_lin_169 = MATR2%v
      OpenAD_lin_170 = G%v
      ADJ_M2%v = (F%v*MATR2%v-G%v*MATR1%v)
      OpenAD_lin_171 = MATR2%v
      OpenAD_lin_172 = F%v
      OpenAD_lin_173 = MATR1%v
      OpenAD_lin_174 = G%v
      ADJ_M3%v = (F%v*MATR3%v+G%v*MATR0%v)
      OpenAD_lin_175 = MATR3%v
      OpenAD_lin_176 = F%v
      OpenAD_lin_177 = MATR0%v
      OpenAD_lin_178 = G%v
      LOC1%v = (ADJ_M1%v*SQRT3)
      ...
      CALL sax(OpenAD_lin_164,MATR0,ADJ_M0)
      CALL saxpy(OpenAD_acc_25,OpenAD_prp_16,ADJ_M0)
      CALL saxpy(OpenAD_lin_165,G,ADJ_M0)
      CALL saxpy(OpenAD_lin_166,MATR3,ADJ_M0)
      CALL sax(OpenAD_lin_168,MATR1,ADJ_M1)
      CALL saxpy(OpenAD_acc_26,OpenAD_prp_16,ADJ_M1)
      CALL saxpy(OpenAD_acc_27,G,ADJ_M1)
      CALL saxpy(OpenAD_acc_28,MATR2,ADJ_M1)
      CALL sax(OpenAD_lin_172,MATR2,ADJ_M2)
      CALL saxpy(OpenAD_acc_29,OpenAD_prp_16,ADJ_M2)
      CALL saxpy(OpenAD_acc_30,G,ADJ_M2)
      CALL saxpy(OpenAD_acc_31,MATR1,ADJ_M2)
      CALL sax(OpenAD_lin_176,MATR3,ADJ_M3)
      CALL saxpy(OpenAD_acc_32,OpenAD_prp_16,ADJ_M3)
      CALL saxpy(OpenAD_lin_177,G,ADJ_M3)
      CALL saxpy(OpenAD_lin_178,MATR0,ADJ_M3)
      CALL sax(OpenAD_lin_179,ADJ_M1,LOC1)
      ...
      LOC2%v = (LOC2%v*2.0D00)
      R00%v = (D00%v*LOC2%v+GG%v*M33%v)
      OpenAD_lin_181 = LOC2%v
      OpenAD_lin_182 = D00%v
      OpenAD_lin_183 = M33%v
      OpenAD_lin_184 = GG%v
      R11%v = (D11%v*LOC2%v+GG%v*M22%v)
      OpenAD_lin_185 = LOC2%v
      OpenAD_lin_186 = D11%v
      OpenAD_lin_187 = M22%v
      OpenAD_lin_188 = GG%v
      R22 = (D11%v*LOC2%v+GG%v*M11%v)
      R33 = (D00%v*LOC2%v+GG%v*M00%v)
      M01%v = (MATR0%v*MATR1%v)
      OpenAD_lin_189 = MATR1%v
      OpenAD_lin_190 = MATR0%v
      M02%v = (MATR0%v*MATR2%v)
      OpenAD_lin_191 = MATR2%v
      OpenAD_lin_192 = MATR0%v
      M12%v = (MATR1%v*MATR2%v)
      OpenAD_lin_193 = MATR2%v
      OpenAD_lin_194 = MATR1%v
      M13%v = (MATR1%v*MATR3%v)
      OpenAD_lin_195 = MATR3%v
      OpenAD_lin_196 = MATR1%v
      M23%v = (MATR2%v*MATR3%v)
      OpenAD_lin_197 = MATR3%v
      OpenAD_lin_198 = MATR2%v
      OpenAD_lin_199 = (M02%v+M13%v)
      D01%v = (LOC2%v*OpenAD_lin_199)
      OpenAD_lin_200 = OpenAD_lin_199
      OpenAD_lin_201 = LOC2%v
      ...
      CALL sax(OpenAD_lin_180,ADJ_M3,LOC1)
      CALL sax(2.0D00,OpenAD_prp_22,LOC2)
      CALL sax(OpenAD_lin_189,MATR0,M01)
      CALL saxpy(OpenAD_lin_190,MATR1,M01)
      CALL sax(OpenAD_lin_191,MATR0,M02)
      CALL saxpy(OpenAD_lin_192,MATR2,M02)
      CALL sax(OpenAD_lin_193,MATR1,M12)
      CALL saxpy(OpenAD_lin_194,MATR2,M12)
      CALL sax(OpenAD_lin_195,MATR1,M13)
      CALL saxpy(OpenAD_lin_196,MATR3,M13)
      CALL sax(OpenAD_lin_197,MATR2,M23)
      CALL saxpy(OpenAD_lin_198,MATR3,M23)
      ...
      CALL sax(OpenAD_lin_181,D00,R00)
      CALL saxpy(OpenAD_lin_182,LOC2,R00)
      CALL saxpy(OpenAD_lin_183,GG,R00)
      CALL saxpy(OpenAD_lin_184,M33,R00)
      CALL sax(OpenAD_lin_185,D11,R11)
      CALL saxpy(OpenAD_lin_186,LOC2,R11)
      CALL saxpy(OpenAD_lin_187,GG,R11)
      CALL saxpy(OpenAD_lin_188,M22,R11)
      CALL sax(OpenAD_lin_200,LOC2,D01)
      CALL saxpy(OpenAD_lin_201,OpenAD_prp_23,D01)
      LOC1%v = (R11%v*THIRD)
      OpenAD_lin_202 = THIRD
      OpenAD_lin_203 = (D01%v+GG%v*M23%v)
      F%v = (TWOSQRT3*OpenAD_lin_203)
      OpenAD_lin_205 = M23%v
      OpenAD_lin_206 = GG%v
      ...
      CALL sax(OpenAD_lin_202,R11,LOC1)
      CALL setderiv(G,LOC1)
      CALL inc_deriv(G,R00)
      CALL setderiv(OpenAD_prp_27,D01)
      CALL saxpy(OpenAD_lin_205,GG,OpenAD_prp_27)
      CALL saxpy(OpenAD_lin_206,M23,OpenAD_prp_27)
      CALL setderiv(H_OBJ1,OpenAD_prp_24)
      CALL inc_deriv(H_OBJ1,LOC1)
      CALL dec_deriv(H_OBJ1,R00)
      CALL sax(OpenAD_lin_204,OpenAD_prp_27,F)
      CALL setderiv(H_OBJ0,F)
      CALL inc_deriv(H_OBJ0,G)
      ...
      CALL saxpy(OpenAD_lin_208,R11,H_OBJ5)
      ...
      OpenAD_lin_210 = (D01%v+GG%v*M01%v)
      F%v = (TWOSQRT3*OpenAD_lin_210)
      OpenAD_lin_212 = M01%v
      OpenAD_lin_213 = GG%v
      ...
      CALL sax(OpenAD_lin_209,R00,LOC1)
      CALL setderiv(G,LOC1)
      CALL inc_deriv(G,R11)
      CALL setderiv(OpenAD_prp_34,D01)
      CALL saxpy(OpenAD_lin_212,GG,OpenAD_prp_34)
      CALL saxpy(OpenAD_lin_213,M01,OpenAD_prp_34)
      CALL setderiv(H_OBJ16,OpenAD_prp_31)
      CALL inc_deriv(H_OBJ16,LOC1)
      CALL dec_deriv(H_OBJ16,R11)
      CALL sax(OpenAD_lin_211,OpenAD_prp_34,F)
      CALL setderiv(H_OBJ15,F)
      CALL inc_deriv(H_OBJ15,G)
      ...
      CALL saxpy(OpenAD_lin_215,R00,H_OBJ20)
      ...
      CALL inc_deriv(H_OBJ19,LOC1)
      OpenAD_lin_216 = (M01%v+M23%v)
      LOC1%v = (LOC2%v*OpenAD_lin_216)
      OpenAD_lin_217 = OpenAD_lin_216
      OpenAD_lin_218 = LOC2%v
      R13%v = (LOC1%v+GG%v*M02%v)
      OpenAD_lin_219 = M02%v
      OpenAD_lin_220 = GG%v
      R02%v = (LOC1%v+GG%v*M13%v)
      OpenAD_lin_221 = M13%v
      OpenAD_lin_222 = GG%v
      R03%v = (D03%v*LOC2%v+GG%v*M03%v)
      OpenAD_lin_223 = LOC2%v
      OpenAD_lin_224 = D03%v
      OpenAD_lin_225 = M03%v
      OpenAD_lin_226 = GG%v
      R12%v = (D12%v*LOC2%v+GG%v*M12%v)
      OpenAD_lin_227 = LOC2%v
      OpenAD_lin_228 = D12%v
      OpenAD_lin_229 = M12%v
      OpenAD_lin_230 = GG%v
      G%v = (-(R13%v*TWO3RD))
      ...
      CALL sax(OpenAD_lin_217,LOC2,LOC1)
      CALL saxpy(OpenAD_lin_218,OpenAD_prp_40,LOC1)
      CALL setderiv(R13,LOC1)
      CALL saxpy(OpenAD_lin_219,GG,R13)
      CALL saxpy(OpenAD_lin_220,M02,R13)
      CALL setderiv(R02,LOC1)
      CALL saxpy(OpenAD_lin_221,GG,R02)
      CALL saxpy(OpenAD_lin_222,M13,R02)
      CALL sax(OpenAD_lin_223,D03,R03)
      CALL saxpy(OpenAD_lin_224,LOC2,R03)
      CALL saxpy(OpenAD_lin_225,GG,R03)
      CALL saxpy(OpenAD_lin_226,M03,R03)
      CALL sax(OpenAD_lin_227,D12,R12)
      CALL saxpy(OpenAD_lin_228,LOC2,R12)
      CALL saxpy(OpenAD_lin_229,GG,R12)
      CALL saxpy(OpenAD_lin_230,M12,R12)
      CALL sax(OpenAD_lin_232,R03,F)
      ...
      CALL sax(OpenAD_lin_233,R12,F)
      CALL sax(OpenAD_lin_234,R02,G)
      ...
      OpenAD_lin_235 = (R03%v+R12%v)
      F%v = (SQRT3*OpenAD_lin_235)
      ...
      CALL sax(OpenAD_lin_237,R02,G)
      CALL sax(OpenAD_lin_236,OpenAD_prp_48,F)
      ...
      OpenAD_lin_238 = (R03%v-R12%v)
      F%v = (SQRT3*OpenAD_lin_238)
      ...
      CALL sax(OpenAD_lin_239,OpenAD_prp_49,F)
      CALL setderiv(Y15,F)
