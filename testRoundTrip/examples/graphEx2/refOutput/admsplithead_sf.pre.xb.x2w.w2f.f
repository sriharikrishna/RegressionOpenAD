...
C     $OpenAD$ INLINE push_s0(subst)
      CALL push_s0(OpenAD_lin_247)
C     $OpenAD$ INLINE push_s0(subst)
      CALL push_s0(OpenAD_lin_248)
C     $OpenAD$ INLINE push_s0(subst)
      CALL push_s0(OpenAD_lin_249)
C     $OpenAD$ INLINE push_s0(subst)
