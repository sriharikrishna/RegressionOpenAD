...
C adjoint
      ...
      F%d = F%d+Y15%d
      Y15%d = 0.0d0
      OpenAD_prop_49%d = OpenAD_prop_49%d+F%d*(OpenAD_Symbol_310)
      F%d = 0.0d0
      ...
      H_OBJ10%d = 0.0d0
      OpenAD_prop_48%d = OpenAD_prop_48%d+F%d*(OpenAD_Symbol_311)
      F%d = 0.0d0
      R02%d = R02%d+G%d*(OpenAD_Symbol_312)
      G%d = 0.0d0
      ...
      H_OBJ12%d = 0.0d0
      R02%d = R02%d+G%d*(OpenAD_Symbol_313)
      G%d = 0.0d0
      R12%d = R12%d+F%d*(OpenAD_Symbol_314)
      F%d = 0.0d0
      ...
      G%d = G%d+H_OBJ8%d
      H_OBJ8%d = 0.0d0
      R13%d = R13%d+G%d*(OpenAD_Symbol_315)
      G%d = 0.0d0
      R03%d = R03%d+F%d*(OpenAD_Symbol_316)
      F%d = 0.0d0
      M12%d = M12%d+R12%d*(OpenAD_Symbol_317)
      GG%d = GG%d+R12%d*(OpenAD_Symbol_318)
      LOC2%d = LOC2%d+R12%d*(OpenAD_Symbol_319)
      D12%d = D12%d+R12%d*(OpenAD_Symbol_320)
      R12%d = 0.0d0
      M03%d = M03%d+R03%d*(OpenAD_Symbol_321)
      GG%d = GG%d+R03%d*(OpenAD_Symbol_322)
      LOC2%d = LOC2%d+R03%d*(OpenAD_Symbol_323)
      D03%d = D03%d+R03%d*(OpenAD_Symbol_324)
      R03%d = 0.0d0
      M13%d = M13%d+R02%d*(OpenAD_Symbol_325)
      GG%d = GG%d+R02%d*(OpenAD_Symbol_326)
      LOC1%d = LOC1%d+R02%d
      R02%d = 0.0d0
      M02%d = M02%d+R13%d*(OpenAD_Symbol_327)
      GG%d = GG%d+R13%d*(OpenAD_Symbol_328)
      LOC1%d = LOC1%d+R13%d
      R13%d = 0.0d0
      OpenAD_prop_40%d = OpenAD_prop_40%d+LOC1%d*(OpenAD_Symbol_329)
      LOC2%d = LOC2%d+LOC1%d*(OpenAD_Symbol_330)
      LOC1%d = 0.0d0
      ...
      H_OBJ17%d = 0.0d0
      R00%d = R00%d+H_OBJ20%d*(OpenAD_Symbol_331)
      OpenAD_prop_37%d = OpenAD_prop_37%d+H_OBJ20%d
      H_OBJ20%d = 0.0d0
      R00%d = R00%d+LOC1%d*(OpenAD_Symbol_332)
      LOC1%d = 0.0d0
      ...
      F%d = F%d+H_OBJ15%d
      H_OBJ15%d = 0.0d0
      OpenAD_prop_34%d = OpenAD_prop_34%d+F%d*(OpenAD_Symbol_333)
      F%d = 0.0d0
      R11%d = R11%d-H_OBJ16%d
      LOC1%d = LOC1%d+H_OBJ16%d
      OpenAD_prop_31%d = OpenAD_prop_31%d+H_OBJ16%d
      H_OBJ16%d = 0.0d0
      M01%d = M01%d+OpenAD_prop_34%d*(OpenAD_Symbol_334)
      GG%d = GG%d+OpenAD_prop_34%d*(OpenAD_Symbol_335)
      D01%d = D01%d+OpenAD_prop_34%d
      OpenAD_prop_34%d = 0.0d0
      R11%d = R11%d+G%d
      LOC1%d = LOC1%d+G%d
      G%d = 0.0d0
      R00%d = R00%d+LOC1%d*(OpenAD_Symbol_336)
      LOC1%d = 0.0d0
      ...
      H_OBJ2%d = 0.0d0
      R11%d = R11%d+H_OBJ5%d*(OpenAD_Symbol_337)
      OpenAD_prop_30%d = OpenAD_prop_30%d+H_OBJ5%d
      H_OBJ5%d = 0.0d0
      R11%d = R11%d+LOC1%d*(OpenAD_Symbol_338)
      LOC1%d = 0.0d0
      ...
      F%d = F%d+H_OBJ0%d
      H_OBJ0%d = 0.0d0
      OpenAD_prop_27%d = OpenAD_prop_27%d+F%d*(OpenAD_Symbol_339)
      F%d = 0.0d0
      R00%d = R00%d-H_OBJ1%d
      LOC1%d = LOC1%d+H_OBJ1%d
      OpenAD_prop_24%d = OpenAD_prop_24%d+H_OBJ1%d
      H_OBJ1%d = 0.0d0
      M23%d = M23%d+OpenAD_prop_27%d*(OpenAD_Symbol_340)
      GG%d = GG%d+OpenAD_prop_27%d*(OpenAD_Symbol_341)
      D01%d = D01%d+OpenAD_prop_27%d
      OpenAD_prop_27%d = 0.0d0
      R00%d = R00%d+G%d
      LOC1%d = LOC1%d+G%d
      G%d = 0.0d0
      R11%d = R11%d+LOC1%d*(OpenAD_Symbol_342)
      LOC1%d = 0.0d0
      ...
      OpenAD_prop_23%d = OpenAD_prop_23%d+D01%d*(OpenAD_Symbol_343)
      LOC2%d = LOC2%d+D01%d*(OpenAD_Symbol_344)
      D01%d = 0.0d0
      M22%d = M22%d+R11%d*(OpenAD_Symbol_345)
      GG%d = GG%d+R11%d*(OpenAD_Symbol_346)
      LOC2%d = LOC2%d+R11%d*(OpenAD_Symbol_347)
      D11%d = D11%d+R11%d*(OpenAD_Symbol_348)
      R11%d = 0.0d0
      M33%d = M33%d+R00%d*(OpenAD_Symbol_349)
      GG%d = GG%d+R00%d*(OpenAD_Symbol_350)
      LOC2%d = LOC2%d+R00%d*(OpenAD_Symbol_351)
      D00%d = D00%d+R00%d*(OpenAD_Symbol_352)
      R00%d = 0.0d0
      ...
      MATR3%d = MATR3%d+M23%d*(OpenAD_Symbol_353)
      MATR2%d = MATR2%d+M23%d*(OpenAD_Symbol_354)
      M23%d = 0.0d0
      MATR3%d = MATR3%d+M13%d*(OpenAD_Symbol_355)
      MATR1%d = MATR1%d+M13%d*(OpenAD_Symbol_356)
      M13%d = 0.0d0
      MATR2%d = MATR2%d+M12%d*(OpenAD_Symbol_357)
      MATR1%d = MATR1%d+M12%d*(OpenAD_Symbol_358)
      M12%d = 0.0d0
      MATR2%d = MATR2%d+M02%d*(OpenAD_Symbol_359)
      MATR0%d = MATR0%d+M02%d*(OpenAD_Symbol_360)
      M02%d = 0.0d0
      MATR1%d = MATR1%d+M01%d*(OpenAD_Symbol_361)
      MATR0%d = MATR0%d+M01%d*(OpenAD_Symbol_362)
      M01%d = 0.0d0
      OpenAD_prop_22%d = OpenAD_prop_22%d+LOC2%d*(2.0D00)
      LOC2%d = 0.0d0
      ADJ_M3%d = ADJ_M3%d+LOC1%d*(OpenAD_Symbol_363)
      LOC1%d = 0.0d0
      ...
      G_OBJ0%d = 0.0d0
      ADJ_M1%d = ADJ_M1%d+LOC1%d*(OpenAD_Symbol_364)
      LOC1%d = 0.0d0
      MATR0%d = MATR0%d+ADJ_M3%d*(OpenAD_Symbol_365)
      G%d = G%d+ADJ_M3%d*(OpenAD_Symbol_366)
      OpenAD_prop_16%d = OpenAD_prop_16%d+ADJ_M3%d*(OpenAD_Symbol_367)
      MATR3%d = MATR3%d+ADJ_M3%d*(OpenAD_Symbol_368)
      ADJ_M3%d = 0.0d0
      MATR1%d = MATR1%d+ADJ_M2%d*(OpenAD_Symbol_369)
      G%d = G%d+ADJ_M2%d*(OpenAD_Symbol_370)
      OpenAD_prop_16%d = OpenAD_prop_16%d+ADJ_M2%d*(OpenAD_Symbol_371)
      MATR2%d = MATR2%d+ADJ_M2%d*(OpenAD_Symbol_372)
      ADJ_M2%d = 0.0d0
      MATR2%d = MATR2%d+ADJ_M1%d*(OpenAD_Symbol_373)
      G%d = G%d+ADJ_M1%d*(OpenAD_Symbol_374)
      OpenAD_prop_16%d = OpenAD_prop_16%d+ADJ_M1%d*(OpenAD_Symbol_375)
      MATR1%d = MATR1%d+ADJ_M1%d*(OpenAD_Symbol_376)
      ADJ_M1%d = 0.0d0
      MATR3%d = MATR3%d+ADJ_M0%d*(OpenAD_Symbol_377)
      G%d = G%d+ADJ_M0%d*(OpenAD_Symbol_378)
      OpenAD_prop_16%d = OpenAD_prop_16%d+ADJ_M0%d*(OpenAD_Symbol_379)
      MATR0%d = MATR0%d+ADJ_M0%d*(OpenAD_Symbol_380)
      ADJ_M0%d = 0.0d0
      ...
      OpenAD_prop_15%d = OpenAD_prop_15%d+GG%d*(OpenAD_Symbol_381)
      GG%d = 0.0d0
      LOC2%d = LOC2%d+G%d*(OpenAD_Symbol_382)
      F%d = F%d+G%d*(OpenAD_Symbol_383)
      G%d = 0.0d0
      OpenAD_prop_15%d = OpenAD_prop_15%d+LOC2%d*(OpenAD_Symbol_384)
      LOC2%d = 0.0d0
      LOC1%d = LOC1%d+OBJ%d*(OpenAD_Symbol_385)
      F%d = F%d+OBJ%d*(OpenAD_Symbol_386)
      OBJ%d = 0.0d0
      OpenAD_prop_15%d = OpenAD_prop_15%d+LOC1%d*(OpenAD_Symbol_387)
      LOC1%d = 0.0d0
      D12%d = D12%d+F%d
      D03%d = D03%d+F%d
      F%d = 0.0d0
      ...
      M22%d = M22%d+D03%d*(OpenAD_Symbol_388)
      M11%d = M11%d+D03%d*(OpenAD_Symbol_389)
      D03%d = 0.0d0
      M33%d = M33%d+D12%d*(OpenAD_Symbol_390)
      M00%d = M00%d+D12%d*(OpenAD_Symbol_391)
      D12%d = 0.0d0
      MATR3%d = MATR3%d+M33%d*(OpenAD_Symbol_392)
      M33%d = 0.0d0
      MATR1%d = MATR1%d+M11%d*(OpenAD_Symbol_393)
      M11%d = 0.0d0
      ...
      M03%d = M03%d+G%d
      G%d = 0.0d0
      MATR2%d = MATR2%d+M12%d*(OpenAD_Symbol_394)
      MATR1%d = MATR1%d+M12%d*(OpenAD_Symbol_395)
      M12%d = 0.0d0
      MATR3%d = MATR3%d+M03%d*(OpenAD_Symbol_396)
      MATR0%d = MATR0%d+M03%d*(OpenAD_Symbol_397)
      M03%d = 0.0d0
      OpenAD_prop_14%d = OpenAD_prop_14%d+MATR3%d*(OpenAD_Symbol_398)
      MATR3%d = 0.0d0
      OpenAD_prop_13%d = OpenAD_prop_13%d+MATR1%d*(OpenAD_Symbol_399)
      MATR1%d = 0.0d0
      ...
      H_OBJ9%d = 0.0d0
      OpenAD_prop_12%d = OpenAD_prop_12%d+F%d*(OpenAD_Symbol_400)
      F%d = 0.0d0
      MATR2%d = MATR2%d+M22%d*(OpenAD_Symbol_401)
      M22%d = 0.0d0
      MATR0%d = MATR0%d+M00%d*(OpenAD_Symbol_402)
      M00%d = 0.0d0
      ...
      H_OBJ10%d = 0.0d0
      OpenAD_prop_10%d = OpenAD_prop_10%d+F%d*(OpenAD_Symbol_403)
      F%d = 0.0d0
      R02%d = R02%d+G%d*(OpenAD_Symbol_404)
      G%d = 0.0d0
      ...
      R02%d = R02%d+G%d*(OpenAD_Symbol_405)
      G%d = 0.0d0
      R13%d = R13%d+H_OBJ14%d*(1.2D+01)
      H_OBJ14%d = 0.0d0
      ...
      H_OBJ12%d = 0.0d0
      R12%d = R12%d+F%d*(OpenAD_Symbol_406)
      F%d = 0.0d0
      ...
      G%d = G%d+H_OBJ8%d
      H_OBJ8%d = 0.0d0
      R13%d = R13%d+G%d*(OpenAD_Symbol_407)
      G%d = 0.0d0
      R03%d = R03%d+F%d*(OpenAD_Symbol_408)
      F%d = 0.0d0
      M12%d = M12%d+R12%d*(OpenAD_Symbol_409)
      GG%d = GG%d+R12%d*(OpenAD_Symbol_410)
      LOC2%d = LOC2%d+R12%d*(OpenAD_Symbol_411)
      D12%d = D12%d+R12%d*(OpenAD_Symbol_412)
      R12%d = 0.0d0
      M03%d = M03%d+R03%d*(OpenAD_Symbol_413)
      GG%d = GG%d+R03%d*(OpenAD_Symbol_414)
      LOC2%d = LOC2%d+R03%d*(OpenAD_Symbol_415)
      D03%d = D03%d+R03%d*(OpenAD_Symbol_416)
      R03%d = 0.0d0
      M13%d = M13%d+R02%d*(OpenAD_Symbol_417)
      GG%d = GG%d+R02%d*(OpenAD_Symbol_418)
      LOC1%d = LOC1%d+R02%d
      R02%d = 0.0d0
      M02%d = M02%d+R13%d*(OpenAD_Symbol_419)
      GG%d = GG%d+R13%d*(OpenAD_Symbol_420)
      LOC1%d = LOC1%d+R13%d
      R13%d = 0.0d0
      OpenAD_prop_7%d = OpenAD_prop_7%d+LOC1%d*(OpenAD_Symbol_421)
      LOC2%d = LOC2%d+LOC1%d*(OpenAD_Symbol_422)
      LOC1%d = 0.0d0
      ...
      LOC1%d = LOC1%d+H_OBJ17%d
      H_OBJ17%d = 0.0d0
      R00%d = R00%d+LOC1%d*(OpenAD_Symbol_423)
      LOC1%d = 0.0d0
      R00%d = R00%d+H_OBJ20%d*(OpenAD_Symbol_424)
      H_OBJ20%d = 0.0d0
      double_tape_pointer = double_tape_pointer-1
      ...
      F%d = F%d+H_OBJ15%d
      H_OBJ15%d = 0.0d0
      OpenAD_prop_6%d = OpenAD_prop_6%d+F%d*(OpenAD_Symbol_425)
      F%d = 0.0d0
      M01%d = M01%d+OpenAD_prop_6%d*(OpenAD_Symbol_426)
      GG%d = GG%d+OpenAD_prop_6%d*(OpenAD_Symbol_427)
      ...
      LOC1%d = LOC1%d+G%d
      G%d = 0.0d0
      R00%d = R00%d+LOC1%d*(OpenAD_Symbol_428)
      LOC1%d = 0.0d0
      double_tape_pointer = double_tape_pointer-1
      ...
      LOC1%d = LOC1%d+H_OBJ2%d
      H_OBJ2%d = 0.0d0
      R11%d = R11%d+LOC1%d*(OpenAD_Symbol_429)
      LOC1%d = 0.0d0
      R11%d = R11%d+H_OBJ5%d*(OpenAD_Symbol_430)
      H_OBJ5%d = 0.0d0
      double_tape_pointer = double_tape_pointer-1
      ...
      F%d = F%d+H_OBJ0%d
      H_OBJ0%d = 0.0d0
      OpenAD_prop_5%d = OpenAD_prop_5%d+F%d*(OpenAD_Symbol_431)
      F%d = 0.0d0
      M23%d = M23%d+OpenAD_prop_5%d*(OpenAD_Symbol_432)
      GG%d = GG%d+OpenAD_prop_5%d*(OpenAD_Symbol_433)
      ...
      LOC1%d = LOC1%d+G%d
      G%d = 0.0d0
      R11%d = R11%d+LOC1%d*(OpenAD_Symbol_434)
      LOC1%d = 0.0d0
      double_tape_pointer = double_tape_pointer-1
      ...
      OpenAD_prop_4%d = OpenAD_prop_4%d+D01%d*(OpenAD_Symbol_435)
      LOC2%d = LOC2%d+D01%d*(OpenAD_Symbol_436)
      D01%d = 0.0d0
      M22%d = M22%d+R11%d*(OpenAD_Symbol_437)
      GG%d = GG%d+R11%d*(OpenAD_Symbol_438)
      LOC2%d = LOC2%d+R11%d*(OpenAD_Symbol_439)
      D11%d = D11%d+R11%d*(OpenAD_Symbol_440)
      R11%d = 0.0d0
      M33%d = M33%d+R00%d*(OpenAD_Symbol_441)
      GG%d = GG%d+R00%d*(OpenAD_Symbol_442)
      LOC2%d = LOC2%d+R00%d*(OpenAD_Symbol_443)
      D00%d = D00%d+R00%d*(OpenAD_Symbol_444)
      R00%d = 0.0d0
      LOC1%d = LOC1%d-G_OBJ3%d
      ADJ_M2%d = ADJ_M2%d-G_OBJ3%d
      G_OBJ3%d = 0.0d0
      ...
      MATR3%d = MATR3%d+M23%d*(OpenAD_Symbol_445)
      MATR2%d = MATR2%d+M23%d*(OpenAD_Symbol_446)
      M23%d = 0.0d0
      MATR3%d = MATR3%d+M13%d*(OpenAD_Symbol_447)
      MATR1%d = MATR1%d+M13%d*(OpenAD_Symbol_448)
      M13%d = 0.0d0
      MATR2%d = MATR2%d+M12%d*(OpenAD_Symbol_449)
      MATR1%d = MATR1%d+M12%d*(OpenAD_Symbol_450)
      M12%d = 0.0d0
      MATR2%d = MATR2%d+M02%d*(OpenAD_Symbol_451)
      MATR0%d = MATR0%d+M02%d*(OpenAD_Symbol_452)
      M02%d = 0.0d0
      MATR1%d = MATR1%d+M01%d*(OpenAD_Symbol_453)
      MATR0%d = MATR0%d+M01%d*(OpenAD_Symbol_454)
      M01%d = 0.0d0
      ...
      ADJ_M2%d = ADJ_M2%d+G_OBJ4%d
      G_OBJ4%d = 0.0d0
      ADJ_M3%d = ADJ_M3%d+LOC1%d*(OpenAD_Symbol_455)
      LOC1%d = 0.0d0
      ...
      ADJ_M0%d = ADJ_M0%d+G_OBJ1%d
      G_OBJ1%d = 0.0d0
      ADJ_M1%d = ADJ_M1%d+LOC1%d*(OpenAD_Symbol_456)
      LOC1%d = 0.0d0
      MATR0%d = MATR0%d+ADJ_M3%d*(OpenAD_Symbol_457)
      G%d = G%d+ADJ_M3%d*(OpenAD_Symbol_458)
      OpenAD_prop_2%d = OpenAD_prop_2%d+ADJ_M3%d*(OpenAD_Symbol_459)
      MATR3%d = MATR3%d+ADJ_M3%d*(OpenAD_Symbol_460)
      ADJ_M3%d = 0.0d0
      MATR1%d = MATR1%d+ADJ_M2%d*(OpenAD_Symbol_461)
      G%d = G%d+ADJ_M2%d*(OpenAD_Symbol_462)
      OpenAD_prop_2%d = OpenAD_prop_2%d+ADJ_M2%d*(OpenAD_Symbol_463)
      MATR2%d = MATR2%d+ADJ_M2%d*(OpenAD_Symbol_464)
      ADJ_M2%d = 0.0d0
      MATR2%d = MATR2%d+ADJ_M1%d*(OpenAD_Symbol_465)
      G%d = G%d+ADJ_M1%d*(OpenAD_Symbol_466)
      OpenAD_prop_2%d = OpenAD_prop_2%d+ADJ_M1%d*(OpenAD_Symbol_467)
      MATR1%d = MATR1%d+ADJ_M1%d*(OpenAD_Symbol_468)
      ADJ_M1%d = 0.0d0
      MATR3%d = MATR3%d+ADJ_M0%d*(OpenAD_Symbol_469)
      G%d = G%d+ADJ_M0%d*(OpenAD_Symbol_470)
      OpenAD_prop_2%d = OpenAD_prop_2%d+ADJ_M0%d*(OpenAD_Symbol_471)
      MATR0%d = MATR0%d+ADJ_M0%d*(OpenAD_Symbol_472)
      ADJ_M0%d = 0.0d0
      LOC2%d = LOC2%d+G%d*(OpenAD_Symbol_473)
      F%d = F%d+G%d*(OpenAD_Symbol_474)
      G%d = 0.0d0
      ...
      G%d = G%d+GG%d*(OpenAD_Symbol_475)
      GG%d = 0.0d0
      G%d = G%d+LOC2%d*(OpenAD_Symbol_476)
      LOC2%d = 0.0d0
      LOC1%d = LOC1%d+OBJ%d*(OpenAD_Symbol_477)
      F%d = F%d+OBJ%d*(OpenAD_Symbol_478)
      OBJ%d = 0.0d0
      G%d = G%d+LOC1%d*(OpenAD_Symbol_479)
      LOC1%d = 0.0d0
      D12%d = D12%d+F%d
      D03%d = D03%d+F%d
      F%d = 0.0d0
      M22%d = M22%d+D03%d*(OpenAD_Symbol_480)
      M11%d = M11%d+D03%d*(OpenAD_Symbol_481)
      D03%d = 0.0d0
      M33%d = M33%d+D12%d*(OpenAD_Symbol_482)
      M00%d = M00%d+D12%d*(OpenAD_Symbol_483)
      D12%d = 0.0d0
      MATR3%d = MATR3%d+M33%d*(OpenAD_Symbol_484)
      M33%d = 0.0d0
      MATR1%d = MATR1%d+M11%d*(OpenAD_Symbol_485)
      M11%d = 0.0d0
      M12%d = M12%d+D11%d*(2.0D00)
      D11%d = 0.0d0
      M03%d = M03%d+D00%d*(2.0D00)
      ...
      M03%d = M03%d+G%d
      G%d = 0.0d0
      MATR2%d = MATR2%d+M12%d*(OpenAD_Symbol_486)
      MATR1%d = MATR1%d+M12%d*(OpenAD_Symbol_487)
      M12%d = 0.0d0
      MATR3%d = MATR3%d+M03%d*(OpenAD_Symbol_488)
      MATR0%d = MATR0%d+M03%d*(OpenAD_Symbol_489)
      M03%d = 0.0d0
      OpenAD_prop_1%d = OpenAD_prop_1%d+MATR3%d*(OpenAD_Symbol_490)
      MATR3%d = 0.0d0
      OpenAD_prop_0%d = OpenAD_prop_0%d+MATR1%d*(OpenAD_Symbol_491)
      MATR1%d = 0.0d0
      ...
      MATR2%d = MATR2%d+M22%d*(OpenAD_Symbol_492)
      M22%d = 0.0d0
      MATR0%d = MATR0%d+M00%d*(OpenAD_Symbol_493)
      M00%d = 0.0d0
      X04%d = X04%d-MATR2%d
      X05%d = X05%d+MATR2%d
      MATR2%d = 0.0d0
