...
C adjoint
      ...
      T%d = T%d+Y(3)%d*(OpenAD_Symbol_14)
      Y(3)%d = 0.0d0
      double_tape_pointer = double_tape_pointer-1
      ...
      T%d = T%d+Y(2)%d*(OpenAD_Symbol_15)
      Y(2)%d = 0.0d0
      OpenAD_prop_0%d = OpenAD_prop_0%d+T%d*(OpenAD_Symbol_16)
      X(4)%d = X(4)%d+T%d*(OpenAD_Symbol_17)
      X(5)%d = X(5)%d+T%d*(OpenAD_Symbol_18)
      T%d = 0.0d0
      ...
      T%d = T%d+Y(1)%d*(OpenAD_Symbol_19)
      Y(1)%d = 0.0d0
      X(2)%d = X(2)%d+T%d*(OpenAD_Symbol_20)
      X(1)%d = X(1)%d+T%d*(OpenAD_Symbol_21)
      X(3)%d = X(3)%d+T%d*(OpenAD_Symbol_22)
      T%d = 0.0d0
