...
C adjoint
      ...
      do while (INT(OpenAD_Symbol_89).LE.INT(OpenAD_Symbol_88))
        ...
        IF (OpenAD_Symbol_90.ne.0) THEN
          ...
          TNOW(INT(OpenAD_Symbol_239))%d = 0.0d0
        ENDIF
...
C adjoint
      ...
      do while (INT(OpenAD_Symbol_137).LE.INT(OpenAD_Symbol_136))
        ...
        S(INT(OpenAD_Symbol_268))%d = S(INT(OpenAD_Symbol_268))%d+SNOW(I
     +NT(OpenAD_Symbol_268))%d
        SNOW(INT(OpenAD_Symbol_268))%d = 0.0d0
        integer_tape_pointer = integer_tape_pointer-1
        OpenAD_Symbol_269 = integer_tape(integer_tape_pointer)
        T(INT(OpenAD_Symbol_269))%d = T(INT(OpenAD_Symbol_269))%d+TNOW(I
     +NT(OpenAD_Symbol_269))%d
        TNOW(INT(OpenAD_Symbol_269))%d = 0.0d0
        S(INT(OpenAD_Symbol_269))%d = S(INT(OpenAD_Symbol_269))%d+SOLD(I
     +NT(OpenAD_Symbol_269))%d
        SOLD(INT(OpenAD_Symbol_269))%d = 0.0d0
        integer_tape_pointer = integer_tape_pointer-1
        OpenAD_Symbol_270 = integer_tape(integer_tape_pointer)
        T(INT(OpenAD_Symbol_270))%d = T(INT(OpenAD_Symbol_270))%d+TOLD(I
     +NT(OpenAD_Symbol_270))%d
        TOLD(INT(OpenAD_Symbol_270))%d = 0.0d0
        S(INT(OpenAD_Symbol_270))%d = S(INT(OpenAD_Symbol_270))%d+SNEW(I
     +NT(OpenAD_Symbol_270))%d
        SNEW(INT(OpenAD_Symbol_270))%d = 0.0d0
        integer_tape_pointer = integer_tape_pointer-1
        OpenAD_Symbol_271 = integer_tape(integer_tape_pointer)
        T(INT(OpenAD_Symbol_271))%d = T(INT(OpenAD_Symbol_271))%d+TNEW(I
     +NT(OpenAD_Symbol_271))%d
        TNEW(INT(OpenAD_Symbol_271))%d = 0.0d0
      ...
      do while (INT(OpenAD_Symbol_139).LE.INT(OpenAD_Symbol_138))
        ...
        XX(INT(OpenAD_Symbol_267))%d = XX(INT(OpenAD_Symbol_267))%d+S(IN
     +T(OpenAD_Symbol_266))%d
        OpenAD_prop_13%d = OpenAD_prop_13%d+S(INT(OpenAD_Symbol_266))%d
        S(INT(OpenAD_Symbol_266))%d = 0.0d0
        XX(INT(OpenAD_Symbol_266))%d = XX(INT(OpenAD_Symbol_266))%d+T(IN
     +T(OpenAD_Symbol_266))%d
        OpenAD_prop_12%d = OpenAD_prop_12%d+T(INT(OpenAD_Symbol_266))%d
        T(INT(OpenAD_Symbol_266))%d = 0.0d0
        S(INT(OpenAD_Symbol_266))%d = S(INT(OpenAD_Symbol_266))%d+OpenAD
     +_prop_13%d
        OpenAD_prop_13%d = 0.0d0
        T(INT(OpenAD_Symbol_266))%d = T(INT(OpenAD_Symbol_266))%d+OpenAD
     +_prop_12%d
...
C adjoint
      ...
      END DO
      integer_tape_pointer = integer_tape_pointer-1
      OpenAD_Symbol_165 = integer_tape(integer_tape_pointer)
      OpenAD_Symbol_166 = 1
          ...
          IF(ILEV2 .LE. MAXLEV2) THEN
            ...
            DO ILEV1 = 1, 73, 1
              ...
              ELSE
                ...
                integer_tape_pointer = integer_tape_pointer+1
              ENDIF
              OpenAD_Symbol_211 = (INT(OpenAD_Symbol_211) + INT( 1_w2f__
     +i8))
            END DO
...
C adjoint
      ...
      do while (INT(OpenAD_Symbol_101).LE.INT(OpenAD_Symbol_100))
        ...
        TLOC(INT(OpenAD_Symbol_240))%d = TLOC(INT(OpenAD_Symbol_240))%d+
     +RHOLOC(INT(OpenAD_Symbol_240))%d*(OpenAD_Symbol_241)
        SLOC(INT(OpenAD_Symbol_240))%d = SLOC(INT(OpenAD_Symbol_240))%d+
     +RHOLOC(INT(OpenAD_Symbol_240))%d*(OpenAD_Symbol_242)
        RHOLOC(INT(OpenAD_Symbol_240))%d = 0.0d0
...
C adjoint
      ...
      OpenAD_prop_0%d = OpenAD_prop_0%d+UVELLOC%d*(OpenAD_Symbol_243)
      UVELLOC%d = 0.0d0
      RHOLOC(3)%d = RHOLOC(3)%d+OpenAD_prop_0%d*(OpenAD_Symbol_244)
      RHOLOC(1)%d = RHOLOC(1)%d+OpenAD_prop_0%d*(OpenAD_Symbol_245)
...
C adjoint
      ...
      do while (INT(OpenAD_Symbol_113).LE.INT(OpenAD_Symbol_112))
        ...
        OpenAD_prop_9%d = OpenAD_prop_9%d+FLDNOW(INT(OpenAD_Symbol_262))
     +%d*(OpenAD_Symbol_263)
        OpenAD_prop_7%d = OpenAD_prop_7%d+FLDNOW(INT(OpenAD_Symbol_262))
     +%d
        FLDNOW(INT(OpenAD_Symbol_262))%d = 0.0d0
        OpenAD_prop_8%d = OpenAD_prop_8%d+OpenAD_prop_9%d*(-2.0D00)
        FLDNEW(INT(OpenAD_Symbol_262))%d = FLDNEW(INT(OpenAD_Symbol_262)
     +)%d+OpenAD_prop_9%d
        FLDOLD(INT(OpenAD_Symbol_262))%d = FLDOLD(INT(OpenAD_Symbol_262)
     +)%d+OpenAD_prop_9%d
        OpenAD_prop_9%d = 0.0d0
        FLDNOW(INT(OpenAD_Symbol_262))%d = FLDNOW(INT(OpenAD_Symbol_262)
     +)%d+OpenAD_prop_8%d
...
C adjoint
      ...
      do while (INT(OpenAD_Symbol_119).LE.INT(OpenAD_Symbol_118))
        ...
        SNEW(INT(OpenAD_Symbol_264))%d = SNEW(INT(OpenAD_Symbol_264))%d+
     +SNOW(INT(OpenAD_Symbol_264))%d
        SNOW(INT(OpenAD_Symbol_264))%d = 0.0d0
        OpenAD_prop_11%d = OpenAD_prop_11%d+SOLD(INT(OpenAD_Symbol_264))
     +%d
        SOLD(INT(OpenAD_Symbol_264))%d = 0.0d0
        SNOW(INT(OpenAD_Symbol_264))%d = SNOW(INT(OpenAD_Symbol_264))%d+
     +OpenAD_prop_11%d
        OpenAD_prop_11%d = 0.0d0
        integer_tape_pointer = integer_tape_pointer-1
        OpenAD_Symbol_265 = integer_tape(integer_tape_pointer)
        TNEW(INT(OpenAD_Symbol_265))%d = TNEW(INT(OpenAD_Symbol_265))%d+
     +TNOW(INT(OpenAD_Symbol_265))%d
        TNOW(INT(OpenAD_Symbol_265))%d = 0.0d0
        OpenAD_prop_10%d = OpenAD_prop_10%d+TOLD(INT(OpenAD_Symbol_265))
     +%d
        TOLD(INT(OpenAD_Symbol_265))%d = 0.0d0
        TNOW(INT(OpenAD_Symbol_265))%d = TNOW(INT(OpenAD_Symbol_265))%d+
     +OpenAD_prop_10%d
...
C adjoint
      ...
      do while (INT(OpenAD_Symbol_234).LE.INT(OpenAD_Symbol_233))
        ...
        DFLDDT(INT(OpenAD_Symbol_272))%d = DFLDDT(INT(OpenAD_Symbol_272)
     +)%d+FLDNEW(INT(OpenAD_Symbol_272))%d*(OpenAD_Symbol_273)
        FLDOLD(INT(OpenAD_Symbol_272))%d = FLDOLD(INT(OpenAD_Symbol_272)
     +)%d+FLDNEW(INT(OpenAD_Symbol_272))%d
        FLDNEW(INT(OpenAD_Symbol_272))%d = 0.0d0
...
C adjoint
      ...
      IF (OpenAD_Symbol_106.ne.0) THEN
        ...
        OpenAD_prop_3%d = OpenAD_prop_3%d+DFLDDT(3)%d*(OpenAD_Symbol_246
     +)
        UVELLOC%d = UVELLOC%d+DFLDDT(3)%d*(OpenAD_Symbol_247)
        DFLDDT(3)%d = 0.0d0
        ...
        FLDNOW(2)%d = FLDNOW(2)%d+DFLDDT(2)%d*(OpenAD_Symbol_248)
        OpenAD_prop_2%d = OpenAD_prop_2%d+DFLDDT(2)%d*(OpenAD_Symbol_249
     +)
        UVELLOC%d = UVELLOC%d+DFLDDT(2)%d*(OpenAD_Symbol_250)
        DFLDDT(2)%d = 0.0d0
        ...
        FLDNOW(1)%d = FLDNOW(1)%d+DFLDDT(1)%d*(OpenAD_Symbol_251)
        OpenAD_prop_1%d = OpenAD_prop_1%d+DFLDDT(1)%d*(OpenAD_Symbol_252
     +)
        UVELLOC%d = UVELLOC%d+DFLDDT(1)%d*(OpenAD_Symbol_253)
        DFLDDT(1)%d = 0.0d0
      ...
      ELSE
        ...
        OpenAD_prop_6%d = OpenAD_prop_6%d+DFLDDT(3)%d*(OpenAD_Symbol_254
     +)
        UVELLOC%d = UVELLOC%d+DFLDDT(3)%d*(OpenAD_Symbol_255)
        DFLDDT(3)%d = 0.0d0
        ...
        FLDNOW(2)%d = FLDNOW(2)%d+DFLDDT(2)%d*(OpenAD_Symbol_256)
        OpenAD_prop_5%d = OpenAD_prop_5%d+DFLDDT(2)%d*(OpenAD_Symbol_257
     +)
        UVELLOC%d = UVELLOC%d+DFLDDT(2)%d*(OpenAD_Symbol_258)
        DFLDDT(2)%d = 0.0d0
        ...
        FLDNOW(1)%d = FLDNOW(1)%d+DFLDDT(1)%d*(OpenAD_Symbol_259)
        OpenAD_prop_4%d = OpenAD_prop_4%d+DFLDDT(1)%d*(OpenAD_Symbol_260
     +)
        UVELLOC%d = UVELLOC%d+DFLDDT(1)%d*(OpenAD_Symbol_261)
        DFLDDT(1)%d = 0.0d0
