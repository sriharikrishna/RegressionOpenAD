...
C$OPENAD XXX Template ad_template.f
     ...
     > )) * OpenAD_lin_9 - __value__(RHOLOC(2)))
      ...
      CALL saxpy(OpenAD_lin_7, __deriv__(RHOLOC(1)), __deriv__(
     > OpenAD_prp_0))
      CALL saxpy(OpenAD_lin_10, __deriv__(RHOLOC(3)), __deriv__(
     > OpenAD_prp_0))
...
C$OPENAD XXX Template ad_template.f
     ...
     > OpenAD_prp_9))
        ...
        CALL saxpy(OpenAD_lin_82, __deriv__(OpenAD_prp_9), __deriv__(
     > FLDNOW(L)))
      END DO
      END SUBROUTINE
...
C$OPENAD XXX Template ad_template.f
     ...
     > DFLDDT(L)) * OpenAD_lin_84)
        ...
        CALL saxpy(OpenAD_lin_85, __deriv__(DFLDDT(L)), __deriv__(
     > FLDNEW(L)))
      END DO
      END SUBROUTINE
