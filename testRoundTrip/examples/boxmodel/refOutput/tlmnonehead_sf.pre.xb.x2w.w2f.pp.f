...
C$OPENAD XXX Template ad_template.f
      ...
      DO L = 1, 3, 1
        ...
        CALL sax(1 _w2f__i8,OpenAD_Symbol_120,T(L))
        CALL saxpy(1 _w2f__i8,XX(L),T(L))
        CALL sax(1 _w2f__i8,OpenAD_Symbol_121,S(L))
...
C$OPENAD XXX Template ad_template.f
     ...
     +HOLOC(2)%v)
      ...
      CALL sax(-1 _w2f__i8,RHOLOC(2),OpenAD_Symbol_90)
...
C$OPENAD XXX Template ad_template.f
     ...
     +l_80)
        ...
        CALL sax(1 _w2f__i8,FLDOLD(L),OpenAD_Symbol_117)
        CALL saxpy(1 _w2f__i8,FLDNEW(L),OpenAD_Symbol_117)
        CALL saxpy(-2.0D00,OpenAD_Symbol_116,OpenAD_Symbol_117)
        CALL sax(1 _w2f__i8,OpenAD_Symbol_115,FLDNOW(L))
...
C$OPENAD XXX Template ad_template.f
      DO L = 1, 3, 1
        ...
        CALL setderiv(OpenAD_Symbol_118,TNOW(L))
        CALL setderiv(TOLD(L),OpenAD_Symbol_118)
        CALL setderiv(TNOW(L),TNEW(L))
        SOLD(INT(L))%v = SNOW(L)%v
        SNOW(INT(L))%v = SNEW(L)%v
        CALL setderiv(OpenAD_Symbol_119,SNOW(L))
        CALL setderiv(SOLD(L),OpenAD_Symbol_119)
...
C$OPENAD XXX Template ad_template.f
      DO L = 1, 3, 1
        ...
        CALL sax(1 _w2f__i8,FLDOLD(L),FLDNEW(L))
...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_18 * OpenAD_Symbol_13)
        CALL sax(1 _w2f__i8,FLDNOW(3),OpenAD_Symbol_94)
        CALL saxpy(-1 _w2f__i8,FLDNOW(1),OpenAD_Symbol_94)
     ...
     >  OpenAD_Symbol_32 * OpenAD_Symbol_27)
        CALL sax(1 _w2f__i8,FLDNOW(1),OpenAD_Symbol_98)
        CALL saxpy(-1 _w2f__i8,FLDNOW(2),OpenAD_Symbol_98)
        ...
        CALL sax(1 _w2f__i8,FLDNOW(2),OpenAD_Symbol_101)
        CALL saxpy(-1 _w2f__i8,FLDNOW(3),OpenAD_Symbol_101)
     ...
     >  OpenAD_Symbol_52 * OpenAD_Symbol_47)
        CALL sax(1 _w2f__i8,FLDNOW(2),OpenAD_Symbol_106)
        CALL saxpy(-1 _w2f__i8,FLDNOW(1),OpenAD_Symbol_106)
     ...
     >  OpenAD_Symbol_66 * OpenAD_Symbol_61)
        CALL sax(1 _w2f__i8,FLDNOW(3),OpenAD_Symbol_111)
        CALL saxpy(-1 _w2f__i8,FLDNOW(2),OpenAD_Symbol_111)
     ...
     > (-1_w2f__i8)))
        CALL sax(1 _w2f__i8,FLDNOW(1),OpenAD_Symbol_114)
        CALL saxpy(-1 _w2f__i8,FLDNOW(3),OpenAD_Symbol_114)
