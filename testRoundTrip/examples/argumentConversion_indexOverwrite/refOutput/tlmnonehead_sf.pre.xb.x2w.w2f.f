...
C$OPENAD XXX Template ad_template.f
      ...
      OpenAD_Symbol_1 = (__value__(Y(1)) * __value__(V(2)))
      ...
      CALL sax(OpenAD_lin_2, __deriv__(OpenAD_prop_1), __deriv__(Y(1)))
      CALL saxpy(OpenAD_lin_3, __deriv__(OpenAD_prop_2), __deriv__(Y(1)
     > ))
      END SUBROUTINE
