...
C$OPENAD XXX Template ad_template.f
      DO I = 1, NY, 1
        DO J = 1, NX, 1
          ...
          CALL setderiv(OpenAD_Symbol_79,PT)
          CALL dec_deriv(OpenAD_Symbol_79,PB)
          CALL setderiv(OpenAD_Symbol_80,PR)
          CALL dec_deriv(OpenAD_Symbol_80,PL)
     ...
     >  OpenAD_Symbol_81)
          CALL setderiv(OpenAD_Symbol_87,PRLAP)
          CALL dec_deriv(OpenAD_Symbol_87,PLLAP)
          CALL setderiv(OpenAD_Symbol_88,PTLAP)
          CALL dec_deriv(OpenAD_Symbol_88,PBLAP)
          CALL setderiv(OpenAD_Symbol_89,PBLAP)
          CALL inc_deriv(OpenAD_Symbol_89,PTLAP)
          CALL saxpy(-2.0D00,PLAP,OpenAD_Symbol_89)
          CALL setderiv(OpenAD_Symbol_90,PLLAP)
          CALL inc_deriv(OpenAD_Symbol_90,PRLAP)
...
C$OPENAD XXX Template ad_template.f
      ...
      CALL setderiv(OpenAD_Symbol_91,PBB)
      CALL inc_deriv(OpenAD_Symbol_91,P)
      CALL saxpy(-2.0D00,PB,OpenAD_Symbol_91)
      CALL setderiv(OpenAD_Symbol_92,PBL)
      CALL inc_deriv(OpenAD_Symbol_92,PBR)
      CALL saxpy(-2.0D00,PB,OpenAD_Symbol_92)
      CALL setderiv(OpenAD_Symbol_93,PBL)
      CALL inc_deriv(OpenAD_Symbol_93,PTL)
      CALL saxpy(-2.0D00,PL,OpenAD_Symbol_93)
      CALL setderiv(OpenAD_Symbol_94,PLL)
      CALL inc_deriv(OpenAD_Symbol_94,P)
      CALL saxpy(-2.0D00,PL,OpenAD_Symbol_94)
      CALL setderiv(OpenAD_Symbol_95,PB)
      CALL inc_deriv(OpenAD_Symbol_95,PT)
      CALL saxpy(-2.0D00,P,OpenAD_Symbol_95)
      CALL setderiv(OpenAD_Symbol_96,PL)
      CALL inc_deriv(OpenAD_Symbol_96,PR)
      CALL saxpy(-2.0D00,P,OpenAD_Symbol_96)
      CALL setderiv(OpenAD_Symbol_97,PBR)
      CALL inc_deriv(OpenAD_Symbol_97,PTR)
      CALL saxpy(-2.0D00,PR,OpenAD_Symbol_97)
      CALL setderiv(OpenAD_Symbol_98,P)
      CALL inc_deriv(OpenAD_Symbol_98,PRR)
      CALL saxpy(-2.0D00,PR,OpenAD_Symbol_98)
      CALL setderiv(OpenAD_Symbol_99,P)
      CALL inc_deriv(OpenAD_Symbol_99,PTT)
      CALL saxpy(-2.0D00,PT,OpenAD_Symbol_99)
      CALL setderiv(OpenAD_Symbol_100,PTL)
      CALL inc_deriv(OpenAD_Symbol_100,PTR)
