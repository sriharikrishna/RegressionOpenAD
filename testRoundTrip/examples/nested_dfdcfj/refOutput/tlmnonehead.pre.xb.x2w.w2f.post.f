...
C$OPENAD XXX Template ad_template.f
      DO I = 1, NY, 1
        DO J = 1, NX, 1
          ...
          CALL sax(1_w2f__i8,PT,OpenAD_Symbol_79)
          CALL saxpy(-1_w2f__i8,PB,OpenAD_Symbol_79)
          CALL sax(1_w2f__i8,PR,OpenAD_Symbol_80)
          CALL saxpy(-1_w2f__i8,PL,OpenAD_Symbol_80)
     ...
     >  OpenAD_Symbol_81)
          CALL sax(1_w2f__i8,PRLAP,OpenAD_Symbol_87)
          CALL saxpy(-1_w2f__i8,PLLAP,OpenAD_Symbol_87)
          CALL sax(1_w2f__i8,PTLAP,OpenAD_Symbol_88)
          CALL saxpy(-1_w2f__i8,PBLAP,OpenAD_Symbol_88)
          CALL sax(1_w2f__i8,PBLAP,OpenAD_Symbol_89)
          CALL saxpy(1_w2f__i8,PTLAP,OpenAD_Symbol_89)
          CALL saxpy(-2.0D00,PLAP,OpenAD_Symbol_89)
          CALL sax(1_w2f__i8,PLLAP,OpenAD_Symbol_90)
          CALL saxpy(1_w2f__i8,PRLAP,OpenAD_Symbol_90)
...
C$OPENAD XXX Template ad_template.f
      ...
      CALL sax(1_w2f__i8,PBB,OpenAD_Symbol_91)
      CALL saxpy(1_w2f__i8,P,OpenAD_Symbol_91)
      CALL saxpy(-2.0D00,PB,OpenAD_Symbol_91)
      CALL sax(1_w2f__i8,PBL,OpenAD_Symbol_92)
      CALL saxpy(1_w2f__i8,PBR,OpenAD_Symbol_92)
      CALL saxpy(-2.0D00,PB,OpenAD_Symbol_92)
      CALL sax(1_w2f__i8,PBL,OpenAD_Symbol_93)
      CALL saxpy(1_w2f__i8,PTL,OpenAD_Symbol_93)
      CALL saxpy(-2.0D00,PL,OpenAD_Symbol_93)
      CALL sax(1_w2f__i8,PLL,OpenAD_Symbol_94)
      CALL saxpy(1_w2f__i8,P,OpenAD_Symbol_94)
      CALL saxpy(-2.0D00,PL,OpenAD_Symbol_94)
      CALL sax(1_w2f__i8,PB,OpenAD_Symbol_95)
      CALL saxpy(1_w2f__i8,PT,OpenAD_Symbol_95)
      CALL saxpy(-2.0D00,P,OpenAD_Symbol_95)
      CALL sax(1_w2f__i8,PL,OpenAD_Symbol_96)
      CALL saxpy(1_w2f__i8,PR,OpenAD_Symbol_96)
      CALL saxpy(-2.0D00,P,OpenAD_Symbol_96)
      CALL sax(1_w2f__i8,PBR,OpenAD_Symbol_97)
      CALL saxpy(1_w2f__i8,PTR,OpenAD_Symbol_97)
      CALL saxpy(-2.0D00,PR,OpenAD_Symbol_97)
      CALL sax(1_w2f__i8,P,OpenAD_Symbol_98)
      CALL saxpy(1_w2f__i8,PRR,OpenAD_Symbol_98)
      CALL saxpy(-2.0D00,PR,OpenAD_Symbol_98)
      CALL sax(1_w2f__i8,P,OpenAD_Symbol_99)
      CALL saxpy(1_w2f__i8,PTT,OpenAD_Symbol_99)
      CALL saxpy(-2.0D00,PT,OpenAD_Symbol_99)
      CALL sax(1_w2f__i8,PTL,OpenAD_Symbol_100)
      CALL saxpy(1_w2f__i8,PTR,OpenAD_Symbol_100)
