...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_21)
          ...
          CALL saxpy(OpenAD_Symbol_169,DPDX,FVEC(K))
          CALL saxpy(OpenAD_Symbol_171,DPDY,FVEC(K))
          CALL saxpy(OpenAD_Symbol_30,PRLAP,FVEC(K))
          CALL saxpy(OpenAD_Symbol_21,PTLAP,FVEC(K))
          CALL saxpy(OpenAD_Symbol_170,PTLAP,FVEC(K))
          CALL saxpy(OpenAD_Symbol_173,PBLAP,FVEC(K))
          CALL saxpy(OpenAD_Symbol_172,PRLAP,FVEC(K))
