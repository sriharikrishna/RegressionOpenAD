...
C         $OpenAD$ INLINE push(subst)
     ...
     >  OpenAD_Symbol_166)
          OpenAD_Symbol_168 = (OpenAD_Symbol_45 * OpenAD_Symbol_166)
          OpenAD_Symbol_169 = (OpenAD_Symbol_57 * OpenAD_Symbol_167)
          OpenAD_Symbol_170 = (OpenAD_Symbol_58 * OpenAD_Symbol_167)
          OpenAD_Symbol_171 = (OpenAD_Symbol_48 * OpenAD_Symbol_168)
          OpenAD_Symbol_172 = (OpenAD_Symbol_49 * OpenAD_Symbol_168)
          OpenAD_Symbol_173 = (INT((-1_w2f__i8)) * OpenAD_Symbol_170)
          OpenAD_Symbol_174 = (INT((-1_w2f__i8)) * OpenAD_Symbol_172)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_309))), __deriv__(PBLAP))
C         $OpenAD$ INLINE pop_i(subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_311))), __deriv__(PTLAP))
C         $OpenAD$ INLINE pop_i(subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_315))), __deriv__(PRLAP))
C         $OpenAD$ INLINE pop_i(subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_317))), __deriv__(DPDY))
C         $OpenAD$ INLINE pop_i(subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_319))), __deriv__(DPDX))
C         $OpenAD$ INLINE pop_i(subst)
...
C         $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_321))), __deriv__(PBLAP))
C         $OpenAD$ INLINE pop_i(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_348, __deriv__(PTLAP), __deriv__(PTR))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_349)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_349, __deriv__(PTLAP), __deriv__(P))
C     $OpenAD$ INLINE Pop(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_354, __deriv__(PRLAP), __deriv__(PRR))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_355)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_355, __deriv__(PRLAP), __deriv__(PBR))
C     $OpenAD$ INLINE Pop(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_360, __deriv__(PLAP), __deriv__(PR))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_361)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_361, __deriv__(PLAP), __deriv__(PB))
C     $OpenAD$ INLINE Pop(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_366, __deriv__(PLLAP), __deriv__(P))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_367)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_367, __deriv__(PLLAP), __deriv__(PBL))
C     $OpenAD$ INLINE Pop(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_372, __deriv__(PBLAP), __deriv__(PBR))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_373)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_373, __deriv__(PBLAP), __deriv__(PBB))
C     $OpenAD$ INLINE Pop(subst)
