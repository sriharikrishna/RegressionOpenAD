...
C$OPENAD XXX Template ad_template.f
     ...
     > (DPDY))
          CALL sax(OpenAD_Symbol_10, __deriv__(OpenAD_prop_2),
     >  __deriv__(DPDX))
     ...
     > )
          CALL sax(OpenAD_Symbol_80, __deriv__(DPDX), __deriv__(FVEC(K)
     > ))
          CALL saxpy(OpenAD_Symbol_81, __deriv__(OpenAD_prop_4),
     >  __deriv__(FVEC(K)))
          CALL saxpy(OpenAD_Symbol_82, __deriv__(DPDY), __deriv__(FVEC(
     > K)))
          CALL saxpy(OpenAD_Symbol_83, __deriv__(OpenAD_prop_3),
     >  __deriv__(FVEC(K)))
          CALL saxpy(OpenAD_Symbol_13, __deriv__(OpenAD_prop_5),
     >  __deriv__(FVEC(K)))
          CALL saxpy(OpenAD_Symbol_17, __deriv__(OpenAD_prop_6),
     >  __deriv__(FVEC(K)))
        END DO
      END DO
      END SUBROUTINE
...
C$OPENAD XXX Template ad_template.f
     ...
     >  HX2))
      ...
      CALL sax(OpenAD_Symbol_39, __deriv__(OpenAD_prop_7), __deriv__(
     > PBLAP))
      CALL saxpy(OpenAD_Symbol_43, __deriv__(OpenAD_prop_8), __deriv__(
     > PBLAP))
      CALL sax(OpenAD_Symbol_47, __deriv__(OpenAD_prop_9), __deriv__(
     > PLLAP))
      CALL saxpy(OpenAD_Symbol_51, __deriv__(OpenAD_prop_10), __deriv__
     > (PLLAP))
      CALL sax(OpenAD_Symbol_55, __deriv__(OpenAD_prop_11), __deriv__(
     > PLAP))
      CALL saxpy(OpenAD_Symbol_59, __deriv__(OpenAD_prop_12), __deriv__
     > (PLAP))
      CALL sax(OpenAD_Symbol_63, __deriv__(OpenAD_prop_13), __deriv__(
     > PRLAP))
      CALL saxpy(OpenAD_Symbol_67, __deriv__(OpenAD_prop_14), __deriv__
     > (PRLAP))
      CALL sax(OpenAD_Symbol_71, __deriv__(OpenAD_prop_15), __deriv__(
     > PTLAP))
      CALL saxpy(OpenAD_Symbol_75, __deriv__(OpenAD_prop_16), __deriv__
     > (PTLAP))
      END SUBROUTINE
