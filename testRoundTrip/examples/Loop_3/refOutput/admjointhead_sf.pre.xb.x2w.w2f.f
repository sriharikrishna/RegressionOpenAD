...
C         $OpenAD$ INLINE push_i(subst)
          ...
          DO K = 1, 3, 1
            OpenAD_Symbol_0 = (__value__(X(J)) * __value__(Y(I)))
            OpenAD_lin_0 = __value__(Y(I))
            OpenAD_lin_1 = __value__(X(J))
            __value__(Y(INT(I))) = OpenAD_Symbol_0
...
C           $OpenAD$ INLINE Saxpy(subst,subst,subst)
     ...
     > OpenAD_Symbol_29))), __deriv__(OpenAD_prop_0))
C           $OpenAD$ INLINE Saxpy(subst,subst,subst)
            CALL Saxpy(OpenAD_Symbol_31, __deriv__(Y(INT(
     > OpenAD_Symbol_29))), __deriv__(X(INT(OpenAD_Symbol_28))))
...
C         $OpenAD$ INLINE IncDeriv(subst,subst)
          CALL IncDeriv(__deriv__(Y(INT(OpenAD_Symbol_27))), __deriv__(
     > X(INT(OpenAD_Symbol_27))))
C         $OpenAD$ INLINE ZeroDeriv(subst)
...
C       $OpenAD$ INLINE IncDeriv(subst,subst)
        CALL IncDeriv(__deriv__(Y(INT(OpenAD_Symbol_26))), __deriv__(X(
