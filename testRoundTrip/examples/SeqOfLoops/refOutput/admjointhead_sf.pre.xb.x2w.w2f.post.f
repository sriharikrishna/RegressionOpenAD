...
C adjoint
      ...
      do while (INT(OpenAD_Symbol_4).LE.INT(OpenAD_Symbol_3))
        ...
        OpenAD_prop_0%d = OpenAD_prop_0%d+Y(INT(OpenAD_Symbol_16))%d*(Op
     +enAD_Symbol_17)
        X(INT(OpenAD_Symbol_16))%d = X(INT(OpenAD_Symbol_16))%d+Y(INT(Op
     +enAD_Symbol_16))%d*(OpenAD_Symbol_18)
        Y(INT(OpenAD_Symbol_16))%d = 0.0d0
        Y(INT(OpenAD_Symbol_16))%d = Y(INT(OpenAD_Symbol_16))%d+OpenAD_p
     +rop_0%d
