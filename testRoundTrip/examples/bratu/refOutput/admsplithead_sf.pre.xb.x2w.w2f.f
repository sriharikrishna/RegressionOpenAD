...
C$OPENAD XXX Template ad_template.f
     ...
     > )
      ...
      OpenAD_Symbol_140 = (OpenAD_Symbol_9 * OpenAD_Symbol_6 *
     >  OpenAD_Symbol_3)
...
C     $OpenAD$ INLINE push(subst)
     ...
     >  OpenAD_Symbol_28)))
      ...
      OpenAD_Symbol_144 = (OpenAD_Symbol_38 * OpenAD_Symbol_35 *
     >  OpenAD_Symbol_25)
...
C     $OpenAD$ INLINE push(subst)
     ...
     >  OpenAD_Symbol_46)))
        ...
        OpenAD_Symbol_150 = (OpenAD_Symbol_56 * OpenAD_Symbol_53 *
     >  OpenAD_Symbol_43)
...
C       $OpenAD$ INLINE push_i(subst)
     ...
     >  OpenAD_Symbol_64)))
        ...
        OpenAD_Symbol_157 = (OpenAD_Symbol_74 * OpenAD_Symbol_71 *
     >  OpenAD_Symbol_61)
...
C       $OpenAD$ INLINE push_i(subst)
     ...
     >  OpenAD_Symbol_83)))
        ...
        OpenAD_Symbol_164 = (OpenAD_Symbol_93 * OpenAD_Symbol_90 *
     >  OpenAD_Symbol_80)
...
C     $OpenAD$ INLINE push_i(subst)
     ...
     >  OpenAD_Symbol_101)))
      ...
      OpenAD_Symbol_170 = (OpenAD_Symbol_111 * OpenAD_Symbol_108 *
     >  OpenAD_Symbol_98)
...
C     $OpenAD$ INLINE push(subst)
     ...
     >  OpenAD_Symbol_117)
      ...
      OpenAD_Symbol_180 = (OpenAD_Symbol_122 * OpenAD_Symbol_119 *
     >  OpenAD_Symbol_116)
C     $OpenAD$ INLINE push(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_248, __deriv__(F(7)), __deriv__(X(8)))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_249)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_249, __deriv__(F(7)), __deriv__(X(9)))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_250)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_250, __deriv__(F(7)), __deriv__(X(7)))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_251)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_251, __deriv__(F(7)), __deriv__(X(7)))
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_252, __deriv__(F(6)), __deriv__(X(9)))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_253)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_253, __deriv__(F(6)), __deriv__(X(7)))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_254)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_254, __deriv__(F(6)), __deriv__(X(8)))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_255)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_255, __deriv__(F(6)), __deriv__(X(7)))
C     $OpenAD$ INLINE ZeroDeriv(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(1_w2f__i8, __deriv__(F(INT(OpenAD_Symbol_208))),
     >  __deriv__(X(INT(OpenAD_Symbol_209))))
C       $OpenAD$ INLINE pop_i(subst)
        CALL pop_i(OpenAD_Symbol_210)
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_211)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_211, __deriv__(F(INT(OpenAD_Symbol_210
     > ))), __deriv__(X(9)))
C       $OpenAD$ INLINE pop_i(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_214, __deriv__(F(INT(OpenAD_Symbol_212
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_216, __deriv__(F(INT(OpenAD_Symbol_215
     > ))), __deriv__(X(8)))
C       $OpenAD$ INLINE pop_i(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_219, __deriv__(F(INT(OpenAD_Symbol_217
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_221, __deriv__(F(INT(OpenAD_Symbol_220
     > ))), __deriv__(X(9)))
C       $OpenAD$ INLINE pop_i(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_224, __deriv__(F(INT(OpenAD_Symbol_222
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_226, __deriv__(F(INT(OpenAD_Symbol_225
     > ))), __deriv__(X(8)))
C       $OpenAD$ INLINE pop_i(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(-2.0D00, __deriv__(F(INT(OpenAD_Symbol_227))),
     >  __deriv__(X(INT(OpenAD_Symbol_228))))
C       $OpenAD$ INLINE pop_i(subst)
        CALL pop_i(OpenAD_Symbol_229)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(1_w2f__i8, __deriv__(F(INT(OpenAD_Symbol_229))),
     >  __deriv__(OpenAD_Symbol_160))
C       $OpenAD$ INLINE pop_i(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_232, __deriv__(F(INT(OpenAD_Symbol_230
     > ))), __deriv__(X(INT(OpenAD_Symbol_231))))
C       $OpenAD$ INLINE ZeroDeriv(subst)
        CALL ZeroDeriv(__deriv__(F(INT(OpenAD_Symbol_230))))
C       $OpenAD$ INLINE pop_i(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(1_w2f__i8, __deriv__(F(INT(OpenAD_Symbol_234))),
     >  __deriv__(OpenAD_Symbol_153))
C       $OpenAD$ INLINE pop_i(subst)
        CALL pop_i(OpenAD_Symbol_235)
C       $OpenAD$ INLINE pop_i(subst)
        CALL pop_i(OpenAD_Symbol_236)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(1_w2f__i8, __deriv__(F(INT(OpenAD_Symbol_235))),
     >  __deriv__(X(INT(OpenAD_Symbol_236))))
C       $OpenAD$ INLINE pop_i(subst)
        CALL pop_i(OpenAD_Symbol_237)
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_238)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_238, __deriv__(F(INT(OpenAD_Symbol_237
     > ))), __deriv__(X(9)))
C       $OpenAD$ INLINE pop_i(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_241, __deriv__(F(INT(OpenAD_Symbol_239
     > ))), __deriv__(X(INT(OpenAD_Symbol_240))))
C       $OpenAD$ INLINE pop_i(subst)
        CALL pop_i(OpenAD_Symbol_242)
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_243)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_243, __deriv__(F(INT(OpenAD_Symbol_242
     > ))), __deriv__(X(8)))
C       $OpenAD$ INLINE pop_i(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_246, __deriv__(F(INT(OpenAD_Symbol_244
     > ))), __deriv__(X(INT(OpenAD_Symbol_245))))
C       $OpenAD$ INLINE ZeroDeriv(subst)
        CALL ZeroDeriv(__deriv__(F(INT(OpenAD_Symbol_244))))
C       $OpenAD$ INLINE pop_i(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_202, __deriv__(F(2)), __deriv__(X(8)))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_203)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_203, __deriv__(F(2)), __deriv__(X(1)))
C     $OpenAD$ INLINE ZeroDeriv(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_204, __deriv__(F(1)), __deriv__(X(8)))
C     $OpenAD$ INLINE Pop(subst)
      CALL Pop(OpenAD_Symbol_205)
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_205, __deriv__(F(1)), __deriv__(X(9)))
C     $OpenAD$ INLINE Pop(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_207, __deriv__(F(1)), __deriv__(X(1)))
C     $OpenAD$ INLINE ZeroDeriv(subst)
