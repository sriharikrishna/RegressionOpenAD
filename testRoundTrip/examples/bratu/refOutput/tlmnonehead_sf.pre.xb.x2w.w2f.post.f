...
C$OPENAD XXX Template ad_template.f
     ...
     +bol_4)
      ...
      CALL saxpy(OpenAD_Symbol_129,X(8),F(1))
      CALL saxpy(OpenAD_Symbol_130,X(1),F(1))
      CALL saxpy(OpenAD_Symbol_132,X(1),F(1))
      CALL saxpy(OpenAD_Symbol_133,X(9),F(1))
     ...
     +ol_24)
      ...
      CALL saxpy(OpenAD_Symbol_135,X(8),F(2))
      CALL saxpy(OpenAD_Symbol_136,X(1),F(2))
      CALL saxpy(OpenAD_Symbol_138,X(1),F(2))
      CALL saxpy(OpenAD_Symbol_139,X(9),F(2))
      DO I = 2,6,1
     ...
     +mbol_41)
        ...
        CALL saxpy(OpenAD_Symbol_141,X(8),F(I+(-1)))
        CALL saxpy(OpenAD_Symbol_142,X(I),F(I+(-1)))
        CALL saxpy(OpenAD_Symbol_144,X(I),F(I+(-1)))
        CALL saxpy(OpenAD_Symbol_145,X(9),F(I+(-1)))
     ...
     +mbol_58)
        ...
        CALL saxpy(OpenAD_Symbol_147,X(8),F(I))
        CALL saxpy(OpenAD_Symbol_148,X(I),F(I))
        CALL saxpy(OpenAD_Symbol_150,X(I),F(I))
        CALL saxpy(OpenAD_Symbol_151,X(9),F(I))
     ...
     +mbol_76)
        ...
        CALL setderiv(F(I+1),X(I))
        CALL saxpy(OpenAD_Symbol_153,X(8),F(I+1))
        CALL saxpy(OpenAD_Symbol_154,X(I),F(I+1))
        CALL saxpy(OpenAD_Symbol_156,X(I),F(I+1))
        CALL saxpy(OpenAD_Symbol_157,X(9),F(I+1))
      END DO
     ...
     +mbol_93)
      ...
      CALL saxpy(OpenAD_Symbol_159,X(8),F(6))
      CALL saxpy(OpenAD_Symbol_160,X(7),F(6))
      CALL saxpy(OpenAD_Symbol_162,X(7),F(6))
      CALL saxpy(OpenAD_Symbol_163,X(9),F(6))
     ...
     +mbol_111)
      ...
      CALL saxpy(OpenAD_Symbol_165,X(8),F(7))
      CALL saxpy(OpenAD_Symbol_166,X(7),F(7))
      CALL saxpy(OpenAD_Symbol_168,X(7),F(7))
      CALL saxpy(OpenAD_Symbol_169,X(9),F(7))
      END SUBROUTINE
