...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_33)
      ...
      CALL saxpy(OpenAD_Symbol_180,X(1),F(2))
      CALL saxpy(OpenAD_Symbol_181,X(9),F(2))
      CALL saxpy(OpenAD_Symbol_182,X(8),F(2))
     ...
     >  OpenAD_Symbol_56)
        ...
        CALL saxpy(OpenAD_Symbol_184,X(I),F(I+(-1)))
        CALL saxpy(OpenAD_Symbol_186,X(I),F(I+(-1)))
        CALL saxpy(OpenAD_Symbol_187,X(9),F(I+(-1)))
        CALL saxpy(OpenAD_Symbol_188,X(8),F(I+(-1)))
     ...
     >  OpenAD_Symbol_77)
        ...
        CALL sax(1 _w2f__i8,OpenAD_Symbol_196,F(I))
        CALL saxpy(OpenAD_Symbol_191,X(I),F(I))
        CALL saxpy(OpenAD_Symbol_193,X(I),F(I))
        CALL saxpy(OpenAD_Symbol_194,X(9),F(I))
        CALL saxpy(-2.0D00,X(I),F(I))
        CALL saxpy(OpenAD_Symbol_195,X(8),F(I))
     ...
     >  OpenAD_Symbol_102)
        ...
        CALL saxpy(OpenAD_Symbol_200,X(I),F(I+1))
        CALL saxpy(OpenAD_Symbol_201,X(9),F(I+1))
        CALL saxpy(OpenAD_Symbol_202,X(8),F(I+1))
     ...
     >  OpenAD_Symbol_125)
      ...
      CALL sax(1 _w2f__i8,X(7),F(6))
      CALL saxpy(1 _w2f__i8,OpenAD_Symbol_209,F(6))
      CALL saxpy(OpenAD_Symbol_204,X(7),F(6))
      CALL saxpy(OpenAD_Symbol_206,X(7),F(6))
      CALL saxpy(OpenAD_Symbol_207,X(9),F(6))
      CALL saxpy(OpenAD_Symbol_208,X(8),F(6))
