...
C$OPENAD XXX Template ad_template.f
     ...
     > ))))
        ...
        CALL inc_deriv(__deriv__(F(I + (-1))), __deriv__(
     > OpenAD_Symbol_153))
     ...
     >  OpenAD_Symbol_61)
        ...
        CALL setderiv(__deriv__(F(I)), __deriv__(OpenAD_Symbol_160))
        CALL saxpy(-2.0D00, __deriv__(X(I)), __deriv__(F(I)))
        CALL saxpy(OpenAD_Symbol_155, __deriv__(X(8)), __deriv__(F(I)))
     ...
     >  OpenAD_Symbol_98)
      ...
      CALL inc_deriv(__deriv__(F(6)), __deriv__(OpenAD_Symbol_173))
      CALL saxpy(OpenAD_Symbol_168, __deriv__(X(8)), __deriv__(F(6)))
      ...
      CALL setderiv(__deriv__(F(7)), __deriv__(OpenAD_Symbol_174))
     ...
     >  OpenAD_Symbol_117)
      ...
      CALL setderiv(__deriv__(F(7)), __deriv__(OpenAD_Symbol_181))
