...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_43)
        ...
        CALL inc_deriv(F(I+(-1)),OpenAD_Symbol_153)
     ...
     >  OpenAD_Symbol_61)
        ...
        CALL setderiv(F(I),OpenAD_Symbol_160)
        CALL saxpy(-2.0D00,X(I),F(I))
        CALL saxpy(OpenAD_Symbol_155,X(8),F(I))
     ...
     >  OpenAD_Symbol_98)
      ...
      CALL inc_deriv(F(6),OpenAD_Symbol_173)
      CALL saxpy(OpenAD_Symbol_168,X(8),F(6))
      ...
      CALL setderiv(F(7),OpenAD_Symbol_174)
     ...
     >  OpenAD_Symbol_117)
      ...
      CALL setderiv(F(7),OpenAD_Symbol_181)
