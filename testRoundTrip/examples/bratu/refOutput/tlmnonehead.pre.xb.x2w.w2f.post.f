...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_4)
      ...
      CALL sax(OpenAD_Symbol_136,X(8),F(1))
     ...
     >  OpenAD_Symbol_43)
        ...
        CALL sax(OpenAD_Symbol_148,X(8),F(I+(-1)))
     ...
     >  OpenAD_Symbol_61)
        ...
        CALL sax(OpenAD_Symbol_155,X(8),F(I))
        CALL saxpy(OpenAD_Symbol_156,X(I),F(I))
     ...
     >  OpenAD_Symbol_80)
        ...
        CALL sax(1_w2f__i8,X(I),F(I+1))
        CALL saxpy(OpenAD_Symbol_162,X(8),F(I+1))
     ...
     >  OpenAD_Symbol_98)
      ...
      CALL sax(OpenAD_Symbol_168,X(8),F(6))
      ...
      CALL sax(1_w2f__i8,OpenAD_Symbol_174,F(7))
     ...
     >  OpenAD_Symbol_117)
      ...
      CALL sax(1_w2f__i8,OpenAD_Symbol_181,F(7))
      CALL saxpy(OpenAD_Symbol_176,X(8),F(7))
      CALL saxpy(OpenAD_Symbol_177,X(7),F(7))
      CALL saxpy(OpenAD_Symbol_179,X(7),F(7))
      CALL saxpy(OpenAD_Symbol_180,X(9),F(7))
      END SUBROUTINE
