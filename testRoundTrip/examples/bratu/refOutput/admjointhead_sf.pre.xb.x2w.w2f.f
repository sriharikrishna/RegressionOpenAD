...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(1_w2f__i8, __deriv__(F(INT(OpenAD_Symbol_217))),
     >  __deriv__(X(INT(OpenAD_Symbol_208))))
C       $OpenAD$ INLINE ZeroDeriv(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(1_w2f__i8, __deriv__(F(INT(OpenAD_Symbol_228))),
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_224, __deriv__(F(INT(OpenAD_Symbol_230
     > ))), __deriv__(X(9)))
C       $OpenAD$ INLINE pop_i(subst)
        CALL pop_i(OpenAD_Symbol_231)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_225, __deriv__(F(INT(OpenAD_Symbol_231
     > ))), __deriv__(X(INT(OpenAD_Symbol_223))))
C       $OpenAD$ INLINE pop_i(subst)
        CALL pop_i(OpenAD_Symbol_232)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_226, __deriv__(F(INT(OpenAD_Symbol_232
     > ))), __deriv__(X(INT(OpenAD_Symbol_223))))
C       $OpenAD$ INLINE pop_i(subst)
        CALL pop_i(OpenAD_Symbol_233)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_227, __deriv__(F(INT(OpenAD_Symbol_233
     > ))), __deriv__(X(8)))
C       $OpenAD$ INLINE ZeroDeriv(subst)
