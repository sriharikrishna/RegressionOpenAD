...
C$OPENAD XXX Template ad_template.f
     ...
     > __value__(NRM3) ** 2))
      ...
      OpenAD_lin_4 = (2 *(__value__(NRM3) **(2 - INT(1_w2f__i8))))
      ...
      OpenAD_lin_7 = __value__(NRM1)
      __value__(NYHAT) = (__value__(NRM2) * __value__(NSIZEI))
      OpenAD_lin_8 = __value__(NSIZEI)
      OpenAD_lin_9 = __value__(NRM2)
      __value__(NZHAT) = (__value__(NRM3) * __value__(NSIZEI))
      OpenAD_lin_10 = __value__(NSIZEI)
      OpenAD_lin_11 = __value__(NRM3)
      OpenAD_lin_14 = (__value__(PRIMR2) / __value__(PRIML2))
      OpenAD_lin_12 = (SIN(OpenAD_lin_14) + 1.0D00)
      __value__(ROEL) = (1.0D00 / OpenAD_lin_12)
      OpenAD_lin_16 = (INT(1_w2f__i8) / __value__(PRIML2))
      OpenAD_lin_17 = (-(__value__(PRIMR2) /(__value__(PRIML2) *
     >  __value__(PRIML2))))
      OpenAD_lin_15 = COS(OpenAD_lin_14)
      OpenAD_lin_13 = (-(1.0D00 /(OpenAD_lin_12 * OpenAD_lin_12)))
      __value__(ROER) = (1.0D00 - __value__(ROEL))
      OpenAD_lin_18 = ((__value__(PRIML3) ** 2) +(__value__(PRIML4) **
     >  2) +(__value__(PRIML5) ** 2))
      __value__(THETAL) = (OpenAD_lin_18 * 5.0D-01)
      OpenAD_lin_19 = (2 *(__value__(PRIML3) **(2 - INT(1_w2f__i8))))
      OpenAD_lin_20 = (2 *(__value__(PRIML4) **(2 - INT(1_w2f__i8))))
      OpenAD_lin_21 = (2 *(__value__(PRIML5) **(2 - INT(1_w2f__i8))))
      OpenAD_lin_22 = ((__value__(PRIMR3) ** 2) +(__value__(PRIMR4) **
     >  2) +(__value__(PRIMR5) ** 2))
      __value__(THETAR) = (OpenAD_lin_22 * 5.0D-01)
      OpenAD_lin_23 = (2 *(__value__(PRIMR3) **(2 - INT(1_w2f__i8))))
      OpenAD_lin_24 = (2 *(__value__(PRIMR4) **(2 - INT(1_w2f__i8))))
      OpenAD_lin_25 = (2 *(__value__(PRIMR5) **(2 - INT(1_w2f__i8))))
      OpenAD_lin_29 = (__value__(GAMMA) * __value__(GM1INV))
      OpenAD_lin_26 = (__value__(PRIML1) * OpenAD_lin_29)
     ...
     > PRIML2)))
      ...
      OpenAD_lin_31 = __value__(PRIML1)
      OpenAD_lin_27 = (INT(1_w2f__i8) / __value__(PRIML2))
      OpenAD_lin_28 = (-(OpenAD_lin_26 /(__value__(PRIML2) * __value__(
     > PRIML2))))
      OpenAD_lin_37 = (__value__(GAMMA) * __value__(GM1INV))
      OpenAD_lin_34 = (__value__(PRIMR1) * OpenAD_lin_37)
     ...
     > ) * OpenAD_lin_45))
      ...
      CALL sax(OpenAD_lin_4, __deriv__(NRM3), __deriv__(OpenAD_prp_0))
      CALL saxpy(OpenAD_lin_2, __deriv__(NRM1), __deriv__(OpenAD_prp_0)
     > )
      CALL saxpy(OpenAD_lin_3, __deriv__(NRM2), __deriv__(OpenAD_prp_0)
     > )
      CALL sax(OpenAD_acc_12, __deriv__(PRIMR2), __deriv__(OpenAD_prp_1
     > ))
      CALL saxpy(OpenAD_acc_13, __deriv__(PRIML2), __deriv__(
     > OpenAD_prp_1))
      CALL sax(OpenAD_lin_21, __deriv__(PRIML5), __deriv__(OpenAD_prp_2
     > ))
      CALL saxpy(OpenAD_lin_19, __deriv__(PRIML3), __deriv__(
     > OpenAD_prp_2))
      CALL saxpy(OpenAD_lin_20, __deriv__(PRIML4), __deriv__(
     > OpenAD_prp_2))
      CALL sax(OpenAD_lin_25, __deriv__(PRIMR5), __deriv__(OpenAD_prp_3
     > ))
      CALL saxpy(OpenAD_lin_23, __deriv__(PRIMR3), __deriv__(
     > OpenAD_prp_3))
      CALL saxpy(OpenAD_lin_24, __deriv__(PRIMR4), __deriv__(
     > OpenAD_prp_3))
      CALL sax(OpenAD_lin_1, __deriv__(OpenAD_prp_0), __deriv__(NSIZE))
      CALL sax(OpenAD_lin_6, __deriv__(NRM1), __deriv__(NXHAT))
      CALL saxpy(OpenAD_acc_2, __deriv__(NSIZE), __deriv__(NXHAT))
      CALL sax(OpenAD_lin_8, __deriv__(NRM2), __deriv__(NYHAT))
      CALL saxpy(OpenAD_acc_3, __deriv__(NSIZE), __deriv__(NYHAT))
      CALL sax(OpenAD_lin_10, __deriv__(NRM3), __deriv__(NZHAT))
      ...
      CALL saxpy(OpenAD_lin_28, __deriv__(PRIML2), __deriv__(HL))
      ...
      CALL saxpy(OpenAD_lin_36, __deriv__(PRIMR2), __deriv__(HR))
      ...
      CALL sax(OpenAD_lin_44, __deriv__(PRIMR3), __deriv__(UAVE))
      CALL saxpy(OpenAD_acc_11, __deriv__(OpenAD_prp_1), __deriv__(UAVE
     > ))
      CALL saxpy(OpenAD_lin_42, __deriv__(PRIML3), __deriv__(UAVE))
      CALL sax(OpenAD_lin_48, __deriv__(PRIMR4), __deriv__(VAVE))
      CALL saxpy(OpenAD_lin_46, __deriv__(PRIML4), __deriv__(VAVE))
      CALL saxpy(OpenAD_acc_10, __deriv__(OpenAD_prp_1), __deriv__(VAVE
     > ))
      CALL sax(OpenAD_lin_52, __deriv__(PRIMR5), __deriv__(WAVE))
      CALL saxpy(OpenAD_lin_50, __deriv__(PRIML5), __deriv__(WAVE))
      CALL saxpy(OpenAD_acc_9, __deriv__(OpenAD_prp_1), __deriv__(WAVE)
     > )
      CALL sax(OpenAD_lin_61, __deriv__(WAVE), __deriv__(OpenAD_prp_4))
      CALL saxpy(OpenAD_lin_60, __deriv__(VAVE), __deriv__(OpenAD_prp_4
     > ))
      CALL saxpy(OpenAD_lin_59, __deriv__(UAVE), __deriv__(OpenAD_prp_4
     > ))
     ...
     >  __value__(NYHAT) * __value__(UAVE))
      ...
      CALL sax(OpenAD_lin_65, __deriv__(OpenAD_prp_5), __deriv__(CAVE))
      ...
      OpenAD_lin_84 = (__value__(LAMCM) - __value__(ALAMCM))
      __value__(ALAMCM) = (OpenAD_lin_84 * 5.0D-01)
      OpenAD_lin_85 = (__value__(LAMCP) - __value__(ALAMCP))
      __value__(ALAMCP) = (OpenAD_lin_85 * 5.0D-01)
      OpenAD_lin_86 = (__value__(LAMU) - __value__(ALAMU))
      __value__(ALAMU) = (OpenAD_lin_86 * 5.0D-01)
      __value__(EL) = (__value__(PRIML1) * __value__(GM1INV) +
     >  __value__(PRIML2) * __value__(THETAL))
      OpenAD_lin_87 = __value__(GM1INV)
      OpenAD_lin_88 = __value__(PRIML1)
      OpenAD_lin_89 = __value__(THETAL)
      OpenAD_lin_90 = __value__(PRIML2)
      __value__(RUL) = (__value__(PRIML2) * __value__(PRIML3))
      OpenAD_lin_91 = __value__(PRIML3)
      OpenAD_lin_92 = __value__(PRIML2)
      __value__(RVL) = (__value__(PRIML2) * __value__(PRIML4))
      OpenAD_lin_93 = __value__(PRIML4)
      OpenAD_lin_94 = __value__(PRIML2)
      __value__(RWL) = (__value__(PRIML2) * __value__(PRIML5))
      OpenAD_lin_95 = __value__(PRIML5)
      OpenAD_lin_96 = __value__(PRIML2)
      __value__(ER) = (__value__(PRIMR1) * __value__(GM1INV) +
     >  __value__(PRIMR2) * __value__(THETAR))
      OpenAD_lin_97 = __value__(GM1INV)
      OpenAD_lin_98 = __value__(PRIMR1)
      OpenAD_lin_99 = __value__(THETAR)
      OpenAD_lin_100 = __value__(PRIMR2)
      __value__(RUR) = (__value__(PRIMR2) * __value__(PRIMR3))
      OpenAD_lin_101 = __value__(PRIMR3)
      OpenAD_lin_102 = __value__(PRIMR2)
      __value__(RVR) = (__value__(PRIMR2) * __value__(PRIMR4))
      OpenAD_lin_103 = __value__(PRIMR4)
      OpenAD_lin_104 = __value__(PRIMR2)
      __value__(RWR) = (__value__(PRIMR2) * __value__(PRIMR5))
      OpenAD_lin_105 = __value__(PRIMR5)
      OpenAD_lin_106 = __value__(PRIMR2)
     ...
     > DRV) * __value__(VAVE) + __value__(DRW) * __value__(WAVE))
      OpenAD_lin_107 = __value__(UAVE)
      OpenAD_lin_108 = __value__(DRU)
      OpenAD_lin_109 = __value__(VAVE)
      OpenAD_lin_110 = __value__(DRV)
      OpenAD_lin_111 = __value__(WAVE)
      OpenAD_lin_112 = __value__(DRW)
      OpenAD_lin_113 = (__value__(GM1) / __value__(CAVE))
      OpenAD_lin_114 = (__value__(DE) + __value__(DR) * __value__(
     > THTAVE) - __value__(UDDRU))
      __value__(OMEGA) = (OpenAD_lin_113 * OpenAD_lin_114)
      OpenAD_lin_117 = (INT(1_w2f__i8) / __value__(CAVE))
      OpenAD_lin_118 = (-(__value__(GM1) /(__value__(CAVE) * __value__(
     > CAVE))))
      OpenAD_lin_115 = OpenAD_lin_114
      OpenAD_lin_119 = __value__(THTAVE)
      OpenAD_lin_120 = __value__(DR)
     ...
     > (DRV) * __value__(NYHAT) + __value__(DRW) * __value__(NZHAT))
      OpenAD_lin_121 = __value__(NXHAT)
      OpenAD_lin_122 = __value__(DRU)
      OpenAD_lin_123 = __value__(NYHAT)
      OpenAD_lin_124 = __value__(DRV)
      OpenAD_lin_125 = __value__(NZHAT)
      OpenAD_lin_126 = __value__(DRW)
      OpenAD_lin_127 = (__value__(OMEGA) + __value__(DR) * __value__(
     > UHAT) - __value__(NDDRU))
      __value__(ALP1) = (OpenAD_lin_127 * 5.0D-01)
      OpenAD_lin_128 = __value__(UHAT)
      OpenAD_lin_129 = __value__(DR)
      OpenAD_lin_132 = (__value__(CAVE) * __value__(NXHAT) - __value__(
     > UTILDE))
      OpenAD_lin_137 = (- __value__(NXHAT))
      __value__(ALP2) = (__value__(DRW) * __value__(NYHAT) + __value__(
     > DR) * OpenAD_lin_132 + __value__(OMEGA) * OpenAD_lin_137 -
     >  __value__(DRV) * __value__(NZHAT))
      OpenAD_lin_130 = __value__(NYHAT)
      OpenAD_lin_131 = __value__(DRW)
      OpenAD_lin_133 = OpenAD_lin_132
      OpenAD_lin_135 = __value__(NXHAT)
      OpenAD_lin_136 = __value__(CAVE)
      OpenAD_lin_134 = __value__(DR)
      OpenAD_lin_138 = OpenAD_lin_137
      OpenAD_lin_139 = __value__(OMEGA)
      OpenAD_lin_140 = __value__(NZHAT)
      OpenAD_lin_141 = __value__(DRV)
      OpenAD_lin_144 = (__value__(CAVE) * __value__(NYHAT) - __value__(
     > VTILDE))
      OpenAD_lin_149 = (- __value__(NYHAT))
     ...
     >  __value__(DRW) * __value__(NXHAT))
      OpenAD_lin_142 = __value__(NZHAT)
      OpenAD_lin_143 = __value__(DRU)
      OpenAD_lin_145 = OpenAD_lin_144
      OpenAD_lin_147 = __value__(NYHAT)
      OpenAD_lin_148 = __value__(CAVE)
      OpenAD_lin_146 = __value__(DR)
      OpenAD_lin_150 = OpenAD_lin_149
      OpenAD_lin_151 = __value__(OMEGA)
      OpenAD_lin_152 = __value__(NXHAT)
      OpenAD_lin_153 = __value__(DRW)
      OpenAD_lin_156 = (__value__(CAVE) * __value__(NZHAT) - __value__(
     > WTILDE))
     ...
     >  __value__(DRU) * __value__(NYHAT))
      ...
      OpenAD_lin_155 = __value__(DRV)
      OpenAD_lin_157 = OpenAD_lin_156
      OpenAD_lin_159 = __value__(NZHAT)
      ...
      OpenAD_lin_166 = (__value__(NDDRU) + __value__(OMEGA) - __value__
     > (DR) * __value__(UHAT))
      __value__(ALP5) = (OpenAD_lin_166 * 5.0D-01)
     ...
     >  5.0D-01)
      ...
      OpenAD_acc_48 = (OpenAD_lin_128 * 5.0D-01 + OpenAD_acc_42 *
     >  5.0D-01)
      ...
      CALL sax(OpenAD_lin_91, __deriv__(PRIML2), __deriv__(RUL))
      CALL saxpy(OpenAD_lin_92, __deriv__(PRIML3), __deriv__(RUL))
      CALL sax(OpenAD_lin_93, __deriv__(PRIML2), __deriv__(RVL))
      CALL saxpy(OpenAD_lin_94, __deriv__(PRIML4), __deriv__(RVL))
      CALL sax(OpenAD_lin_95, __deriv__(PRIML2), __deriv__(RWL))
      CALL saxpy(OpenAD_lin_96, __deriv__(PRIML5), __deriv__(RWL))
      ...
      CALL saxpy(OpenAD_lin_101, __deriv__(PRIMR2), __deriv__(DRU))
      CALL saxpy(OpenAD_lin_102, __deriv__(PRIMR3), __deriv__(DRU))
      CALL set_neg_deriv(__deriv__(DRV), __deriv__(RVL))
      CALL saxpy(OpenAD_lin_103, __deriv__(PRIMR2), __deriv__(DRV))
      CALL saxpy(OpenAD_lin_104, __deriv__(PRIMR4), __deriv__(DRV))
      CALL set_neg_deriv(__deriv__(DRW), __deriv__(RWL))
      CALL saxpy(OpenAD_lin_105, __deriv__(PRIMR2), __deriv__(DRW))
      CALL saxpy(OpenAD_lin_106, __deriv__(PRIMR5), __deriv__(DRW))
      ...
      CALL sax(OpenAD_lin_87, __deriv__(PRIML1), __deriv__(EL))
      CALL saxpy(OpenAD_lin_88, __deriv__(GM1INV), __deriv__(EL))
      CALL saxpy(OpenAD_lin_89, __deriv__(PRIML2), __deriv__(EL))
      CALL saxpy(OpenAD_lin_90, __deriv__(THETAL), __deriv__(EL))
      CALL set_neg_deriv(__deriv__(DE), __deriv__(EL))
      CALL saxpy(OpenAD_lin_97, __deriv__(PRIMR1), __deriv__(DE))
      CALL saxpy(OpenAD_lin_98, __deriv__(GM1INV), __deriv__(DE))
      CALL saxpy(OpenAD_lin_99, __deriv__(PRIMR2), __deriv__(DE))
      CALL saxpy(OpenAD_lin_100, __deriv__(THETAR), __deriv__(DE))
      CALL sax(OpenAD_lin_125, __deriv__(DRW), __deriv__(NDDRU))
      CALL saxpy(OpenAD_lin_126, __deriv__(NZHAT), __deriv__(NDDRU))
      CALL saxpy(OpenAD_lin_123, __deriv__(DRV), __deriv__(NDDRU))
      CALL saxpy(OpenAD_lin_124, __deriv__(NYHAT), __deriv__(NDDRU))
      CALL saxpy(OpenAD_lin_121, __deriv__(DRU), __deriv__(NDDRU))
      CALL saxpy(OpenAD_lin_122, __deriv__(NXHAT), __deriv__(NDDRU))
      ...
      CALL saxpy(OpenAD_lin_116, __deriv__(DE), __deriv__(OMEGA))
      ...
      CALL sax(OpenAD_lin_138, __deriv__(OMEGA), __deriv__(ALP2))
      ...
      CALL saxpy(OpenAD_lin_130, __deriv__(DRW), __deriv__(ALP2))
      CALL saxpy(OpenAD_lin_131, __deriv__(NYHAT), __deriv__(ALP2))
      CALL saxpy(OpenAD_acc_57, __deriv__(DRV), __deriv__(ALP2))
      CALL saxpy(OpenAD_acc_58, __deriv__(NZHAT), __deriv__(ALP2))
      CALL sax(OpenAD_lin_150, __deriv__(OMEGA), __deriv__(ALP3))
      ...
      CALL saxpy(OpenAD_lin_142, __deriv__(DRU), __deriv__(ALP3))
      CALL saxpy(OpenAD_lin_143, __deriv__(NZHAT), __deriv__(ALP3))
      CALL saxpy(OpenAD_acc_55, __deriv__(DRW), __deriv__(ALP3))
      CALL saxpy(OpenAD_acc_56, __deriv__(NXHAT), __deriv__(ALP3))
      CALL sax(OpenAD_lin_162, __deriv__(OMEGA), __deriv__(ALP4))
      ...
      CALL saxpy(OpenAD_lin_154, __deriv__(DRV), __deriv__(ALP4))
      CALL saxpy(OpenAD_lin_155, __deriv__(NXHAT), __deriv__(ALP4))
     ...
     >  __value__(CAVE))))
      ...
      OpenAD_lin_189 = (__value__(GM1INV) * __value__(CAVE))
      __value__(DSS1) = (__value__(MU) * __value__(THTAVE) + __value__(
     > ALP15P) * OpenAD_lin_189 - __value__(ALP15M) * __value__(UHAT) +
     ...
     >  __value__(VTILDE) + __value__(ALP4) * __value__(WTILDE))
      ...
      OpenAD_lin_192 = __value__(CAVE)
      OpenAD_lin_193 = __value__(GM1INV)
      OpenAD_lin_191 = __value__(ALP15P)
      OpenAD_lin_194 = __value__(UHAT)
      OpenAD_lin_195 = __value__(ALP15M)
      OpenAD_lin_196 = __value__(UTILDE)
      OpenAD_lin_197 = __value__(ALP2)
      OpenAD_lin_198 = __value__(VTILDE)
      OpenAD_lin_199 = __value__(ALP3)
      OpenAD_lin_200 = __value__(WTILDE)
      OpenAD_lin_201 = __value__(ALP4)
     ...
     >  __value__(ALP4) * __value__(NYHAT))
      OpenAD_lin_202 = __value__(NZHAT)
      OpenAD_lin_203 = __value__(ALP3)
      OpenAD_lin_204 = __value__(UAVE)
      OpenAD_lin_205 = __value__(MU)
      OpenAD_lin_206 = __value__(NXHAT)
      OpenAD_lin_207 = __value__(ALP15M)
      OpenAD_lin_208 = __value__(NYHAT)
      OpenAD_lin_209 = __value__(ALP4)
     ...
     >  __value__(ALP2) * __value__(NZHAT))
      OpenAD_lin_210 = __value__(NXHAT)
      OpenAD_lin_211 = __value__(ALP4)
      OpenAD_lin_212 = __value__(VAVE)
      OpenAD_lin_213 = __value__(MU)
      OpenAD_lin_214 = __value__(NYHAT)
      OpenAD_lin_215 = __value__(ALP15M)
      OpenAD_lin_216 = __value__(NZHAT)
      OpenAD_lin_217 = __value__(ALP2)
     ...
     >  __value__(ALP3) * __value__(NXHAT))
      OpenAD_lin_218 = __value__(NYHAT)
      OpenAD_lin_219 = __value__(ALP2)
      OpenAD_lin_220 = __value__(WAVE)
      OpenAD_lin_221 = __value__(MU)
      OpenAD_lin_222 = __value__(NZHAT)
      OpenAD_lin_223 = __value__(ALP15M)
      OpenAD_lin_224 = __value__(NXHAT)
      OpenAD_lin_225 = __value__(ALP3)
      __value__(UHATL) = (__value__(PRIML3) * __value__(NXHAT) +
     >  __value__(PRIML4) * __value__(NYHAT) + __value__(PRIML5) *
     >  __value__(NZHAT))
      OpenAD_lin_226 = __value__(NXHAT)
      OpenAD_lin_227 = __value__(PRIML3)
      OpenAD_lin_228 = __value__(NYHAT)
      OpenAD_lin_229 = __value__(PRIML4)
      OpenAD_lin_230 = __value__(NZHAT)
      OpenAD_lin_231 = __value__(PRIML5)
      OpenAD_lin_235 = (__value__(PRIML1) + __value__(EL))
      OpenAD_lin_232 = (__value__(DSS1) + __value__(UHATL) *
     >  OpenAD_lin_235)
      __value__(FLUX1) = (__value__(NSIZE) * OpenAD_lin_232)
      OpenAD_lin_233 = OpenAD_lin_232
      OpenAD_lin_236 = OpenAD_lin_235
      OpenAD_lin_237 = __value__(UHATL)
      OpenAD_lin_234 = __value__(NSIZE)
      OpenAD_lin_238 = (__value__(DSS2) + __value__(PRIML2) * __value__
     > (UHATL))
      __value__(FLUX2) = (__value__(NSIZE) * OpenAD_lin_238)
      OpenAD_lin_239 = OpenAD_lin_238
      OpenAD_lin_241 = __value__(UHATL)
      OpenAD_lin_242 = __value__(PRIML2)
      OpenAD_lin_240 = __value__(NSIZE)
      OpenAD_lin_243 = (__value__(DSS3) + __value__(PRIML1) * __value__
     > (NXHAT) + __value__(RUL) * __value__(UHATL))
      __value__(FLUX3) = (__value__(NSIZE) * OpenAD_lin_243)
      OpenAD_lin_244 = OpenAD_lin_243
      OpenAD_lin_246 = __value__(NXHAT)
      OpenAD_lin_247 = __value__(PRIML1)
      OpenAD_lin_248 = __value__(UHATL)
      OpenAD_lin_249 = __value__(RUL)
      OpenAD_lin_245 = __value__(NSIZE)
      OpenAD_lin_250 = (__value__(DSS4) + __value__(PRIML1) * __value__
     > (NYHAT) + __value__(RVL) * __value__(UHATL))
      __value__(FLUX4) = (__value__(NSIZE) * OpenAD_lin_250)
      OpenAD_lin_251 = OpenAD_lin_250
      OpenAD_lin_253 = __value__(NYHAT)
      OpenAD_lin_254 = __value__(PRIML1)
      OpenAD_lin_255 = __value__(UHATL)
      OpenAD_lin_256 = __value__(RVL)
      OpenAD_lin_252 = __value__(NSIZE)
      OpenAD_lin_257 = (__value__(DSS5) + __value__(PRIML1) * __value__
     > (NZHAT) + __value__(RWL) * __value__(UHATL))
      __value__(FLUX5) = (__value__(NSIZE) * OpenAD_lin_257)
      OpenAD_lin_258 = OpenAD_lin_257
      OpenAD_lin_260 = __value__(NZHAT)
      OpenAD_lin_261 = __value__(PRIML1)
      OpenAD_lin_262 = __value__(UHATL)
      OpenAD_lin_263 = __value__(RWL)
      OpenAD_lin_259 = __value__(NSIZE)
      ...
      OpenAD_acc_98 = (OpenAD_lin_223 * OpenAD_acc_84 + OpenAD_lin_261
     >  * OpenAD_lin_259)
      ...
      OpenAD_acc_102 = (OpenAD_lin_215 * OpenAD_acc_88 + OpenAD_lin_254
     >  * OpenAD_lin_252)
      ...
      OpenAD_acc_106 = (OpenAD_lin_207 * OpenAD_acc_92 + OpenAD_lin_247
     >  * OpenAD_lin_245)
      ...
      OpenAD_acc_111 = (OpenAD_lin_192 * OpenAD_lin_191 *
     >  OpenAD_lin_234)
      OpenAD_acc_112 = (OpenAD_lin_193 * OpenAD_lin_191 *
     >  OpenAD_lin_234)
      ...
      CALL sax(OpenAD_lin_169, __deriv__(ALAMCM), __deriv__(ALP1))
      CALL saxpy(OpenAD_lin_170, __deriv__(OpenAD_prp_12), __deriv__(
     > ALP1))
      CALL sax(OpenAD_lin_171, __deriv__(ALAMU), __deriv__(ALP2))
      CALL saxpy(OpenAD_lin_172, __deriv__(OpenAD_prp_13), __deriv__(
     > ALP2))
      CALL sax(OpenAD_lin_173, __deriv__(ALAMU), __deriv__(ALP3))
      CALL saxpy(OpenAD_lin_174, __deriv__(OpenAD_prp_14), __deriv__(
     > ALP3))
      CALL sax(OpenAD_lin_175, __deriv__(ALAMU), __deriv__(ALP4))
      CALL saxpy(OpenAD_lin_176, __deriv__(OpenAD_prp_15), __deriv__(
     > ALP4))
      CALL sax(OpenAD_lin_177, __deriv__(ALAMCP), __deriv__(ALP5))
      CALL saxpy(OpenAD_lin_178, __deriv__(OpenAD_prp_16), __deriv__(
     > ALP5))
      ...
      CALL sax(OpenAD_lin_226, __deriv__(PRIML3), __deriv__(UHATL))
      CALL saxpy(OpenAD_lin_227, __deriv__(NXHAT), __deriv__(UHATL))
      CALL saxpy(OpenAD_lin_228, __deriv__(PRIML4), __deriv__(UHATL))
      CALL saxpy(OpenAD_lin_229, __deriv__(NYHAT), __deriv__(UHATL))
      CALL saxpy(OpenAD_lin_230, __deriv__(PRIML5), __deriv__(UHATL))
      CALL saxpy(OpenAD_lin_231, __deriv__(NZHAT), __deriv__(UHATL))
      CALL sax(OpenAD_lin_179, __deriv__(ALP15P), __deriv__(MU))
      CALL saxpy(OpenAD_lin_180, __deriv__(CAVE), __deriv__(MU))
      CALL saxpy(OpenAD_lin_181, __deriv__(ALP2), __deriv__(MU))
      CALL saxpy(OpenAD_lin_182, __deriv__(NXHAT), __deriv__(MU))
      CALL saxpy(OpenAD_lin_183, __deriv__(ALP3), __deriv__(MU))
      CALL saxpy(OpenAD_lin_184, __deriv__(NYHAT), __deriv__(MU))
      CALL saxpy(OpenAD_lin_185, __deriv__(ALP4), __deriv__(MU))
      CALL saxpy(OpenAD_lin_186, __deriv__(NZHAT), __deriv__(MU))
      CALL sax(OpenAD_lin_239, __deriv__(NSIZE), __deriv__(FLUX2))
      CALL saxpy(OpenAD_acc_108, __deriv__(PRIML2), __deriv__(FLUX2))
      CALL saxpy(OpenAD_acc_109, __deriv__(UHATL), __deriv__(FLUX2))
      CALL saxpy(OpenAD_lin_240, __deriv__(MU), __deriv__(FLUX2))
      CALL sax(OpenAD_lin_244, __deriv__(NSIZE), __deriv__(FLUX3))
      ...
      CALL sax(OpenAD_lin_251, __deriv__(NSIZE), __deriv__(FLUX4))
      ...
      CALL sax(OpenAD_lin_258, __deriv__(NSIZE), __deriv__(FLUX5))
      ...
      CALL sax(OpenAD_lin_233, __deriv__(NSIZE), __deriv__(FLUX1))
