...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_342 * 5.0D-01)
      ...
      CALL setderiv(__deriv__(OpenAD_Symbol_362), __deriv__(LAMCM))
      CALL dec_deriv(__deriv__(OpenAD_Symbol_362), __deriv__(
     > OpenAD_Symbol_359))
      CALL setderiv(__deriv__(OpenAD_Symbol_363), __deriv__(LAMCP))
      CALL dec_deriv(__deriv__(OpenAD_Symbol_363), __deriv__(
     > OpenAD_Symbol_360))
      CALL setderiv(__deriv__(OpenAD_Symbol_364), __deriv__(LAMU))
      CALL dec_deriv(__deriv__(OpenAD_Symbol_364), __deriv__(
     > OpenAD_Symbol_361))
     ...
     >  __deriv__(ALP5))
      ...
      CALL setderiv(__deriv__(OpenAD_Symbol_427), __deriv__(PRIML1))
