...
C$OPENAD XXX Template ad_template.f
     ...
     > ) * OpenAD_lin_51))
      ...
      CALL sax(OpenAD_lin_5, __deriv__(NRM3), __deriv__(OpenAD_prop_0))
      CALL saxpy(OpenAD_lin_1, __deriv__(NRM1), __deriv__(OpenAD_prop_0
     > ))
      CALL saxpy(OpenAD_lin_3, __deriv__(NRM2), __deriv__(OpenAD_prop_0
     > ))
      CALL sax(OpenAD_acc_12, __deriv__(PRIMR2), __deriv__(
     > OpenAD_prop_1))
      CALL saxpy(OpenAD_acc_13, __deriv__(PRIML2), __deriv__(
     > OpenAD_prop_1))
      CALL sax(OpenAD_lin_27, __deriv__(PRIML5), __deriv__(
     > OpenAD_prop_2))
      CALL saxpy(OpenAD_lin_23, __deriv__(PRIML3), __deriv__(
     > OpenAD_prop_2))
      CALL saxpy(OpenAD_lin_25, __deriv__(PRIML4), __deriv__(
     > OpenAD_prop_2))
      CALL sax(OpenAD_lin_34, __deriv__(PRIMR5), __deriv__(
     > OpenAD_prop_3))
      CALL saxpy(OpenAD_lin_30, __deriv__(PRIMR3), __deriv__(
     > OpenAD_prop_3))
      CALL saxpy(OpenAD_lin_32, __deriv__(PRIMR4), __deriv__(
     > OpenAD_prop_3))
      CALL sax(OpenAD_lin_0, __deriv__(OpenAD_prop_0), __deriv__(NSIZE)
     > )
      CALL sax(OpenAD_lin_9, __deriv__(NRM1), __deriv__(NXHAT))
      CALL saxpy(OpenAD_acc_2, __deriv__(NSIZE), __deriv__(NXHAT))
      CALL sax(OpenAD_lin_11, __deriv__(NRM2), __deriv__(NYHAT))
      CALL saxpy(OpenAD_acc_3, __deriv__(NSIZE), __deriv__(NYHAT))
      CALL sax(OpenAD_lin_13, __deriv__(NRM3), __deriv__(NZHAT))
      ...
      CALL saxpy(OpenAD_lin_37, __deriv__(PRIML2), __deriv__(HL))
      ...
      CALL saxpy(OpenAD_lin_43, __deriv__(PRIMR2), __deriv__(HR))
      ...
      CALL sax(OpenAD_lin_50, __deriv__(PRIMR3), __deriv__(UAVE))
      CALL saxpy(OpenAD_acc_11, __deriv__(OpenAD_prop_1), __deriv__(
     > UAVE))
      CALL saxpy(OpenAD_lin_48, __deriv__(PRIML3), __deriv__(UAVE))
      CALL sax(OpenAD_lin_54, __deriv__(PRIMR4), __deriv__(VAVE))
      CALL saxpy(OpenAD_lin_52, __deriv__(PRIML4), __deriv__(VAVE))
      CALL saxpy(OpenAD_acc_10, __deriv__(OpenAD_prop_1), __deriv__(
     > VAVE))
      CALL sax(OpenAD_lin_58, __deriv__(PRIMR5), __deriv__(WAVE))
      CALL saxpy(OpenAD_lin_56, __deriv__(PRIML5), __deriv__(WAVE))
      CALL saxpy(OpenAD_acc_9, __deriv__(OpenAD_prop_1), __deriv__(WAVE
     > ))
      CALL sax(OpenAD_lin_69, __deriv__(WAVE), __deriv__(OpenAD_prop_4)
     > )
     ...
     >  __value__(NYHAT) * __value__(UAVE))
      ...
      CALL sax(OpenAD_lin_73, __deriv__(OpenAD_prop_5), __deriv__(CAVE)
     > )
     ...
     > ))
      CALL sax(OpenAD_lin_99, __deriv__(PRIML2), __deriv__(RUL))
      CALL saxpy(OpenAD_lin_100, __deriv__(PRIML3), __deriv__(RUL))
      CALL sax(OpenAD_lin_101, __deriv__(PRIML2), __deriv__(RVL))
      CALL saxpy(OpenAD_lin_102, __deriv__(PRIML4), __deriv__(RVL))
      CALL sax(OpenAD_lin_103, __deriv__(PRIML2), __deriv__(RWL))
      CALL saxpy(OpenAD_lin_104, __deriv__(PRIML5), __deriv__(RWL))
      ...
      CALL saxpy(OpenAD_lin_109, __deriv__(PRIMR2), __deriv__(DRU))
      CALL saxpy(OpenAD_lin_110, __deriv__(PRIMR3), __deriv__(DRU))
      CALL set_neg_deriv(__deriv__(DRV), __deriv__(RVL))
      CALL saxpy(OpenAD_lin_111, __deriv__(PRIMR2), __deriv__(DRV))
      CALL saxpy(OpenAD_lin_112, __deriv__(PRIMR4), __deriv__(DRV))
      CALL set_neg_deriv(__deriv__(DRW), __deriv__(RWL))
      CALL saxpy(OpenAD_lin_113, __deriv__(PRIMR2), __deriv__(DRW))
      CALL saxpy(OpenAD_lin_114, __deriv__(PRIMR5), __deriv__(DRW))
      ...
      CALL sax(OpenAD_lin_95, __deriv__(PRIML1), __deriv__(EL))
      CALL saxpy(OpenAD_lin_96, __deriv__(GM1INV), __deriv__(EL))
      CALL saxpy(OpenAD_lin_97, __deriv__(PRIML2), __deriv__(EL))
      CALL saxpy(OpenAD_lin_98, __deriv__(THETAL), __deriv__(EL))
      CALL set_neg_deriv(__deriv__(DE), __deriv__(EL))
      CALL saxpy(OpenAD_lin_105, __deriv__(PRIMR1), __deriv__(DE))
      CALL saxpy(OpenAD_lin_106, __deriv__(GM1INV), __deriv__(DE))
      CALL saxpy(OpenAD_lin_107, __deriv__(PRIMR2), __deriv__(DE))
      CALL saxpy(OpenAD_lin_108, __deriv__(THETAR), __deriv__(DE))
      CALL sax(OpenAD_lin_131, __deriv__(DRW), __deriv__(NDDRU))
      CALL saxpy(OpenAD_lin_132, __deriv__(NZHAT), __deriv__(NDDRU))
      CALL saxpy(OpenAD_lin_129, __deriv__(DRV), __deriv__(NDDRU))
      CALL saxpy(OpenAD_lin_130, __deriv__(NYHAT), __deriv__(NDDRU))
      CALL saxpy(OpenAD_lin_127, __deriv__(DRU), __deriv__(NDDRU))
      CALL saxpy(OpenAD_lin_128, __deriv__(NXHAT), __deriv__(NDDRU))
      ...
      CALL saxpy(OpenAD_lin_122, __deriv__(DE), __deriv__(OMEGA))
      ...
      CALL sax(OpenAD_lin_142, __deriv__(OMEGA), __deriv__(ALP2))
      ...
      CALL saxpy(OpenAD_lin_136, __deriv__(DRW), __deriv__(ALP2))
      CALL saxpy(OpenAD_lin_137, __deriv__(NYHAT), __deriv__(ALP2))
      CALL saxpy(OpenAD_acc_57, __deriv__(DRV), __deriv__(ALP2))
      CALL saxpy(OpenAD_acc_58, __deriv__(NZHAT), __deriv__(ALP2))
      CALL sax(OpenAD_lin_152, __deriv__(OMEGA), __deriv__(ALP3))
      ...
      CALL saxpy(OpenAD_lin_146, __deriv__(DRU), __deriv__(ALP3))
      CALL saxpy(OpenAD_lin_147, __deriv__(NZHAT), __deriv__(ALP3))
      ...
      CALL saxpy(OpenAD_lin_156, __deriv__(DRV), __deriv__(ALP4))
      CALL saxpy(OpenAD_lin_157, __deriv__(NXHAT), __deriv__(ALP4))
     ...
     >  OpenAD_lin_232)
      ...
      CALL saxpy(OpenAD_lin_170, __deriv__(OpenAD_prop_12), __deriv__(
     > ALP1))
      CALL sax(OpenAD_lin_171, __deriv__(ALAMU), __deriv__(ALP2))
      CALL saxpy(OpenAD_lin_172, __deriv__(OpenAD_prop_13), __deriv__(
     > ALP2))
      CALL sax(OpenAD_lin_173, __deriv__(ALAMU), __deriv__(ALP3))
      CALL saxpy(OpenAD_lin_174, __deriv__(OpenAD_prop_14), __deriv__(
     > ALP3))
      CALL sax(OpenAD_lin_175, __deriv__(ALAMU), __deriv__(ALP4))
      CALL saxpy(OpenAD_lin_176, __deriv__(OpenAD_prop_15), __deriv__(
     > ALP4))
      CALL sax(OpenAD_lin_177, __deriv__(ALAMCP), __deriv__(ALP5))
      CALL saxpy(OpenAD_lin_178, __deriv__(OpenAD_prop_16), __deriv__(
     > ALP5))
      ...
      CALL sax(OpenAD_lin_225, __deriv__(PRIML3), __deriv__(UHATL))
      CALL saxpy(OpenAD_lin_226, __deriv__(NXHAT), __deriv__(UHATL))
      CALL saxpy(OpenAD_lin_227, __deriv__(PRIML4), __deriv__(UHATL))
      CALL saxpy(OpenAD_lin_228, __deriv__(NYHAT), __deriv__(UHATL))
      CALL saxpy(OpenAD_lin_229, __deriv__(PRIML5), __deriv__(UHATL))
      CALL saxpy(OpenAD_lin_230, __deriv__(NZHAT), __deriv__(UHATL))
      ...
      CALL sax(OpenAD_lin_235, __deriv__(NSIZE), __deriv__(FLUX2))
      CALL saxpy(OpenAD_acc_108, __deriv__(PRIML2), __deriv__(FLUX2))
      CALL saxpy(OpenAD_acc_109, __deriv__(UHATL), __deriv__(FLUX2))
      CALL saxpy(OpenAD_lin_236, __deriv__(MU), __deriv__(FLUX2))
      CALL sax(OpenAD_lin_239, __deriv__(NSIZE), __deriv__(FLUX3))
      ...
      CALL sax(OpenAD_lin_245, __deriv__(NSIZE), __deriv__(FLUX4))
      ...
      CALL sax(OpenAD_lin_251, __deriv__(NSIZE), __deriv__(FLUX5))
      ...
      CALL sax(OpenAD_lin_231, __deriv__(NSIZE), __deriv__(FLUX1))
