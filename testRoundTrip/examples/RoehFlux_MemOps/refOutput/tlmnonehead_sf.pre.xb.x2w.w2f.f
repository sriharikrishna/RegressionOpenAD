...
C$OPENAD XXX Template ad_template.f
     ...
     > OpenAD_Symbol_314))
      CALL sax(OpenAD_Symbol_306, __deriv__(PRIMR2), __deriv__(
     > OpenAD_Symbol_315))
      CALL saxpy(OpenAD_Symbol_307, __deriv__(PRIML2), __deriv__(
     > OpenAD_Symbol_315))
     ...
     > OpenAD_Symbol_317))
      CALL sax(OpenAD_Symbol_1, __deriv__(OpenAD_Symbol_314), __deriv__
     > (NSIZE))
      CALL sax(OpenAD_Symbol_10, __deriv__(NRM1), __deriv__(NXHAT))
      CALL saxpy(OpenAD_Symbol_296, __deriv__(NSIZE), __deriv__(NXHAT))
      CALL sax(OpenAD_Symbol_12, __deriv__(NRM2), __deriv__(NYHAT))
      CALL saxpy(OpenAD_Symbol_297, __deriv__(NSIZE), __deriv__(NYHAT))
      CALL sax(OpenAD_Symbol_14, __deriv__(NRM3), __deriv__(NZHAT))
      CALL saxpy(OpenAD_Symbol_298, __deriv__(NSIZE), __deriv__(NZHAT))
      CALL sax(5.0D-01, __deriv__(OpenAD_Symbol_316), __deriv__(THETAL)
     > )
      CALL sax(5.0D-01, __deriv__(OpenAD_Symbol_317), __deriv__(THETAR)
     > )
      CALL sax(1_w2f__i8, __deriv__(THETAL), __deriv__(HL))
      CALL saxpy(OpenAD_Symbol_43, __deriv__(PRIML2), __deriv__(HL))
      CALL saxpy(OpenAD_Symbol_308, __deriv__(PRIML1), __deriv__(HL))
      CALL saxpy(OpenAD_Symbol_309, __deriv__(GAMMA), __deriv__(HL))
      CALL saxpy(OpenAD_Symbol_310, __deriv__(GM1INV), __deriv__(HL))
      CALL sax(1_w2f__i8, __deriv__(THETAR), __deriv__(HR))
      CALL saxpy(OpenAD_Symbol_51, __deriv__(PRIMR2), __deriv__(HR))
      CALL saxpy(OpenAD_Symbol_311, __deriv__(PRIMR1), __deriv__(HR))
      CALL saxpy(OpenAD_Symbol_312, __deriv__(GAMMA), __deriv__(HR))
      CALL saxpy(OpenAD_Symbol_313, __deriv__(GM1INV), __deriv__(HR))
      CALL sax(OpenAD_Symbol_59, __deriv__(PRIMR3), __deriv__(UAVE))
      CALL saxpy(OpenAD_Symbol_305, __deriv__(OpenAD_Symbol_315),
     >  __deriv__(UAVE))
     ...
     > OpenAD_Symbol_318))
      CALL sax(5.0D-01, __deriv__(OpenAD_Symbol_318), __deriv__(THTAVE)
     > )
      CALL sax(OpenAD_Symbol_82, __deriv__(GM1), __deriv__(CAVE))
      CALL saxpy(OpenAD_Symbol_299, __deriv__(OpenAD_Symbol_318),
     >  __deriv__(CAVE))
      CALL saxpy(OpenAD_Symbol_300, __deriv__(HR), __deriv__(CAVE))
      CALL saxpy(OpenAD_Symbol_301, __deriv__(HL), __deriv__(CAVE))
      CALL saxpy(OpenAD_Symbol_302, __deriv__(OpenAD_Symbol_315),
     >  __deriv__(CAVE))
     ...
     >  __value__(NYHAT) * __value__(UAVE))
      ...
      CALL setderiv(__deriv__(OpenAD_Symbol_325), __deriv__(CAVE))
      CALL sax(OpenAD_Symbol_84, __deriv__(OpenAD_Symbol_325),
     >  __deriv__(CAVE))
      CALL sax(OpenAD_Symbol_92, __deriv__(NYHAT), __deriv__(UTILDE))
      CALL saxpy(OpenAD_Symbol_93, __deriv__(WAVE), __deriv__(UTILDE))
      CALL saxpy(OpenAD_Symbol_319, __deriv__(NZHAT), __deriv__(UTILDE)
     > )
      CALL saxpy(OpenAD_Symbol_320, __deriv__(VAVE), __deriv__(UTILDE))
      CALL sax(OpenAD_Symbol_96, __deriv__(NZHAT), __deriv__(VTILDE))
      CALL saxpy(OpenAD_Symbol_97, __deriv__(UAVE), __deriv__(VTILDE))
      CALL saxpy(OpenAD_Symbol_321, __deriv__(NXHAT), __deriv__(VTILDE)
     > )
      CALL saxpy(OpenAD_Symbol_322, __deriv__(WAVE), __deriv__(VTILDE))
      CALL sax(OpenAD_Symbol_100, __deriv__(NXHAT), __deriv__(WTILDE))
      CALL saxpy(OpenAD_Symbol_101, __deriv__(VAVE), __deriv__(WTILDE))
      CALL saxpy(OpenAD_Symbol_323, __deriv__(NYHAT), __deriv__(WTILDE)
     > )
      CALL saxpy(OpenAD_Symbol_324, __deriv__(UAVE), __deriv__(WTILDE))
      ...
      CALL sax(1_w2f__i8, __deriv__(UHAT), __deriv__(LAMCM))
      CALL saxpy(-1_w2f__i8, __deriv__(CAVE), __deriv__(LAMCM))
      CALL setderiv(__deriv__(LAMU), __deriv__(UHAT))
      CALL sax(1_w2f__i8, __deriv__(CAVE), __deriv__(LAMCP))
      CALL saxpy(1_w2f__i8, __deriv__(UHAT), __deriv__(LAMCP))
     ...
     >  OpenAD_Symbol_342 * 5.0D-01)
      ...
      CALL setderiv(__deriv__(OpenAD_Symbol_359), __deriv__(ALAMCM))
      CALL setderiv(__deriv__(OpenAD_Symbol_360), __deriv__(ALAMCP))
      CALL setderiv(__deriv__(OpenAD_Symbol_361), __deriv__(ALAMU))
      CALL sax(1_w2f__i8, __deriv__(LAMCM), __deriv__(OpenAD_Symbol_362
     > ))
      CALL saxpy(-1_w2f__i8, __deriv__(OpenAD_Symbol_359), __deriv__(
     > OpenAD_Symbol_362))
      CALL sax(1_w2f__i8, __deriv__(LAMCP), __deriv__(OpenAD_Symbol_363
     > ))
      CALL saxpy(-1_w2f__i8, __deriv__(OpenAD_Symbol_360), __deriv__(
     > OpenAD_Symbol_363))
      CALL sax(1_w2f__i8, __deriv__(LAMU), __deriv__(OpenAD_Symbol_364)
     > )
      CALL saxpy(-1_w2f__i8, __deriv__(OpenAD_Symbol_361), __deriv__(
     > OpenAD_Symbol_364))
      ...
      CALL sax(1_w2f__i8, __deriv__(PRIMR2), __deriv__(DR))
      CALL saxpy(-1_w2f__i8, __deriv__(PRIML2), __deriv__(DR))
      CALL sax(-1_w2f__i8, __deriv__(RUL), __deriv__(DRU))
      CALL saxpy(OpenAD_Symbol_124, __deriv__(PRIMR2), __deriv__(DRU))
      CALL saxpy(OpenAD_Symbol_125, __deriv__(PRIMR3), __deriv__(DRU))
      CALL sax(-1_w2f__i8, __deriv__(RVL), __deriv__(DRV))
      CALL saxpy(OpenAD_Symbol_126, __deriv__(PRIMR2), __deriv__(DRV))
      CALL saxpy(OpenAD_Symbol_127, __deriv__(PRIMR4), __deriv__(DRV))
      CALL sax(-1_w2f__i8, __deriv__(RWL), __deriv__(DRW))
      CALL saxpy(OpenAD_Symbol_128, __deriv__(PRIMR2), __deriv__(DRW))
      CALL saxpy(OpenAD_Symbol_129, __deriv__(PRIMR5), __deriv__(DRW))
      CALL sax(5.0D-01, __deriv__(OpenAD_Symbol_362), __deriv__(ALAMCM)
     > )
      CALL sax(5.0D-01, __deriv__(OpenAD_Symbol_363), __deriv__(ALAMCP)
     > )
      CALL sax(5.0D-01, __deriv__(OpenAD_Symbol_364), __deriv__(ALAMU))
      ...
      CALL sax(-1_w2f__i8, __deriv__(EL), __deriv__(DE))
      ...
      CALL sax(OpenAD_Symbol_326, __deriv__(GM1), __deriv__(OMEGA))
      CALL saxpy(OpenAD_Symbol_327, __deriv__(CAVE), __deriv__(OMEGA))
      CALL saxpy(OpenAD_Symbol_331, __deriv__(DRW), __deriv__(OMEGA))
      CALL saxpy(OpenAD_Symbol_332, __deriv__(WAVE), __deriv__(OMEGA))
      CALL saxpy(OpenAD_Symbol_139, __deriv__(DE), __deriv__(OMEGA))
      CALL saxpy(OpenAD_Symbol_343, __deriv__(THTAVE), __deriv__(OMEGA)
     > )
      CALL saxpy(OpenAD_Symbol_349, __deriv__(DRV), __deriv__(OMEGA))
      CALL saxpy(OpenAD_Symbol_350, __deriv__(VAVE), __deriv__(OMEGA))
      CALL saxpy(OpenAD_Symbol_351, __deriv__(DRU), __deriv__(OMEGA))
      CALL saxpy(OpenAD_Symbol_352, __deriv__(UAVE), __deriv__(OMEGA))
      CALL sax(-5.0D-01, __deriv__(NDDRU), __deriv__(ALP1))
      CALL saxpy(5.0D-01, __deriv__(OMEGA), __deriv__(ALP1))
      CALL saxpy(OpenAD_Symbol_348, __deriv__(DR), __deriv__(ALP1))
      CALL saxpy(OpenAD_Symbol_329, __deriv__(UHAT), __deriv__(ALP1))
      CALL sax(5.0D-01, __deriv__(NDDRU), __deriv__(ALP5))
      CALL saxpy(5.0D-01, __deriv__(OMEGA), __deriv__(ALP5))
      CALL saxpy(OpenAD_Symbol_344, __deriv__(DR), __deriv__(ALP5))
      CALL saxpy(OpenAD_Symbol_328, __deriv__(UHAT), __deriv__(ALP5))
      CALL sax(OpenAD_Symbol_162, __deriv__(OMEGA), __deriv__(ALP2))
      CALL saxpy(OpenAD_Symbol_347, __deriv__(DR), __deriv__(ALP2))
      CALL saxpy(OpenAD_Symbol_339, __deriv__(CAVE), __deriv__(ALP2))
      CALL saxpy(OpenAD_Symbol_340, __deriv__(NXHAT), __deriv__(ALP2))
      CALL saxpy(OpenAD_Symbol_341, __deriv__(UTILDE), __deriv__(ALP2))
      CALL saxpy(OpenAD_Symbol_154, __deriv__(DRW), __deriv__(ALP2))
      CALL saxpy(OpenAD_Symbol_155, __deriv__(NYHAT), __deriv__(ALP2))
      CALL saxpy(OpenAD_Symbol_357, __deriv__(DRV), __deriv__(ALP2))
      CALL saxpy(OpenAD_Symbol_358, __deriv__(NZHAT), __deriv__(ALP2))
      CALL sax(OpenAD_Symbol_174, __deriv__(OMEGA), __deriv__(ALP3))
      CALL saxpy(OpenAD_Symbol_346, __deriv__(DR), __deriv__(ALP3))
      CALL saxpy(OpenAD_Symbol_336, __deriv__(CAVE), __deriv__(ALP3))
      CALL saxpy(OpenAD_Symbol_337, __deriv__(NYHAT), __deriv__(ALP3))
      CALL saxpy(OpenAD_Symbol_338, __deriv__(VTILDE), __deriv__(ALP3))
      CALL saxpy(OpenAD_Symbol_166, __deriv__(DRU), __deriv__(ALP3))
      CALL saxpy(OpenAD_Symbol_167, __deriv__(NZHAT), __deriv__(ALP3))
      CALL saxpy(OpenAD_Symbol_355, __deriv__(DRW), __deriv__(ALP3))
      CALL saxpy(OpenAD_Symbol_356, __deriv__(NXHAT), __deriv__(ALP3))
      CALL sax(OpenAD_Symbol_186, __deriv__(OMEGA), __deriv__(ALP4))
      CALL saxpy(OpenAD_Symbol_345, __deriv__(DR), __deriv__(ALP4))
      CALL saxpy(OpenAD_Symbol_333, __deriv__(CAVE), __deriv__(ALP4))
      CALL saxpy(OpenAD_Symbol_334, __deriv__(NZHAT), __deriv__(ALP4))
      CALL saxpy(OpenAD_Symbol_335, __deriv__(WTILDE), __deriv__(ALP4))
      CALL saxpy(OpenAD_Symbol_178, __deriv__(DRV), __deriv__(ALP4))
      CALL saxpy(OpenAD_Symbol_179, __deriv__(NXHAT), __deriv__(ALP4))
      CALL saxpy(OpenAD_Symbol_353, __deriv__(DRU), __deriv__(ALP4))
      CALL saxpy(OpenAD_Symbol_354, __deriv__(NYHAT), __deriv__(ALP4))
     ...
     >  OpenAD_Symbol_264)
      ...
      CALL saxpy(OpenAD_Symbol_195, __deriv__(OpenAD_Symbol_422),
     >  __deriv__(ALP1))
      CALL sax(OpenAD_Symbol_197, __deriv__(ALAMU), __deriv__(ALP2))
      CALL saxpy(OpenAD_Symbol_198, __deriv__(OpenAD_Symbol_423),
     >  __deriv__(ALP2))
      CALL sax(OpenAD_Symbol_200, __deriv__(ALAMU), __deriv__(ALP3))
      CALL saxpy(OpenAD_Symbol_201, __deriv__(OpenAD_Symbol_424),
     >  __deriv__(ALP3))
      CALL sax(OpenAD_Symbol_203, __deriv__(ALAMU), __deriv__(ALP4))
      CALL saxpy(OpenAD_Symbol_204, __deriv__(OpenAD_Symbol_425),
     >  __deriv__(ALP4))
      CALL sax(OpenAD_Symbol_206, __deriv__(ALAMCP), __deriv__(ALP5))
      CALL saxpy(OpenAD_Symbol_207, __deriv__(OpenAD_Symbol_426),
     >  __deriv__(ALP5))
      CALL sax(1_w2f__i8, __deriv__(ALP1), __deriv__(ALP15P))
      CALL saxpy(1_w2f__i8, __deriv__(ALP5), __deriv__(ALP15P))
      CALL sax(1_w2f__i8, __deriv__(ALP1), __deriv__(ALP15M))
      CALL saxpy(-1_w2f__i8, __deriv__(ALP5), __deriv__(ALP15M))
      CALL sax(1_w2f__i8, __deriv__(PRIML1), __deriv__(
     > OpenAD_Symbol_427))
      CALL saxpy(1_w2f__i8, __deriv__(EL), __deriv__(OpenAD_Symbol_427)
     > )
     ...
     > )
      ...
      CALL saxpy(OpenAD_Symbol_414, __deriv__(PRIML2), __deriv__(FLUX2)
     > )
      CALL saxpy(OpenAD_Symbol_415, __deriv__(UHATL), __deriv__(FLUX2))
      CALL saxpy(OpenAD_Symbol_270, __deriv__(MU), __deriv__(FLUX2))
      CALL sax(OpenAD_Symbol_274, __deriv__(NSIZE), __deriv__(FLUX3))
      CALL saxpy(OpenAD_Symbol_376, __deriv__(ALP4), __deriv__(FLUX3))
      CALL saxpy(OpenAD_Symbol_377, __deriv__(NYHAT), __deriv__(FLUX3))
      CALL saxpy(OpenAD_Symbol_384, __deriv__(ALP3), __deriv__(FLUX3))
      CALL saxpy(OpenAD_Symbol_385, __deriv__(NZHAT), __deriv__(FLUX3))
      CALL saxpy(OpenAD_Symbol_396, __deriv__(MU), __deriv__(FLUX3))
      CALL saxpy(OpenAD_Symbol_397, __deriv__(UAVE), __deriv__(FLUX3))
      CALL saxpy(OpenAD_Symbol_399, __deriv__(ALP15M), __deriv__(FLUX3)
     > )
      CALL saxpy(OpenAD_Symbol_412, __deriv__(NXHAT), __deriv__(FLUX3))
      CALL saxpy(OpenAD_Symbol_410, __deriv__(RUL), __deriv__(FLUX3))
      CALL saxpy(OpenAD_Symbol_411, __deriv__(UHATL), __deriv__(FLUX3))
      CALL saxpy(OpenAD_Symbol_413, __deriv__(PRIML1), __deriv__(FLUX3)
     > )
      CALL sax(OpenAD_Symbol_281, __deriv__(NSIZE), __deriv__(FLUX4))
      CALL saxpy(OpenAD_Symbol_373, __deriv__(ALP2), __deriv__(FLUX4))
      CALL saxpy(OpenAD_Symbol_374, __deriv__(NZHAT), __deriv__(FLUX4))
      CALL saxpy(OpenAD_Symbol_382, __deriv__(ALP4), __deriv__(FLUX4))
      CALL saxpy(OpenAD_Symbol_383, __deriv__(NXHAT), __deriv__(FLUX4))
      CALL saxpy(OpenAD_Symbol_392, __deriv__(MU), __deriv__(FLUX4))
      CALL saxpy(OpenAD_Symbol_393, __deriv__(VAVE), __deriv__(FLUX4))
      CALL saxpy(OpenAD_Symbol_395, __deriv__(ALP15M), __deriv__(FLUX4)
     > )
      CALL saxpy(OpenAD_Symbol_408, __deriv__(NYHAT), __deriv__(FLUX4))
      CALL saxpy(OpenAD_Symbol_406, __deriv__(RVL), __deriv__(FLUX4))
      CALL saxpy(OpenAD_Symbol_407, __deriv__(UHATL), __deriv__(FLUX4))
      CALL saxpy(OpenAD_Symbol_409, __deriv__(PRIML1), __deriv__(FLUX4)
     > )
      CALL sax(OpenAD_Symbol_288, __deriv__(NSIZE), __deriv__(FLUX5))
      CALL saxpy(OpenAD_Symbol_370, __deriv__(ALP3), __deriv__(FLUX5))
      CALL saxpy(OpenAD_Symbol_371, __deriv__(NXHAT), __deriv__(FLUX5))
      CALL saxpy(OpenAD_Symbol_380, __deriv__(ALP2), __deriv__(FLUX5))
      CALL saxpy(OpenAD_Symbol_381, __deriv__(NYHAT), __deriv__(FLUX5))
      CALL saxpy(OpenAD_Symbol_388, __deriv__(MU), __deriv__(FLUX5))
      CALL saxpy(OpenAD_Symbol_389, __deriv__(WAVE), __deriv__(FLUX5))
      CALL saxpy(OpenAD_Symbol_391, __deriv__(ALP15M), __deriv__(FLUX5)
     > )
      CALL saxpy(OpenAD_Symbol_404, __deriv__(NZHAT), __deriv__(FLUX5))
      CALL saxpy(OpenAD_Symbol_402, __deriv__(RWL), __deriv__(FLUX5))
      CALL saxpy(OpenAD_Symbol_403, __deriv__(UHATL), __deriv__(FLUX5))
      CALL saxpy(OpenAD_Symbol_405, __deriv__(PRIML1), __deriv__(FLUX5)
     > )
      CALL sax(OpenAD_Symbol_263, __deriv__(NSIZE), __deriv__(FLUX1))
      CALL saxpy(OpenAD_Symbol_365, __deriv__(UHATL), __deriv__(FLUX1))
      CALL saxpy(OpenAD_Symbol_366, __deriv__(OpenAD_Symbol_427),
     >  __deriv__(FLUX1))
      CALL saxpy(OpenAD_Symbol_367, __deriv__(ALP4), __deriv__(FLUX1))
      CALL saxpy(OpenAD_Symbol_368, __deriv__(WTILDE), __deriv__(FLUX1)
     > )
      CALL saxpy(OpenAD_Symbol_378, __deriv__(ALP3), __deriv__(FLUX1))
      CALL saxpy(OpenAD_Symbol_379, __deriv__(VTILDE), __deriv__(FLUX1)
     > )
      CALL saxpy(OpenAD_Symbol_386, __deriv__(ALP2), __deriv__(FLUX1))
      CALL saxpy(OpenAD_Symbol_387, __deriv__(UTILDE), __deriv__(FLUX1)
     > )
      CALL saxpy(OpenAD_Symbol_400, __deriv__(MU), __deriv__(FLUX1))
      CALL saxpy(OpenAD_Symbol_401, __deriv__(THTAVE), __deriv__(FLUX1)
     > )
      CALL saxpy(OpenAD_Symbol_416, __deriv__(ALP15P), __deriv__(FLUX1)
     > )
      CALL saxpy(OpenAD_Symbol_417, __deriv__(GM1INV), __deriv__(FLUX1)
     > )
      CALL saxpy(OpenAD_Symbol_418, __deriv__(CAVE), __deriv__(FLUX1))
      CALL saxpy(OpenAD_Symbol_420, __deriv__(ALP15M), __deriv__(FLUX1)
     > )
      CALL saxpy(OpenAD_Symbol_421, __deriv__(UHAT), __deriv__(FLUX1))
      END SUBROUTINE
