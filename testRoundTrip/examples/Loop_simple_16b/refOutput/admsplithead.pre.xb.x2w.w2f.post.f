...
C adjoint
      ...
      DENOM%d = DENOM%d+LAG%d*(OpenAD_Symbol_23)
      NUMER%d = NUMER%d+LAG%d*(OpenAD_Symbol_24)
      LAG%d = 0.0d0
      integer_tape_pointer = integer_tape_pointer-1
      ...
      do while (K.GE.1)
        IF (I.ne.K) THEN
          ...
          A(K)%d = A(K)%d+NUMER%d*(OpenAD_Symbol_19)
          OpenAD_prop_1%d = OpenAD_prop_1%d+NUMER%d*(OpenAD_Symbol_20)
          NUMER%d = 0.0d0
          OpenAD_prop_2%d = OpenAD_prop_2%d+DENOM%d*(OpenAD_Symbol_21)
          OpenAD_prop_0%d = OpenAD_prop_0%d+DENOM%d*(OpenAD_Symbol_22)
          DENOM%d = 0.0d0
