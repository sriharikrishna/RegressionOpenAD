...
C adjoint
      ...
      GAMMA%d = GAMMA%d+Y(2)%d*(OpenAD_Symbol_13)
      OpenAD_prop_0%d = OpenAD_prop_0%d+Y(2)%d*(OpenAD_Symbol_14)
      Y(2)%d = 0.0d0
      ...
      GAMMA%d = GAMMA%d+Y(1)%d*(OpenAD_Symbol_15)
      X(4)%d = X(4)%d+Y(1)%d*(OpenAD_Symbol_16)
      X(3)%d = X(3)%d+Y(1)%d*(OpenAD_Symbol_17)
