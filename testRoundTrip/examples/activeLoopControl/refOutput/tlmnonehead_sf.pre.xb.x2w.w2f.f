...
C$OPENAD XXX Template ad_template.f
      ...
      DO I = INT(__value__(X(1))), (INT(__value__(X(2))) + 2), 1
        OpenAD_Symbol_2 = (__value__(X(2)) * __value__(Y(1)))
        OpenAD_Symbol_0 = __value__(Y(1))
        OpenAD_Symbol_1 = __value__(X(2))
        __value__(Y(1)) = OpenAD_Symbol_2
        CALL setderiv(__deriv__(OpenAD_prop_0), __deriv__(Y(1)))
        CALL sax(OpenAD_Symbol_0, __deriv__(X(2)), __deriv__(Y(1)))
        CALL saxpy(OpenAD_Symbol_1, __deriv__(OpenAD_prop_0), __deriv__
     > (Y(1)))
      END DO
      END SUBROUTINE
