...
C$OPENAD XXX Template ad_template.f
      ...
      T2%v = (X1%v*OpenAD_lin_2)
      OpenAD_lin_3 = OpenAD_lin_2
      OpenAD_lin_5 = COS(T1%v)
      OpenAD_lin_4 = X1%v
      Y1%v = COS(T2%v)
      OpenAD_lin_6 = (-SIN(T2%v))
      Y2%v = (X2%v*T2%v)
      OpenAD_lin_7 = T2%v
      OpenAD_lin_8 = X2%v
      ...
      CALL sax(OpenAD_lin_3,X1,T2)
      CALL saxpy(OpenAD_acc_1,X1,T2)
      CALL saxpy(OpenAD_acc_2,X2,T2)
      CALL sax(OpenAD_lin_6,T2,Y1)
      CALL sax(OpenAD_lin_7,X2,Y2)
      CALL saxpy(OpenAD_lin_8,T2,Y2)
      END SUBROUTINE
