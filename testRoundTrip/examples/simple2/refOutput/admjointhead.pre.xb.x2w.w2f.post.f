...
C adjoint
      ...
      T2%d = T2%d+Y2%d*(OpenAD_Symbol_9)
      X2%d = X2%d+Y2%d*(OpenAD_Symbol_10)
      Y2%d = 0.0d0
      T2%d = T2%d+Y1%d*(OpenAD_Symbol_11)
      Y1%d = 0.0d0
      X2%d = X2%d+T2%d*(OpenAD_Symbol_12)
      X1%d = X1%d+T2%d*(OpenAD_Symbol_13)
      X1%d = X1%d+T2%d*(OpenAD_Symbol_14)
      T2%d = 0.0d0
