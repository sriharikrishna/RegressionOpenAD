...
C adjoint
      ...
      X(2)%d = X(2)%d+Y(1)%d*(OpenAD_Symbol_24)
      OpenAD_prop_0%d = OpenAD_prop_0%d+Y(1)%d*(OpenAD_Symbol_25)
      X(1)%d = X(1)%d+Y(1)%d*(OpenAD_Symbol_26)
      X(2)%d = X(2)%d+Y(1)%d*(OpenAD_Symbol_27)
      OpenAD_prop_1%d = OpenAD_prop_1%d+Y(1)%d*(OpenAD_Symbol_28)
      X(1)%d = X(1)%d+Y(1)%d*(OpenAD_Symbol_29)
      X(3)%d = X(3)%d+Y(1)%d*(OpenAD_Symbol_30)
      Y(1)%d = 0.0d0
