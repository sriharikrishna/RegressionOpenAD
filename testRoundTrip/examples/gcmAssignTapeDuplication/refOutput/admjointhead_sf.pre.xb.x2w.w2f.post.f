...
C adjoint
      ...
      X(4)%d = X(4)%d+Y(1)%d*(OpenAD_Symbol_15)
      X(2)%d = X(2)%d+Y(1)%d*(OpenAD_Symbol_16)
      OpenAD_prop_0%d = OpenAD_prop_0%d+Y(1)%d*(OpenAD_Symbol_17)
      X(1)%d = X(1)%d+Y(1)%d*(OpenAD_Symbol_18)
      X(2)%d = X(2)%d+Y(1)%d*(OpenAD_Symbol_19)
