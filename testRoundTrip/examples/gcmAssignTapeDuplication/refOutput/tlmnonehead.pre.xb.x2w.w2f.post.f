...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_4)))
      ...
      CALL setderiv(OpenAD_Symbol_23,X(8))
      CALL inc_deriv(OpenAD_Symbol_23,X(7))
      CALL inc_deriv(OpenAD_Symbol_23,X(5))
      CALL inc_deriv(OpenAD_Symbol_23,X(6))
      CALL setderiv(OpenAD_Symbol_24,X(12))
      CALL inc_deriv(OpenAD_Symbol_24,X(11))
      CALL inc_deriv(OpenAD_Symbol_24,X(9))
      CALL inc_deriv(OpenAD_Symbol_24,X(10))
