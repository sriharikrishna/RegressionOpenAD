...
C$OPENAD XXX Template ad_template.f
      ...
      CALL setderiv(__deriv__(OpenAD_Symbol_7), __deriv__(A))
      CALL sax(2.0D00, __deriv__(OpenAD_Symbol_7), __deriv__(A))
      END SUBROUTINE
...
C$OPENAD XXX Template ad_template.f
      ...
      CALL setderiv(__deriv__(OpenAD_Symbol_8), __deriv__(A))
      CALL sax(OpenAD_Symbol_3, __deriv__(OpenAD_Symbol_8), __deriv__(A
     > ))
      END SUBROUTINE
