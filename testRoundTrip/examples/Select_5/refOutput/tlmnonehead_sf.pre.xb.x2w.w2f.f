...
11    CONTINUE
      GO TO 12
12    CONTINUE
      OpenAD_Symbol_5 = (__value__(Y(1)) * 4.0D00)
...
13    CONTINUE
      ...
      ENDIF
14    CONTINUE
      OpenAD_Symbol_11 = (I * __value__(Y(1)))
      OpenAD_Symbol_10 = I
      __value__(Y(1)) = OpenAD_Symbol_11
      CALL setderiv(__deriv__(OpenAD_prop_2), __deriv__(Y(1)))
      CALL sax(OpenAD_Symbol_10, __deriv__(OpenAD_prop_2), __deriv__(Y(
     > 1)))
      GO TO 15
15    CONTINUE
      GO TO 16
16    CONTINUE
      GO TO 19
17    CONTINUE
      OpenAD_Symbol_8 = (I * __value__(Y(1)))
      OpenAD_Symbol_7 = I
      __value__(Y(1)) = OpenAD_Symbol_8
      CALL setderiv(__deriv__(OpenAD_prop_1), __deriv__(Y(1)))
      CALL sax(OpenAD_Symbol_7, __deriv__(OpenAD_prop_1), __deriv__(Y(1
     > )))
      RETURN
      GO TO 19
18    CONTINUE
