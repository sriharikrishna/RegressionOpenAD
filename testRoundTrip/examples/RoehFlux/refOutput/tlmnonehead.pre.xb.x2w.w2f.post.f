...
C$OPENAD XXX Template ad_template.f
     ...
     > -1_w2f__i8)) * OpenAD_Symbol_60))
      ...
      CALL sax(1_w2f__i8,UHAT,LAMCM)
      CALL saxpy(-1_w2f__i8,CAVE,LAMCM)
      CALL setderiv(LAMU,UHAT)
      CALL sax(1_w2f__i8,CAVE,LAMCP)
      CALL saxpy(1_w2f__i8,UHAT,LAMCP)
      CALL sax(1_w2f__i8,CAVE,OpenAD_Symbol_358)
      CALL saxpy(1_w2f__i8,UHAT,OpenAD_Symbol_358)
      ...
      ELSE
        ...
        CALL sax(1_w2f__i8,DELTA2,OpenAD_Symbol_437)
        CALL saxpy(1_w2f__i8,LAM2,OpenAD_Symbol_437)
      ...
      ELSE
        ...
        CALL sax(1_w2f__i8,DELTA2,OpenAD_Symbol_435)
        CALL saxpy(1_w2f__i8,LAM2,OpenAD_Symbol_435)
      ...
      CALL sax(1_w2f__i8,CAVE,OpenAD_Symbol_362)
      CALL saxpy(1_w2f__i8,UHAT,OpenAD_Symbol_362)
      ...
      ELSE
        ...
        CALL sax(1_w2f__i8,DELTA2,OpenAD_Symbol_433)
        CALL saxpy(1_w2f__i8,LAM2,OpenAD_Symbol_433)
     ...
     +ol_201-DRU%v*NYHAT%v)
      ...
      CALL sax(1_w2f__i8,LAMCM,OpenAD_Symbol_385)
      CALL saxpy(-1_w2f__i8,OpenAD_Symbol_382,OpenAD_Symbol_385)
      CALL sax(1_w2f__i8,LAMCP,OpenAD_Symbol_386)
      CALL saxpy(-1_w2f__i8,OpenAD_Symbol_383,OpenAD_Symbol_386)
      CALL sax(1_w2f__i8,LAMU,OpenAD_Symbol_387)
      CALL saxpy(-1_w2f__i8,OpenAD_Symbol_384,OpenAD_Symbol_387)
      ...
      CALL sax(-1_w2f__i8,NDDRU,OpenAD_Symbol_392)
      CALL saxpy(1_w2f__i8,OMEGA,OpenAD_Symbol_392)
      CALL saxpy(OpenAD_Symbol_168,DR,OpenAD_Symbol_392)
      CALL saxpy(OpenAD_Symbol_169,UHAT,OpenAD_Symbol_392)
      CALL sax(1_w2f__i8,NDDRU,OpenAD_Symbol_393)
      CALL saxpy(1_w2f__i8,OMEGA,OpenAD_Symbol_393)
     ...
     >  OpenAD_Symbol_280)
      ...
      CALL sax(1_w2f__i8,ALP1,ALP15P)
      CALL saxpy(1_w2f__i8,ALP5,ALP15P)
      CALL sax(1_w2f__i8,ALP1,ALP15M)
      CALL saxpy(-1_w2f__i8,ALP5,ALP15M)
      CALL sax(1_w2f__i8,PRIML(1),OpenAD_Symbol_427)
      CALL saxpy(1_w2f__i8,EL,OpenAD_Symbol_427)
      ...
      CALL sax(1_w2f__i8,DSS2,OpenAD_Symbol_428)
      ...
      CALL sax(1_w2f__i8,DSS3,OpenAD_Symbol_429)
      ...
      CALL sax(1_w2f__i8,DSS4,OpenAD_Symbol_430)
      ...
      CALL sax(1_w2f__i8,DSS5,OpenAD_Symbol_431)
