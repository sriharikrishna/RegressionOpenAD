...
C$OPENAD XXX Template ad_template.f
      OpenAD_tmp_0 = ((__value__(NRM(1)) ** 2) +(__value__(NRM(2)) ** 2
     > ) +(__value__(NRM(3)) ** 2))
      __value__(NSIZE) = SIN(OpenAD_tmp_0)
      OpenAD_lin_1 = (2 *(__value__(NRM(1)) **(2 - INT(1_w2f__i8))))
      OpenAD_lin_3 = (2 *(__value__(NRM(2)) **(2 - INT(1_w2f__i8))))
      OpenAD_lin_5 = (2 *(__value__(NRM(3)) **(2 - INT(1_w2f__i8))))
...
C       $OpenAD$ INLINE push_i(subst)
      ...
      OpenAD_lin_10 = __value__(NRM(1))
      __value__(NYHAT) = (__value__(NRM(2)) * __value__(NSIZEI))
      OpenAD_lin_11 = __value__(NSIZEI)
      OpenAD_lin_12 = __value__(NRM(2))
      __value__(NZHAT) = (__value__(NRM(3)) * __value__(NSIZEI))
      OpenAD_lin_13 = __value__(NSIZEI)
      OpenAD_lin_14 = __value__(NRM(3))
      OpenAD_tmp_2 = (__value__(PRIMR(2)) / __value__(PRIML(2)))
      OpenAD_tmp_1 = (SIN(OpenAD_tmp_2) + 1.0D00)
      __value__(ROEL) = (1.0D00 / OpenAD_tmp_1)
      OpenAD_lin_19 = (INT(1_w2f__i8) / __value__(PRIML(2)))
      OpenAD_lin_20 = (-(__value__(PRIMR(2)) /(__value__(PRIML(2)) *
     >  __value__(PRIML(2)))))
      OpenAD_lin_18 = COS(OpenAD_tmp_2)
      OpenAD_lin_16 = (-(1.0D00 /(OpenAD_tmp_1 * OpenAD_tmp_1)))
      __value__(ROER) = (1.0D00 - __value__(ROEL))
      OpenAD_tmp_3 = ((__value__(PRIML(3)) ** 2) +(__value__(PRIML(4))
     >  ** 2) +(__value__(PRIML(5)) ** 2))
      __value__(THETAL) = (OpenAD_tmp_3 * 5.0D-01)
      OpenAD_lin_23 = (2 *(__value__(PRIML(3)) **(2 - INT(1_w2f__i8))))
      OpenAD_lin_25 = (2 *(__value__(PRIML(4)) **(2 - INT(1_w2f__i8))))
      OpenAD_lin_27 = (2 *(__value__(PRIML(5)) **(2 - INT(1_w2f__i8))))
      OpenAD_tmp_4 = ((__value__(PRIMR(3)) ** 2) +(__value__(PRIMR(4))
     >  ** 2) +(__value__(PRIMR(5)) ** 2))
      __value__(THETAR) = (OpenAD_tmp_4 * 5.0D-01)
      OpenAD_lin_30 = (2 *(__value__(PRIMR(3)) **(2 - INT(1_w2f__i8))))
      OpenAD_lin_32 = (2 *(__value__(PRIMR(4)) **(2 - INT(1_w2f__i8))))
      OpenAD_lin_34 = (2 *(__value__(PRIMR(5)) **(2 - INT(1_w2f__i8))))
      OpenAD_tmp_6 = (__value__(GAMMA) * __value__(GM1INV))
      OpenAD_tmp_5 = (__value__(PRIML(1)) * OpenAD_tmp_6)
     ...
     > PRIML(2))))
      ...
      OpenAD_lin_39 = __value__(PRIML(1))
      OpenAD_lin_36 = (INT(1_w2f__i8) / __value__(PRIML(2)))
      OpenAD_lin_37 = (-(OpenAD_tmp_5 /(__value__(PRIML(2)) * __value__
     > (PRIML(2)))))
      OpenAD_tmp_8 = (__value__(GAMMA) * __value__(GM1INV))
      OpenAD_tmp_7 = (__value__(PRIMR(1)) * OpenAD_tmp_8)
     ...
     > PRIMR(2))))
      ...
      OpenAD_lin_45 = __value__(PRIMR(1))
      OpenAD_lin_42 = (INT(1_w2f__i8) / __value__(PRIMR(2)))
      OpenAD_lin_43 = (-(OpenAD_tmp_7 /(__value__(PRIMR(2)) * __value__
     > (PRIMR(2)))))
      __value__(UAVE) = (__value__(PRIML(3)) * __value__(ROEL) +
     >  __value__(PRIMR(3)) * __value__(ROER))
      OpenAD_lin_48 = __value__(ROEL)
      OpenAD_lin_49 = __value__(PRIML(3))
      OpenAD_lin_50 = __value__(ROER)
      OpenAD_lin_51 = __value__(PRIMR(3))
      __value__(VAVE) = (__value__(PRIML(4)) * __value__(ROEL) +
     >  __value__(PRIMR(4)) * __value__(ROER))
      OpenAD_lin_52 = __value__(ROEL)
      OpenAD_lin_53 = __value__(PRIML(4))
      OpenAD_lin_54 = __value__(ROER)
      OpenAD_lin_55 = __value__(PRIMR(4))
      __value__(WAVE) = (__value__(PRIML(5)) * __value__(ROEL) +
     >  __value__(PRIMR(5)) * __value__(ROER))
      OpenAD_lin_56 = __value__(ROEL)
      OpenAD_lin_57 = __value__(PRIML(5))
      OpenAD_lin_58 = __value__(ROER)
      OpenAD_lin_59 = __value__(PRIMR(5))
      __value__(HAVE) = (__value__(HL) * __value__(ROEL) + __value__(HR
     > ) * __value__(ROER))
...
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_10)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_11)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_12)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_13)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_14)
C     $OpenAD$ INLINE push(subst)
...
C     $OpenAD$ INLINE push(subst)
     ...
     >  __value__(NYHAT) * __value__(UAVE))
      ...
      __value__(LAMU) = __value__(UHAT)
      __value__(LAMCP) = (__value__(CAVE) + __value__(UHAT))
      OpenAD_tmp_11 = (__value__(CAVE) + __value__(UHAT))
      __value__(DELTA) = (__value__(NLEFIX) * OpenAD_tmp_11)
      OpenAD_lin_92 = OpenAD_tmp_11
      OpenAD_lin_93 = __value__(NLEFIX)
      __value__(DELTA2) = (__value__(DELTA) ** 2)
      OpenAD_lin_94 = (2 *(__value__(DELTA) **(2 - INT(1_w2f__i8))))
      __value__(LAM2) = (__value__(LAMCM) ** 2)
      OpenAD_lin_96 = (2 *(__value__(LAMCM) **(2 - INT(1_w2f__i8))))
...
C       $OpenAD$ INLINE push_i(subst)
      ...
      ELSE
        OpenAD_tmp_38 = (__value__(DELTA2) + __value__(LAM2))
        OpenAD_tmp_37 = (OpenAD_tmp_38 * 5.0D-01)
        __value__(ALAMCM) = (OpenAD_tmp_37 / __value__(DELTA2))
        OpenAD_lin_277 = (INT(1_w2f__i8) / __value__(DELTA2))
        OpenAD_lin_278 = (-(OpenAD_tmp_37 /(__value__(DELTA2) *
     >  __value__(DELTA2))))
        OpenAD_acc_80 = (5.0D-01 * OpenAD_lin_277)
C       $OpenAD$ INLINE push(subst)
        CALL push(OpenAD_lin_278)
C       $OpenAD$ INLINE push(subst)
...
C       $OpenAD$ INLINE push_i(subst)
      ...
      ENDIF
      __value__(LAM2) = (__value__(LAMCP) ** 2)
      OpenAD_lin_98 = (2 *(__value__(LAMCP) **(2 - INT(1_w2f__i8))))
C     $OpenAD$ INLINE push(subst)
...
C       $OpenAD$ INLINE push_i(subst)
      ...
      ELSE
        OpenAD_tmp_36 = (__value__(DELTA2) + __value__(LAM2))
        OpenAD_tmp_35 = (OpenAD_tmp_36 * 5.0D-01)
        __value__(ALAMCP) = (OpenAD_tmp_35 / __value__(DELTA2))
        OpenAD_lin_274 = (INT(1_w2f__i8) / __value__(DELTA2))
        OpenAD_lin_275 = (-(OpenAD_tmp_35 /(__value__(DELTA2) *
     >  __value__(DELTA2))))
        OpenAD_acc_79 = (5.0D-01 * OpenAD_lin_274)
C       $OpenAD$ INLINE push(subst)
        CALL push(OpenAD_lin_275)
C       $OpenAD$ INLINE push(subst)
...
C       $OpenAD$ INLINE push_i(subst)
      ...
      ENDIF
      OpenAD_tmp_12 = (__value__(CAVE) + __value__(UHAT))
      __value__(DELTA) = (__value__(LEFIX) * OpenAD_tmp_12)
      OpenAD_lin_100 = OpenAD_tmp_12
      OpenAD_lin_101 = __value__(LEFIX)
      __value__(DELTA2) = (__value__(DELTA) * __value__(DELTA))
      OpenAD_lin_102 = __value__(DELTA)
      OpenAD_lin_103 = __value__(DELTA)
      __value__(LAM2) = (__value__(LAMU) ** 2)
      OpenAD_lin_104 = (2 *(__value__(LAMU) **(2 - INT(1_w2f__i8))))
...
C       $OpenAD$ INLINE push_i(subst)
      ...
      ELSE
        OpenAD_tmp_34 = (__value__(DELTA2) + __value__(LAM2))
        OpenAD_tmp_33 = (OpenAD_tmp_34 * 5.0D-01)
        __value__(ALAMU) = (OpenAD_tmp_33 / __value__(DELTA2))
        OpenAD_lin_271 = (INT(1_w2f__i8) / __value__(DELTA2))
        OpenAD_lin_272 = (-(OpenAD_tmp_33 /(__value__(DELTA2) *
     >  __value__(DELTA2))))
        OpenAD_acc_78 = (5.0D-01 * OpenAD_lin_271)
C       $OpenAD$ INLINE push(subst)
        CALL push(OpenAD_lin_272)
C       $OpenAD$ INLINE push(subst)
...
C       $OpenAD$ INLINE push_i(subst)
      ...
      ENDIF
      OpenAD_tmp_13 = (__value__(LAMCM) - __value__(ALAMCM))
      __value__(ALAMCM) = (OpenAD_tmp_13 * 5.0D-01)
      OpenAD_tmp_14 = (__value__(LAMCP) - __value__(ALAMCP))
      __value__(ALAMCP) = (OpenAD_tmp_14 * 5.0D-01)
      OpenAD_tmp_15 = (__value__(LAMU) - __value__(ALAMU))
      __value__(ALAMU) = (OpenAD_tmp_15 * 5.0D-01)
      __value__(EL) = (__value__(PRIML(1)) * __value__(GM1INV) +
     >  __value__(PRIML(2)) * __value__(THETAL))
      OpenAD_lin_109 = __value__(GM1INV)
      OpenAD_lin_110 = __value__(PRIML(1))
      OpenAD_lin_111 = __value__(THETAL)
      OpenAD_lin_112 = __value__(PRIML(2))
      __value__(RUL) = (__value__(PRIML(2)) * __value__(PRIML(3)))
      OpenAD_lin_113 = __value__(PRIML(3))
      OpenAD_lin_114 = __value__(PRIML(2))
      __value__(RVL) = (__value__(PRIML(2)) * __value__(PRIML(4)))
      OpenAD_lin_115 = __value__(PRIML(4))
      OpenAD_lin_116 = __value__(PRIML(2))
      __value__(RWL) = (__value__(PRIML(2)) * __value__(PRIML(5)))
      OpenAD_lin_117 = __value__(PRIML(5))
      OpenAD_lin_118 = __value__(PRIML(2))
      __value__(ER) = (__value__(PRIMR(1)) * __value__(GM1INV) +
     >  __value__(PRIMR(2)) * __value__(THETAR))
      OpenAD_lin_119 = __value__(GM1INV)
      OpenAD_lin_120 = __value__(PRIMR(1))
      OpenAD_lin_121 = __value__(THETAR)
      OpenAD_lin_122 = __value__(PRIMR(2))
      __value__(RUR) = (__value__(PRIMR(2)) * __value__(PRIMR(3)))
      OpenAD_lin_123 = __value__(PRIMR(3))
      OpenAD_lin_124 = __value__(PRIMR(2))
      __value__(RVR) = (__value__(PRIMR(2)) * __value__(PRIMR(4)))
      OpenAD_lin_125 = __value__(PRIMR(4))
      OpenAD_lin_126 = __value__(PRIMR(2))
      __value__(RWR) = (__value__(PRIMR(2)) * __value__(PRIMR(5)))
      OpenAD_lin_127 = __value__(PRIMR(5))
      OpenAD_lin_128 = __value__(PRIMR(2))
      __value__(DE) = (__value__(ER) - __value__(EL))
      __value__(DR) = (__value__(PRIMR(2)) - __value__(PRIML(2)))
      __value__(DRU) = (__value__(RUR) - __value__(RUL))
      __value__(DRV) = (__value__(RVR) - __value__(RVL))
     ...
     > DRV) * __value__(VAVE) + __value__(DRW) * __value__(WAVE))
      ...
      OpenAD_tmp_16 = (__value__(GM1) / __value__(CAVE))
      OpenAD_tmp_17 = (__value__(DE) + __value__(DR) * __value__(THTAVE
     > ) - __value__(UDDRU))
      __value__(OMEGA) = (OpenAD_tmp_16 * OpenAD_tmp_17)
      OpenAD_lin_137 = (INT(1_w2f__i8) / __value__(CAVE))
      OpenAD_lin_138 = (-(__value__(GM1) /(__value__(CAVE) * __value__(
     > CAVE))))
      OpenAD_lin_135 = OpenAD_tmp_17
      OpenAD_lin_139 = __value__(THTAVE)
      OpenAD_lin_140 = __value__(DR)
      OpenAD_lin_136 = OpenAD_tmp_16
      __value__(NDDRU) = (__value__(DRU) * __value__(NXHAT) + __value__
     > (DRV) * __value__(NYHAT) + __value__(DRW) * __value__(NZHAT))
      OpenAD_lin_141 = __value__(NXHAT)
      OpenAD_lin_142 = __value__(DRU)
      OpenAD_lin_143 = __value__(NYHAT)
      OpenAD_lin_144 = __value__(DRV)
      OpenAD_lin_145 = __value__(NZHAT)
      OpenAD_lin_146 = __value__(DRW)
      OpenAD_tmp_18 = (__value__(OMEGA) + __value__(DR) * __value__(
     > UHAT) - __value__(NDDRU))
      __value__(ALP1) = (OpenAD_tmp_18 * 5.0D-01)
      OpenAD_lin_148 = __value__(UHAT)
      OpenAD_lin_149 = __value__(DR)
      OpenAD_tmp_19 = (__value__(CAVE) * __value__(NXHAT) - __value__(
     > UTILDE))
      OpenAD_tmp_20 = (- __value__(NXHAT))
      __value__(ALP2) = (__value__(DRW) * __value__(NYHAT) + __value__(
     > DR) * OpenAD_tmp_19 + __value__(OMEGA) * OpenAD_tmp_20 -
     >  __value__(DRV) * __value__(NZHAT))
      OpenAD_lin_150 = __value__(NYHAT)
      OpenAD_lin_151 = __value__(DRW)
      OpenAD_lin_152 = OpenAD_tmp_19
      OpenAD_lin_154 = __value__(NXHAT)
      OpenAD_lin_155 = __value__(CAVE)
      OpenAD_lin_153 = __value__(DR)
      OpenAD_lin_156 = OpenAD_tmp_20
      OpenAD_lin_157 = __value__(OMEGA)
      OpenAD_lin_158 = __value__(NZHAT)
      OpenAD_lin_159 = __value__(DRV)
      OpenAD_tmp_21 = (__value__(CAVE) * __value__(NYHAT) - __value__(
     > VTILDE))
      OpenAD_tmp_22 = (- __value__(NYHAT))
      __value__(ALP3) = (__value__(DRU) * __value__(NZHAT) + __value__(
     > DR) * OpenAD_tmp_21 + __value__(OMEGA) * OpenAD_tmp_22 -
     >  __value__(DRW) * __value__(NXHAT))
      OpenAD_lin_160 = __value__(NZHAT)
      OpenAD_lin_161 = __value__(DRU)
      OpenAD_lin_162 = OpenAD_tmp_21
      OpenAD_lin_164 = __value__(NYHAT)
      OpenAD_lin_165 = __value__(CAVE)
      OpenAD_lin_163 = __value__(DR)
      OpenAD_lin_166 = OpenAD_tmp_22
      OpenAD_lin_167 = __value__(OMEGA)
      OpenAD_lin_168 = __value__(NXHAT)
      OpenAD_lin_169 = __value__(DRW)
      OpenAD_tmp_23 = (__value__(CAVE) * __value__(NZHAT) - __value__(
     > WTILDE))
      OpenAD_tmp_24 = (- __value__(NZHAT))
      __value__(ALP4) = (__value__(DRV) * __value__(NXHAT) + __value__(
     > DR) * OpenAD_tmp_23 + __value__(OMEGA) * OpenAD_tmp_24 -
     >  __value__(DRU) * __value__(NYHAT))
      OpenAD_lin_170 = __value__(NXHAT)
      OpenAD_lin_171 = __value__(DRV)
      OpenAD_lin_172 = OpenAD_tmp_23
      OpenAD_lin_174 = __value__(NZHAT)
      OpenAD_lin_175 = __value__(CAVE)
      OpenAD_lin_173 = __value__(DR)
      OpenAD_lin_176 = OpenAD_tmp_24
      OpenAD_lin_177 = __value__(OMEGA)
      OpenAD_lin_178 = __value__(NYHAT)
      OpenAD_lin_179 = __value__(DRU)
      OpenAD_tmp_25 = (__value__(NDDRU) + __value__(OMEGA) - __value__(
     > DR) * __value__(UHAT))
      __value__(ALP5) = (OpenAD_tmp_25 * 5.0D-01)
      OpenAD_lin_181 = __value__(UHAT)
      OpenAD_lin_182 = __value__(DR)
...
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_115)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_116)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_117)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_118)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_123)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_124)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_125)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_126)
C     $OpenAD$ INLINE push(subst)
...
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_154)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_155)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_164)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_165)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_174)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_175)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_119)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_120)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_121)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_122)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_139)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_140)
C     $OpenAD$ INLINE push(subst)
...
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_141)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_142)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_143)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_144)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_145)
C     $OpenAD$ INLINE push(subst)
...
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_148)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_149)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_acc_48)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_acc_49)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_150)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_151)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_152)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_153)
C     $OpenAD$ INLINE push(subst)
...
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_160)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_161)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_162)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_163)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_166)
C     $OpenAD$ INLINE push(subst)
...
C     $OpenAD$ INLINE push(subst)
     ...
     >  __value__(ALP2) * __value__(NXHAT) + __value__(ALP3) *
     >  __value__(NYHAT) + __value__(ALP4) * __value__(NZHAT))
      OpenAD_lin_193 = (INT(1_w2f__i8) / __value__(CAVE))
      OpenAD_lin_194 = (-(__value__(ALP15P) /(__value__(CAVE) *
     >  __value__(CAVE))))
      OpenAD_lin_195 = __value__(NXHAT)
      OpenAD_lin_196 = __value__(ALP2)
      OpenAD_lin_197 = __value__(NYHAT)
      OpenAD_lin_198 = __value__(ALP3)
      OpenAD_lin_199 = __value__(NZHAT)
      OpenAD_lin_200 = __value__(ALP4)
      OpenAD_tmp_26 = (__value__(GM1INV) * __value__(CAVE))
      __value__(DSS1) = (__value__(MU) * __value__(THTAVE) + __value__(
     > ALP15P) * OpenAD_tmp_26 - __value__(ALP15M) * __value__(UHAT) +
     >  __value__(ALP2) * __value__(UTILDE) + __value__(ALP3) *
     >  __value__(VTILDE) + __value__(ALP4) * __value__(WTILDE))
      OpenAD_lin_201 = __value__(THTAVE)
      OpenAD_lin_202 = __value__(MU)
      OpenAD_lin_203 = OpenAD_tmp_26
      OpenAD_lin_205 = __value__(CAVE)
      OpenAD_lin_206 = __value__(GM1INV)
      OpenAD_lin_204 = __value__(ALP15P)
      OpenAD_lin_207 = __value__(UHAT)
      OpenAD_lin_208 = __value__(ALP15M)
      OpenAD_lin_209 = __value__(UTILDE)
      OpenAD_lin_210 = __value__(ALP2)
      OpenAD_lin_211 = __value__(VTILDE)
      OpenAD_lin_212 = __value__(ALP3)
      OpenAD_lin_213 = __value__(WTILDE)
      OpenAD_lin_214 = __value__(ALP4)
      __value__(DSS2) = __value__(MU)
      __value__(DSS3) = (__value__(ALP3) * __value__(NZHAT) + __value__
     > (MU) * __value__(UAVE) - __value__(ALP15M) * __value__(NXHAT) -
     >  __value__(ALP4) * __value__(NYHAT))
      OpenAD_lin_215 = __value__(NZHAT)
      OpenAD_lin_216 = __value__(ALP3)
      OpenAD_lin_217 = __value__(UAVE)
      OpenAD_lin_218 = __value__(MU)
      OpenAD_lin_219 = __value__(NXHAT)
      OpenAD_lin_220 = __value__(ALP15M)
      OpenAD_lin_221 = __value__(NYHAT)
      OpenAD_lin_222 = __value__(ALP4)
      __value__(DSS4) = (__value__(ALP4) * __value__(NXHAT) + __value__
     > (MU) * __value__(VAVE) - __value__(ALP15M) * __value__(NYHAT) -
     >  __value__(ALP2) * __value__(NZHAT))
      OpenAD_lin_223 = __value__(NXHAT)
      OpenAD_lin_224 = __value__(ALP4)
      OpenAD_lin_225 = __value__(VAVE)
      OpenAD_lin_226 = __value__(MU)
      OpenAD_lin_227 = __value__(NYHAT)
      OpenAD_lin_228 = __value__(ALP15M)
      OpenAD_lin_229 = __value__(NZHAT)
      OpenAD_lin_230 = __value__(ALP2)
      __value__(DSS5) = (__value__(ALP2) * __value__(NYHAT) + __value__
     > (MU) * __value__(WAVE) - __value__(ALP15M) * __value__(NZHAT) -
     >  __value__(ALP3) * __value__(NXHAT))
      OpenAD_lin_231 = __value__(NYHAT)
      OpenAD_lin_232 = __value__(ALP2)
      OpenAD_lin_233 = __value__(WAVE)
      OpenAD_lin_234 = __value__(MU)
      OpenAD_lin_235 = __value__(NZHAT)
      OpenAD_lin_236 = __value__(ALP15M)
      OpenAD_lin_237 = __value__(NXHAT)
      OpenAD_lin_238 = __value__(ALP3)
      __value__(UHATL) = (__value__(PRIML(3)) * __value__(NXHAT) +
     >  __value__(PRIML(4)) * __value__(NYHAT) + __value__(PRIML(5)) *
     >  __value__(NZHAT))
      OpenAD_lin_239 = __value__(NXHAT)
      OpenAD_lin_240 = __value__(PRIML(3))
      OpenAD_lin_241 = __value__(NYHAT)
      OpenAD_lin_242 = __value__(PRIML(4))
      OpenAD_lin_243 = __value__(NZHAT)
      OpenAD_lin_244 = __value__(PRIML(5))
      OpenAD_tmp_28 = (__value__(PRIML(1)) + __value__(EL))
      OpenAD_tmp_27 = (__value__(DSS1) + __value__(UHATL) *
     >  OpenAD_tmp_28)
      __value__(FLUX(1)) = (__value__(NSIZE) * OpenAD_tmp_27)
      OpenAD_lin_245 = OpenAD_tmp_27
      OpenAD_lin_247 = OpenAD_tmp_28
      OpenAD_lin_248 = __value__(UHATL)
...
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_187)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_188)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_189)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_190)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_191)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_192)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_239)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_240)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_241)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_242)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_243)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_244)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_193)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_194)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_195)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_196)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_197)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_198)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_199)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_200)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_217)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_218)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_acc_66)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_acc_67)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_215)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_216)
C     $OpenAD$ INLINE push(subst)
...
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_223)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_224)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_acc_74)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_acc_75)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_233)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_234)
C     $OpenAD$ INLINE push(subst)
...
C     $OpenAD$ INLINE push(subst)
      ...
      OpenAD_tmp_29 = (__value__(DSS2) + __value__(PRIML(2)) *
     >  __value__(UHATL))
      __value__(FLUX(2)) = (__value__(NSIZE) * OpenAD_tmp_29)
      OpenAD_lin_249 = OpenAD_tmp_29
      OpenAD_lin_251 = __value__(UHATL)
      OpenAD_lin_252 = __value__(PRIML(2))
      OpenAD_lin_250 = __value__(NSIZE)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_251)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_252)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_249)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_250)
      OpenAD_tmp_30 = (__value__(DSS3) + __value__(PRIML(1)) *
     >  __value__(NXHAT) + __value__(RUL) * __value__(UHATL))
      __value__(FLUX(3)) = (__value__(NSIZE) * OpenAD_tmp_30)
      OpenAD_lin_253 = OpenAD_tmp_30
      OpenAD_lin_255 = __value__(NXHAT)
      OpenAD_lin_256 = __value__(PRIML(1))
      OpenAD_lin_257 = __value__(UHATL)
      OpenAD_lin_258 = __value__(RUL)
      OpenAD_lin_254 = __value__(NSIZE)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_255)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_256)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_257)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_258)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_253)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_254)
      OpenAD_tmp_31 = (__value__(DSS4) + __value__(PRIML(1)) *
     >  __value__(NYHAT) + __value__(RVL) * __value__(UHATL))
      __value__(FLUX(4)) = (__value__(NSIZE) * OpenAD_tmp_31)
      OpenAD_lin_259 = OpenAD_tmp_31
      OpenAD_lin_261 = __value__(NYHAT)
      OpenAD_lin_262 = __value__(PRIML(1))
      OpenAD_lin_263 = __value__(UHATL)
      OpenAD_lin_264 = __value__(RVL)
      OpenAD_lin_260 = __value__(NSIZE)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_261)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_262)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_263)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_264)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_259)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_260)
      OpenAD_tmp_32 = (__value__(DSS5) + __value__(PRIML(1)) *
     >  __value__(NZHAT) + __value__(RWL) * __value__(UHATL))
      __value__(FLUX(5)) = (__value__(NSIZE) * OpenAD_tmp_32)
      OpenAD_lin_265 = OpenAD_tmp_32
      OpenAD_lin_267 = __value__(NZHAT)
      OpenAD_lin_268 = __value__(PRIML(1))
      OpenAD_lin_269 = __value__(UHATL)
      OpenAD_lin_270 = __value__(RWL)
      OpenAD_lin_266 = __value__(NSIZE)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_267)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_268)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_269)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_270)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_265)
C     $OpenAD$ INLINE push(subst)
      CALL push(OpenAD_lin_266)
C     $OpenAD$ END REPLACEMENT
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_99, __deriv__(FLUX(5)), __deriv__(
     > OpenAD_prop_28))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_100, __deriv__(FLUX(5)), __deriv__(NSIZE
     > ))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(FLUX(5)))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_101, __deriv__(OpenAD_prop_28),
     >  __deriv__(UHATL))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_102, __deriv__(OpenAD_prop_28),
     >  __deriv__(RWL))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_103, __deriv__(OpenAD_prop_28),
     >  __deriv__(NZHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_104, __deriv__(OpenAD_prop_28),
     >  __deriv__(PRIML(1)))
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_105, __deriv__(FLUX(4)), __deriv__(
     > OpenAD_prop_27))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_106, __deriv__(FLUX(4)), __deriv__(NSIZE
     > ))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(FLUX(4)))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_107, __deriv__(OpenAD_prop_27),
     >  __deriv__(UHATL))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_108, __deriv__(OpenAD_prop_27),
     >  __deriv__(RVL))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_109, __deriv__(OpenAD_prop_27),
     >  __deriv__(NYHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_110, __deriv__(OpenAD_prop_27),
     >  __deriv__(PRIML(1)))
C     $OpenAD$ INLINE IncDeriv(subst,subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_111, __deriv__(FLUX(3)), __deriv__(
     > OpenAD_prop_26))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_112, __deriv__(FLUX(3)), __deriv__(NSIZE
     > ))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(FLUX(3)))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_113, __deriv__(OpenAD_prop_26),
     >  __deriv__(UHATL))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_114, __deriv__(OpenAD_prop_26),
     >  __deriv__(RUL))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_115, __deriv__(OpenAD_prop_26),
     >  __deriv__(NXHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_116, __deriv__(OpenAD_prop_26),
     >  __deriv__(PRIML(1)))
C     $OpenAD$ INLINE IncDeriv(subst,subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_117, __deriv__(FLUX(2)), __deriv__(
     > OpenAD_prop_25))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_118, __deriv__(FLUX(2)), __deriv__(NSIZE
     > ))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(FLUX(2)))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_119, __deriv__(OpenAD_prop_25),
     >  __deriv__(UHATL))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_120, __deriv__(OpenAD_prop_25),
     >  __deriv__(PRIML(2)))
C     $OpenAD$ INLINE IncDeriv(subst,subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_121, __deriv__(FLUX(1)), __deriv__(UHAT)
     > )
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_122, __deriv__(FLUX(1)), __deriv__(
     > ALP15M))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_123, __deriv__(FLUX(1)), __deriv__(CAVE)
     > )
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_124, __deriv__(FLUX(1)), __deriv__(
     > GM1INV))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_125, __deriv__(FLUX(1)), __deriv__(
     > ALP15P))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_126, __deriv__(FLUX(1)), __deriv__(
     > THTAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_127, __deriv__(FLUX(1)), __deriv__(MU))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_128, __deriv__(FLUX(1)), __deriv__(
     > UTILDE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_129, __deriv__(FLUX(1)), __deriv__(ALP2)
     > )
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_130, __deriv__(FLUX(1)), __deriv__(
     > VTILDE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_131, __deriv__(FLUX(1)), __deriv__(ALP3)
     > )
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_132, __deriv__(FLUX(1)), __deriv__(
     > WTILDE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_133, __deriv__(FLUX(1)), __deriv__(ALP4)
     > )
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_134, __deriv__(FLUX(1)), __deriv__(
     > OpenAD_prop_24))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_135, __deriv__(FLUX(1)), __deriv__(UHATL
     > ))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_136, __deriv__(FLUX(1)), __deriv__(NSIZE
     > ))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(FLUX(1)))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_137, __deriv__(DSS5), __deriv__(NZHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_138, __deriv__(DSS5), __deriv__(ALP15M))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_139, __deriv__(DSS5), __deriv__(NYHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_140, __deriv__(DSS5), __deriv__(ALP2))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_141, __deriv__(DSS5), __deriv__(NXHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_142, __deriv__(DSS5), __deriv__(ALP3))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_143, __deriv__(DSS5), __deriv__(WAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_144, __deriv__(DSS5), __deriv__(MU))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(DSS5))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_145, __deriv__(DSS4), __deriv__(NYHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_146, __deriv__(DSS4), __deriv__(ALP15M))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_147, __deriv__(DSS4), __deriv__(NXHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_148, __deriv__(DSS4), __deriv__(ALP4))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_149, __deriv__(DSS4), __deriv__(NZHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_150, __deriv__(DSS4), __deriv__(ALP2))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_151, __deriv__(DSS4), __deriv__(VAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_152, __deriv__(DSS4), __deriv__(MU))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(DSS4))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_153, __deriv__(DSS3), __deriv__(NXHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_154, __deriv__(DSS3), __deriv__(ALP15M))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_155, __deriv__(DSS3), __deriv__(NZHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_156, __deriv__(DSS3), __deriv__(ALP3))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_157, __deriv__(DSS3), __deriv__(NYHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_158, __deriv__(DSS3), __deriv__(ALP4))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_159, __deriv__(DSS3), __deriv__(UAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_160, __deriv__(DSS3), __deriv__(MU))
C     $OpenAD$ INLINE ZeroDeriv(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_161, __deriv__(MU), __deriv__(NZHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_162, __deriv__(MU), __deriv__(ALP4))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_163, __deriv__(MU), __deriv__(NYHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_164, __deriv__(MU), __deriv__(ALP3))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_165, __deriv__(MU), __deriv__(NXHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_166, __deriv__(MU), __deriv__(ALP2))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_167, __deriv__(MU), __deriv__(CAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_168, __deriv__(MU), __deriv__(ALP15P))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(MU))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_169, __deriv__(UHATL), __deriv__(NZHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_170, __deriv__(UHATL), __deriv__(PRIML(5
     > )))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_171, __deriv__(UHATL), __deriv__(NYHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_172, __deriv__(UHATL), __deriv__(PRIML(4
     > )))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_173, __deriv__(UHATL), __deriv__(NXHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_174, __deriv__(UHATL), __deriv__(PRIML(3
     > )))
C     $OpenAD$ INLINE ZeroDeriv(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_175, __deriv__(ALP5), __deriv__(
     > OpenAD_prop_23))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_176, __deriv__(ALP5), __deriv__(ALAMCP))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(ALP5))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_177, __deriv__(ALP4), __deriv__(
     > OpenAD_prop_22))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_178, __deriv__(ALP4), __deriv__(ALAMU))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(ALP4))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_179, __deriv__(ALP3), __deriv__(
     > OpenAD_prop_21))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_180, __deriv__(ALP3), __deriv__(ALAMU))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(ALP3))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_181, __deriv__(ALP2), __deriv__(
     > OpenAD_prop_20))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_182, __deriv__(ALP2), __deriv__(ALAMU))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(ALP2))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_183, __deriv__(ALP1), __deriv__(
     > OpenAD_prop_19))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_184, __deriv__(ALP1), __deriv__(ALAMCM))
C     $OpenAD$ INLINE ZeroDeriv(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_185, __deriv__(ALP4), __deriv__(NYHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_186, __deriv__(ALP4), __deriv__(DRU))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_187, __deriv__(ALP4), __deriv__(NZHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_188, __deriv__(ALP4), __deriv__(OMEGA))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_189, __deriv__(ALP4), __deriv__(
     > OpenAD_prop_15))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_190, __deriv__(ALP4), __deriv__(DR))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_191, __deriv__(ALP4), __deriv__(NXHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_192, __deriv__(ALP4), __deriv__(DRV))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(ALP4))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_193, __deriv__(ALP3), __deriv__(NXHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_194, __deriv__(ALP3), __deriv__(DRW))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_195, __deriv__(ALP3), __deriv__(NYHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_196, __deriv__(ALP3), __deriv__(OMEGA))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_197, __deriv__(ALP3), __deriv__(
     > OpenAD_prop_14))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_198, __deriv__(ALP3), __deriv__(DR))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_199, __deriv__(ALP3), __deriv__(NZHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_200, __deriv__(ALP3), __deriv__(DRU))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(ALP3))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_201, __deriv__(ALP2), __deriv__(NZHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_202, __deriv__(ALP2), __deriv__(DRV))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_203, __deriv__(ALP2), __deriv__(NXHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_204, __deriv__(ALP2), __deriv__(OMEGA))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_205, __deriv__(ALP2), __deriv__(
     > OpenAD_prop_13))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_206, __deriv__(ALP2), __deriv__(DR))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_207, __deriv__(ALP2), __deriv__(NYHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_208, __deriv__(ALP2), __deriv__(DRW))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(ALP2))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
...
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(ALP1))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_209, __deriv__(OpenAD_prop_18),
     >  __deriv__(UHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_210, __deriv__(OpenAD_prop_18),
     >  __deriv__(DR))
C     $OpenAD$ INLINE IncDeriv(subst,subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_211, __deriv__(OpenAD_prop_17),
     >  __deriv__(UHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_212, __deriv__(OpenAD_prop_17),
     >  __deriv__(DR))
C     $OpenAD$ INLINE DecDeriv(subst,subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_213, __deriv__(OMEGA), __deriv__(CAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_214, __deriv__(OMEGA), __deriv__(GM1))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_215, __deriv__(OMEGA), __deriv__(
     > OpenAD_prop_16))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(OMEGA))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_216, __deriv__(NDDRU), __deriv__(NZHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_217, __deriv__(NDDRU), __deriv__(DRW))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_218, __deriv__(NDDRU), __deriv__(NYHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_219, __deriv__(NDDRU), __deriv__(DRV))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_220, __deriv__(NDDRU), __deriv__(NXHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_221, __deriv__(NDDRU), __deriv__(DRU))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(NDDRU))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_222, __deriv__(OpenAD_prop_16),
     >  __deriv__(WAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_223, __deriv__(OpenAD_prop_16),
     >  __deriv__(DRW))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_224, __deriv__(OpenAD_prop_16),
     >  __deriv__(VAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_225, __deriv__(OpenAD_prop_16),
     >  __deriv__(DRV))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_226, __deriv__(OpenAD_prop_16),
     >  __deriv__(UAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_227, __deriv__(OpenAD_prop_16),
     >  __deriv__(DRU))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_228, __deriv__(OpenAD_prop_16),
     >  __deriv__(THTAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_229, __deriv__(OpenAD_prop_16),
     >  __deriv__(DR))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_230, __deriv__(OpenAD_prop_16),
     >  __deriv__(THETAR))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_231, __deriv__(OpenAD_prop_16),
     >  __deriv__(PRIMR(2)))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_232, __deriv__(OpenAD_prop_16),
     >  __deriv__(GM1INV))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_233, __deriv__(OpenAD_prop_16),
     >  __deriv__(PRIMR(1)))
C     $OpenAD$ INLINE DecDeriv(subst,subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_234, __deriv__(OpenAD_prop_15),
     >  __deriv__(NZHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_235, __deriv__(OpenAD_prop_15),
     >  __deriv__(CAVE))
C     $OpenAD$ INLINE DecDeriv(subst,subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_236, __deriv__(OpenAD_prop_14),
     >  __deriv__(NYHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_237, __deriv__(OpenAD_prop_14),
     >  __deriv__(CAVE))
C     $OpenAD$ INLINE DecDeriv(subst,subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_238, __deriv__(OpenAD_prop_13),
     >  __deriv__(NXHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_239, __deriv__(OpenAD_prop_13),
     >  __deriv__(CAVE))
C     $OpenAD$ INLINE DecDeriv(subst,subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_240, __deriv__(EL), __deriv__(THETAL))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_241, __deriv__(EL), __deriv__(PRIML(2)))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_242, __deriv__(EL), __deriv__(GM1INV))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_243, __deriv__(EL), __deriv__(PRIML(1)))
C     $OpenAD$ INLINE ZeroDeriv(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_244, __deriv__(DRW), __deriv__(PRIMR(5))
     > )
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_245, __deriv__(DRW), __deriv__(PRIMR(2))
     > )
C     $OpenAD$ INLINE DecDeriv(subst,subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_246, __deriv__(DRV), __deriv__(PRIMR(4))
     > )
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_247, __deriv__(DRV), __deriv__(PRIMR(2))
     > )
C     $OpenAD$ INLINE DecDeriv(subst,subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_248, __deriv__(DRU), __deriv__(PRIMR(3))
     > )
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_249, __deriv__(DRU), __deriv__(PRIMR(2))
     > )
C     $OpenAD$ INLINE DecDeriv(subst,subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_250, __deriv__(RWL), __deriv__(PRIML(5))
     > )
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_251, __deriv__(RWL), __deriv__(PRIML(2))
     > )
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(RWL))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_252, __deriv__(RVL), __deriv__(PRIML(4))
     > )
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_253, __deriv__(RVL), __deriv__(PRIML(2))
     > )
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(RVL))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_254, __deriv__(RUL), __deriv__(PRIML(3))
     > )
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_255, __deriv__(RUL), __deriv__(PRIML(2))
     > )
C     $OpenAD$ INLINE ZeroDeriv(subst)
...
C       $OpenAD$ INLINE ZeroDeriv(subst)
      ...
      ELSE
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_256)
C       $OpenAD$ INLINE Pop(subst)
        CALL Pop(OpenAD_Symbol_257)
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_256, __deriv__(ALAMU), __deriv__(
     > OpenAD_prop_29))
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_257, __deriv__(ALAMU), __deriv__(
     > DELTA2))
C       $OpenAD$ INLINE ZeroDeriv(subst)
        CALL ZeroDeriv(__deriv__(ALAMU))
C       $OpenAD$ INLINE IncDeriv(subst,subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_96, __deriv__(DELTA2), __deriv__(
     > OpenAD_prop_6))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_97, __deriv__(DELTA2), __deriv__(LEFIX))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(DELTA2))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_98, __deriv__(LAM2), __deriv__(LAMU))
C     $OpenAD$ INLINE ZeroDeriv(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_258, __deriv__(ALAMCP), __deriv__(
     > OpenAD_prop_30))
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_259, __deriv__(ALAMCP), __deriv__(
     > DELTA2))
C       $OpenAD$ INLINE ZeroDeriv(subst)
        CALL ZeroDeriv(__deriv__(ALAMCP))
C       $OpenAD$ INLINE IncDeriv(subst,subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_95, __deriv__(LAM2), __deriv__(LAMCP))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(LAM2))
C     $OpenAD$ INLINE pop_i(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_260, __deriv__(ALAMCM), __deriv__(
     > OpenAD_prop_31))
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_261, __deriv__(ALAMCM), __deriv__(
     > DELTA2))
C       $OpenAD$ INLINE ZeroDeriv(subst)
        CALL ZeroDeriv(__deriv__(ALAMCM))
C       $OpenAD$ INLINE IncDeriv(subst,subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_34, __deriv__(DELTA2), __deriv__(
     > OpenAD_prop_5))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_35, __deriv__(DELTA2), __deriv__(NLEFIX)
     > )
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(DELTA2))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_36, __deriv__(LAM2), __deriv__(LAMCM))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(LAM2))
C     $OpenAD$ INLINE IncDeriv(subst,subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_37, __deriv__(UHAT), __deriv__(WAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_38, __deriv__(UHAT), __deriv__(NZHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_39, __deriv__(UHAT), __deriv__(VAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_40, __deriv__(UHAT), __deriv__(NYHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_41, __deriv__(UHAT), __deriv__(UAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_42, __deriv__(UHAT), __deriv__(NXHAT))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(UHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_43, __deriv__(WTILDE), __deriv__(UAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_44, __deriv__(WTILDE), __deriv__(NYHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_45, __deriv__(WTILDE), __deriv__(VAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_46, __deriv__(WTILDE), __deriv__(NXHAT))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(WTILDE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_47, __deriv__(VTILDE), __deriv__(WAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_48, __deriv__(VTILDE), __deriv__(NXHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_49, __deriv__(VTILDE), __deriv__(UAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_50, __deriv__(VTILDE), __deriv__(NZHAT))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(VTILDE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_51, __deriv__(UTILDE), __deriv__(VAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_52, __deriv__(UTILDE), __deriv__(NZHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_53, __deriv__(UTILDE), __deriv__(WAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_54, __deriv__(UTILDE), __deriv__(NYHAT))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(UTILDE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_55, __deriv__(CAVE), __deriv__(
     > OpenAD_prop_4))
C     $OpenAD$ INLINE ZeroDeriv(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_56, __deriv__(CAVE), __deriv__(
     > OpenAD_prop_0))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_57, __deriv__(CAVE), __deriv__(HL))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_58, __deriv__(CAVE), __deriv__(HR))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_59, __deriv__(CAVE), __deriv__(
     > OpenAD_prop_3))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_60, __deriv__(CAVE), __deriv__(GM1))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(CAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_61, __deriv__(OpenAD_prop_3), __deriv__(
     > UAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_62, __deriv__(OpenAD_prop_3), __deriv__(
     > VAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_63, __deriv__(OpenAD_prop_3), __deriv__(
     > WAVE))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(OpenAD_prop_3))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_64, __deriv__(WAVE), __deriv__(
     > OpenAD_prop_0))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_65, __deriv__(WAVE), __deriv__(PRIML(5))
     > )
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_66, __deriv__(WAVE), __deriv__(PRIMR(5))
     > )
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(WAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_67, __deriv__(VAVE), __deriv__(
     > OpenAD_prop_0))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_68, __deriv__(VAVE), __deriv__(PRIML(4))
     > )
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_69, __deriv__(VAVE), __deriv__(PRIMR(4))
     > )
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(VAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_70, __deriv__(UAVE), __deriv__(PRIML(3))
     > )
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_71, __deriv__(UAVE), __deriv__(
     > OpenAD_prop_0))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_72, __deriv__(UAVE), __deriv__(PRIMR(3))
     > )
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(UAVE))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_73, __deriv__(HR), __deriv__(GM1INV))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_74, __deriv__(HR), __deriv__(GAMMA))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_75, __deriv__(HR), __deriv__(PRIMR(1)))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_76, __deriv__(HR), __deriv__(PRIMR(2)))
C     $OpenAD$ INLINE IncDeriv(subst,subst)
      CALL IncDeriv(__deriv__(HR), __deriv__(THETAR))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(HR))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_77, __deriv__(HL), __deriv__(GM1INV))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_78, __deriv__(HL), __deriv__(GAMMA))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_79, __deriv__(HL), __deriv__(PRIML(1)))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_80, __deriv__(HL), __deriv__(PRIML(2)))
C     $OpenAD$ INLINE IncDeriv(subst,subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_81, __deriv__(OpenAD_prop_2), __deriv__(
     > PRIMR(4)))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_82, __deriv__(OpenAD_prop_2), __deriv__(
     > PRIMR(3)))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_83, __deriv__(OpenAD_prop_2), __deriv__(
     > PRIMR(5)))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(OpenAD_prop_2))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_84, __deriv__(OpenAD_prop_1), __deriv__(
     > PRIML(4)))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_85, __deriv__(OpenAD_prop_1), __deriv__(
     > PRIML(3)))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_86, __deriv__(OpenAD_prop_1), __deriv__(
     > PRIML(5)))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(OpenAD_prop_1))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_87, __deriv__(OpenAD_prop_0), __deriv__(
     > PRIML(2)))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_88, __deriv__(OpenAD_prop_0), __deriv__(
     > PRIMR(2)))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(OpenAD_prop_0))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_89, __deriv__(NZHAT), __deriv__(NSIZEI))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_90, __deriv__(NZHAT), __deriv__(NRM(3)))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(NZHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_91, __deriv__(NYHAT), __deriv__(NSIZEI))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_92, __deriv__(NYHAT), __deriv__(NRM(2)))
C     $OpenAD$ INLINE ZeroDeriv(subst)
      CALL ZeroDeriv(__deriv__(NYHAT))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_93, __deriv__(NXHAT), __deriv__(NSIZEI))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_94, __deriv__(NXHAT), __deriv__(NRM(1)))
C     $OpenAD$ INLINE ZeroDeriv(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_33, __deriv__(NSIZEI), __deriv__(NSIZE
     > ))
C       $OpenAD$ INLINE ZeroDeriv(subst)
...
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_30, __deriv__(NSIZE), __deriv__(NRM(1)))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_31, __deriv__(NSIZE), __deriv__(NRM(2)))
C     $OpenAD$ INLINE Saxpy(subst,subst,subst)
      CALL Saxpy(OpenAD_Symbol_32, __deriv__(NSIZE), __deriv__(NRM(3)))
C     $OpenAD$ INLINE ZeroDeriv(subst)
