...
C adjoint
      ...
      T1%d = T1%d+Y(1)%d*(OpenAD_Symbol_13)
      Y(1)%d = 0.0d0
      T1%d = T1%d+Y4%d*(OpenAD_Symbol_14)
      Y4%d = 0.0d0
      T1%d = T1%d+Y3%d*(OpenAD_Symbol_15)
      Y3%d = 0.0d0
      T1%d = T1%d+Y2%d*(OpenAD_Symbol_16)
      Y2%d = 0.0d0
      X(2)%d = X(2)%d+T1%d*(OpenAD_Symbol_17)
      X(1)%d = X(1)%d+T1%d*(OpenAD_Symbol_18)
      T1%d = 0.0d0
          end if
        end subroutine head
