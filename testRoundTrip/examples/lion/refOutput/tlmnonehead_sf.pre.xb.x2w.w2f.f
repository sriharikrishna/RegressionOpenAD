...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_8)
      ...
      CALL sax(OpenAD_Symbol_10, __deriv__(T1), __deriv__(Y2))
      CALL sax(OpenAD_Symbol_11, __deriv__(T1), __deriv__(Y3))
      CALL sax(OpenAD_Symbol_9, __deriv__(T1), __deriv__(Y4))
      CALL sax(OpenAD_Symbol_12, __deriv__(T1), __deriv__(Y(1)))
