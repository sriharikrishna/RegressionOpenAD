...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_7)
      ...
      CALL sax(OpenAD_Symbol_13, __deriv__(X(1)), __deriv__(Y2))
      CALL saxpy(OpenAD_Symbol_17, __deriv__(X(2)), __deriv__(Y2))
      CALL sax(OpenAD_Symbol_14, __deriv__(X(1)), __deriv__(Y3))
      CALL saxpy(OpenAD_Symbol_18, __deriv__(X(2)), __deriv__(Y3))
      CALL sax(OpenAD_Symbol_12, __deriv__(X(1)), __deriv__(Y4))
      CALL saxpy(OpenAD_Symbol_16, __deriv__(X(2)), __deriv__(Y4))
      CALL sax(OpenAD_Symbol_15, __deriv__(X(1)), __deriv__(Y(1)))
      CALL saxpy(OpenAD_Symbol_19, __deriv__(X(2)), __deriv__(Y(1)))
