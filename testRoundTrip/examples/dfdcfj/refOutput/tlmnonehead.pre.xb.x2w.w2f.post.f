...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_80)
          ...
          CALL setderiv(OpenAD_Symbol_99,PT)
          CALL dec_deriv(OpenAD_Symbol_99,PB)
          CALL setderiv(OpenAD_Symbol_100,PR)
          CALL dec_deriv(OpenAD_Symbol_100,PL)
          CALL setderiv(OpenAD_Symbol_101,PBB)
          CALL inc_deriv(OpenAD_Symbol_101,P)
          CALL saxpy(-2.0D00,PB,OpenAD_Symbol_101)
          CALL setderiv(OpenAD_Symbol_102,PBL)
          CALL inc_deriv(OpenAD_Symbol_102,PBR)
          CALL saxpy(-2.0D00,PB,OpenAD_Symbol_102)
          CALL setderiv(OpenAD_Symbol_103,PBL)
          CALL inc_deriv(OpenAD_Symbol_103,PTL)
          CALL saxpy(-2.0D00,PL,OpenAD_Symbol_103)
          CALL setderiv(OpenAD_Symbol_104,PLL)
          CALL inc_deriv(OpenAD_Symbol_104,P)
          CALL saxpy(-2.0D00,PL,OpenAD_Symbol_104)
          CALL setderiv(OpenAD_Symbol_105,PB)
          CALL inc_deriv(OpenAD_Symbol_105,PT)
          CALL saxpy(-2.0D00,P,OpenAD_Symbol_105)
          CALL setderiv(OpenAD_Symbol_106,PL)
          CALL inc_deriv(OpenAD_Symbol_106,PR)
          CALL saxpy(-2.0D00,P,OpenAD_Symbol_106)
          CALL setderiv(OpenAD_Symbol_107,P)
          CALL inc_deriv(OpenAD_Symbol_107,PRR)
          CALL saxpy(-2.0D00,PR,OpenAD_Symbol_107)
          CALL setderiv(OpenAD_Symbol_108,PBR)
          CALL inc_deriv(OpenAD_Symbol_108,PTR)
          CALL saxpy(-2.0D00,PR,OpenAD_Symbol_108)
          CALL setderiv(OpenAD_Symbol_109,P)
          CALL inc_deriv(OpenAD_Symbol_109,PTT)
          CALL saxpy(-2.0D00,PT,OpenAD_Symbol_109)
          CALL setderiv(OpenAD_Symbol_110,PTL)
          CALL inc_deriv(OpenAD_Symbol_110,PTR)
