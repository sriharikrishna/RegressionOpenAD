...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_80)
          ...
          CALL setderiv(__deriv__(OpenAD_Symbol_99), __deriv__(PT))
          CALL dec_deriv(__deriv__(OpenAD_Symbol_99), __deriv__(PB))
          CALL setderiv(__deriv__(OpenAD_Symbol_100), __deriv__(PR))
          CALL dec_deriv(__deriv__(OpenAD_Symbol_100), __deriv__(PL))
          CALL setderiv(__deriv__(OpenAD_Symbol_101), __deriv__(PBB))
          CALL inc_deriv(__deriv__(OpenAD_Symbol_101), __deriv__(P))
          CALL saxpy(-2.0D00, __deriv__(PB), __deriv__(
     > OpenAD_Symbol_101))
          CALL setderiv(__deriv__(OpenAD_Symbol_102), __deriv__(PBL))
          CALL inc_deriv(__deriv__(OpenAD_Symbol_102), __deriv__(PBR))
          CALL saxpy(-2.0D00, __deriv__(PB), __deriv__(
     > OpenAD_Symbol_102))
          CALL setderiv(__deriv__(OpenAD_Symbol_103), __deriv__(PBL))
          CALL inc_deriv(__deriv__(OpenAD_Symbol_103), __deriv__(PTL))
          CALL saxpy(-2.0D00, __deriv__(PL), __deriv__(
     > OpenAD_Symbol_103))
          CALL setderiv(__deriv__(OpenAD_Symbol_104), __deriv__(PLL))
          CALL inc_deriv(__deriv__(OpenAD_Symbol_104), __deriv__(P))
          CALL saxpy(-2.0D00, __deriv__(PL), __deriv__(
     > OpenAD_Symbol_104))
          CALL setderiv(__deriv__(OpenAD_Symbol_105), __deriv__(PB))
          CALL inc_deriv(__deriv__(OpenAD_Symbol_105), __deriv__(PT))
          CALL saxpy(-2.0D00, __deriv__(P), __deriv__(OpenAD_Symbol_105
     > ))
          CALL setderiv(__deriv__(OpenAD_Symbol_106), __deriv__(PL))
          CALL inc_deriv(__deriv__(OpenAD_Symbol_106), __deriv__(PR))
          CALL saxpy(-2.0D00, __deriv__(P), __deriv__(OpenAD_Symbol_106
     > ))
          CALL setderiv(__deriv__(OpenAD_Symbol_107), __deriv__(P))
          CALL inc_deriv(__deriv__(OpenAD_Symbol_107), __deriv__(PRR))
          CALL saxpy(-2.0D00, __deriv__(PR), __deriv__(
     > OpenAD_Symbol_107))
          CALL setderiv(__deriv__(OpenAD_Symbol_108), __deriv__(PBR))
          CALL inc_deriv(__deriv__(OpenAD_Symbol_108), __deriv__(PTR))
          CALL saxpy(-2.0D00, __deriv__(PR), __deriv__(
     > OpenAD_Symbol_108))
          CALL setderiv(__deriv__(OpenAD_Symbol_109), __deriv__(P))
          CALL inc_deriv(__deriv__(OpenAD_Symbol_109), __deriv__(PTT))
          CALL saxpy(-2.0D00, __deriv__(PT), __deriv__(
     > OpenAD_Symbol_109))
          CALL setderiv(__deriv__(OpenAD_Symbol_110), __deriv__(PTL))
          CALL inc_deriv(__deriv__(OpenAD_Symbol_110), __deriv__(PTR))
          CALL saxpy(-2.0D00, __deriv__(PT), __deriv__(
     > OpenAD_Symbol_110))
