...
C adjoint
      ...
      D%d = D%d+Y(3)%d*(OpenAD_Symbol_8)
      C%d = C%d+Y(3)%d*(OpenAD_Symbol_9)
      Y(3)%d = 0.0d0
      CALL foo(X(1),X(2),C,D)
      X(4)%d = X(4)%d+Y(2)%d
      Y(2)%d = 0.0d0
...
C adjoint
      ...
      OpenAD_prop_0%d = OpenAD_prop_0%d+D%d*(OpenAD_Symbol_10)
      D%d = 0.0d0
      B%d = B%d+C%d*(OpenAD_Symbol_11)
      A%d = A%d+C%d*(OpenAD_Symbol_12)
      C%d = 0.0d0
