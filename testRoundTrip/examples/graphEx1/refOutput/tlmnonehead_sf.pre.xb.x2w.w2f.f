...
C$OPENAD XXX Template ad_template.f
     ...
     > ) * OpenAD_lin_51))
      ...
      CALL sax(OpenAD_lin_5, __deriv__(X03), __deriv__(OpenAD_prop_0))
      CALL saxpy(OpenAD_lin_1, __deriv__(X01), __deriv__(OpenAD_prop_0)
     > )
      CALL saxpy(OpenAD_lin_3, __deriv__(X02), __deriv__(OpenAD_prop_0)
     > )
     ...
     > ))
      CALL sax(OpenAD_lin_27, __deriv__(X08), __deriv__(OpenAD_prop_2))
      CALL saxpy(OpenAD_lin_23, __deriv__(X06), __deriv__(OpenAD_prop_2
     > ))
      CALL saxpy(OpenAD_lin_25, __deriv__(X07), __deriv__(OpenAD_prop_2
     > ))
      CALL sax(OpenAD_lin_34, __deriv__(X13), __deriv__(OpenAD_prop_3))
      CALL saxpy(OpenAD_lin_30, __deriv__(X11), __deriv__(OpenAD_prop_3
     > ))
      CALL saxpy(OpenAD_lin_32, __deriv__(X12), __deriv__(OpenAD_prop_3
     > ))
      CALL sax(OpenAD_lin_0, __deriv__(OpenAD_prop_0), __deriv__(T01))
      CALL sax(OpenAD_lin_9, __deriv__(X01), __deriv__(T03))
      CALL saxpy(OpenAD_acc_2, __deriv__(T01), __deriv__(T03))
      CALL sax(OpenAD_lin_11, __deriv__(X02), __deriv__(T04))
      CALL saxpy(OpenAD_acc_3, __deriv__(T01), __deriv__(T04))
      CALL sax(OpenAD_lin_13, __deriv__(X03), __deriv__(T05))
      ...
      CALL saxpy(OpenAD_lin_37, __deriv__(X05), __deriv__(T10))
      ...
      CALL saxpy(OpenAD_lin_43, __deriv__(X10), __deriv__(T11))
      ...
      CALL sax(OpenAD_lin_50, __deriv__(X11), __deriv__(T12))
      CALL saxpy(OpenAD_acc_11, __deriv__(OpenAD_prop_1), __deriv__(T12
     > ))
      CALL saxpy(OpenAD_lin_48, __deriv__(X06), __deriv__(T12))
      CALL sax(OpenAD_lin_54, __deriv__(X12), __deriv__(T13))
      CALL saxpy(OpenAD_lin_52, __deriv__(X07), __deriv__(T13))
      CALL saxpy(OpenAD_acc_10, __deriv__(OpenAD_prop_1), __deriv__(T13
     > ))
      CALL sax(OpenAD_lin_58, __deriv__(X13), __deriv__(T14))
      CALL saxpy(OpenAD_lin_56, __deriv__(X08), __deriv__(T14))
      CALL saxpy(OpenAD_acc_9, __deriv__(OpenAD_prop_1), __deriv__(T14)
     > )
      CALL sax(OpenAD_lin_69, __deriv__(T14), __deriv__(OpenAD_prop_4))
      CALL saxpy(OpenAD_lin_67, __deriv__(T13), __deriv__(OpenAD_prop_4
     > ))
      CALL saxpy(OpenAD_lin_65, __deriv__(T12), __deriv__(OpenAD_prop_4
     > ))
      CALL sax(5.0D-01, __deriv__(OpenAD_prop_4), __deriv__(T18))
      CALL sax(OpenAD_lin_71, __deriv__(X15), __deriv__(T16))
     ...
     > ) * __value__(T12))
      ...
      CALL sax(OpenAD_lin_73, __deriv__(OpenAD_prop_5), __deriv__(T16))
      CALL sax(OpenAD_lin_80, __deriv__(T04), __deriv__(T19))
      CALL saxpy(OpenAD_lin_81, __deriv__(T14), __deriv__(T19))
      CALL saxpy(OpenAD_acc_20, __deriv__(T05), __deriv__(T19))
      CALL saxpy(OpenAD_acc_21, __deriv__(T13), __deriv__(T19))
      CALL sax(OpenAD_lin_84, __deriv__(T05), __deriv__(T20))
      CALL saxpy(OpenAD_lin_85, __deriv__(T12), __deriv__(T20))
      CALL saxpy(OpenAD_acc_22, __deriv__(T03), __deriv__(T20))
      CALL saxpy(OpenAD_acc_23, __deriv__(T14), __deriv__(T20))
      CALL sax(OpenAD_lin_88, __deriv__(T03), __deriv__(T21))
      CALL saxpy(OpenAD_lin_89, __deriv__(T13), __deriv__(T21))
      CALL saxpy(OpenAD_acc_24, __deriv__(T04), __deriv__(T21))
      CALL saxpy(OpenAD_acc_25, __deriv__(T12), __deriv__(T21))
      CALL sax(OpenAD_lin_74, __deriv__(T03), __deriv__(T17))
      CALL saxpy(OpenAD_lin_75, __deriv__(T12), __deriv__(T17))
      CALL saxpy(OpenAD_lin_76, __deriv__(T04), __deriv__(T17))
      CALL saxpy(OpenAD_lin_77, __deriv__(T13), __deriv__(T17))
      CALL saxpy(OpenAD_lin_78, __deriv__(T05), __deriv__(T17))
      CALL saxpy(OpenAD_lin_79, __deriv__(T14), __deriv__(T17))
     ...
     > ))
      CALL sax(OpenAD_lin_99, __deriv__(X05), __deriv__(T29))
      CALL saxpy(OpenAD_lin_100, __deriv__(X06), __deriv__(T29))
      CALL sax(OpenAD_lin_101, __deriv__(X05), __deriv__(T30))
      CALL saxpy(OpenAD_lin_102, __deriv__(X07), __deriv__(T30))
      CALL sax(OpenAD_lin_103, __deriv__(X05), __deriv__(T31))
      CALL saxpy(OpenAD_lin_104, __deriv__(X08), __deriv__(T31))
      ...
      CALL saxpy(OpenAD_lin_109, __deriv__(X10), __deriv__(T38))
      CALL saxpy(OpenAD_lin_110, __deriv__(X11), __deriv__(T38))
      CALL set_neg_deriv(__deriv__(T39), __deriv__(T30))
      CALL saxpy(OpenAD_lin_111, __deriv__(X10), __deriv__(T39))
      CALL saxpy(OpenAD_lin_112, __deriv__(X12), __deriv__(T39))
      CALL set_neg_deriv(__deriv__(T40), __deriv__(T31))
      CALL saxpy(OpenAD_lin_113, __deriv__(X10), __deriv__(T40))
      CALL saxpy(OpenAD_lin_114, __deriv__(X13), __deriv__(T40))
      ...
      CALL sax(OpenAD_lin_95, __deriv__(X04), __deriv__(T28))
      CALL saxpy(OpenAD_lin_96, __deriv__(X16), __deriv__(T28))
      CALL saxpy(OpenAD_lin_97, __deriv__(X05), __deriv__(T28))
      CALL saxpy(OpenAD_lin_98, __deriv__(T08), __deriv__(T28))
      CALL set_neg_deriv(__deriv__(T36), __deriv__(T28))
      CALL saxpy(OpenAD_lin_105, __deriv__(X09), __deriv__(T36))
      CALL saxpy(OpenAD_lin_106, __deriv__(X16), __deriv__(T36))
      CALL saxpy(OpenAD_lin_107, __deriv__(X10), __deriv__(T36))
      CALL saxpy(OpenAD_lin_108, __deriv__(T09), __deriv__(T36))
      CALL sax(OpenAD_lin_131, __deriv__(T05), __deriv__(T48))
      CALL saxpy(OpenAD_lin_132, __deriv__(T40), __deriv__(T48))
      CALL saxpy(OpenAD_lin_129, __deriv__(T04), __deriv__(T48))
      CALL saxpy(OpenAD_lin_130, __deriv__(T39), __deriv__(T48))
      CALL saxpy(OpenAD_lin_127, __deriv__(T03), __deriv__(T48))
      CALL saxpy(OpenAD_lin_128, __deriv__(T38), __deriv__(T48))
      ...
      CALL saxpy(OpenAD_lin_122, __deriv__(T36), __deriv__(T47))
      ...
      CALL sax(OpenAD_lin_142, __deriv__(T47), __deriv__(T42))
      ...
      CALL saxpy(OpenAD_lin_136, __deriv__(T04), __deriv__(T42))
      CALL saxpy(OpenAD_lin_137, __deriv__(T40), __deriv__(T42))
      CALL saxpy(OpenAD_acc_57, __deriv__(T05), __deriv__(T42))
      CALL saxpy(OpenAD_acc_58, __deriv__(T39), __deriv__(T42))
      CALL sax(OpenAD_lin_152, __deriv__(T47), __deriv__(T43))
      ...
      CALL saxpy(OpenAD_lin_146, __deriv__(T05), __deriv__(T43))
      CALL saxpy(OpenAD_lin_147, __deriv__(T38), __deriv__(T43))
      ...
      CALL saxpy(OpenAD_lin_156, __deriv__(T03), __deriv__(T44))
      CALL saxpy(OpenAD_lin_157, __deriv__(T39), __deriv__(T44))
     ...
     > T45))
      ...
      CALL sax(OpenAD_lin_225, __deriv__(X06), __deriv__(T57))
      CALL saxpy(OpenAD_lin_226, __deriv__(T03), __deriv__(T57))
      CALL saxpy(OpenAD_lin_227, __deriv__(X07), __deriv__(T57))
      CALL saxpy(OpenAD_lin_228, __deriv__(T04), __deriv__(T57))
      CALL saxpy(OpenAD_lin_229, __deriv__(X08), __deriv__(T57))
      CALL saxpy(OpenAD_lin_230, __deriv__(T05), __deriv__(T57))
      ...
      CALL sax(OpenAD_lin_235, __deriv__(T01), __deriv__(Y2))
      CALL saxpy(OpenAD_acc_108, __deriv__(X05), __deriv__(Y2))
      CALL saxpy(OpenAD_acc_109, __deriv__(T57), __deriv__(Y2))
      CALL saxpy(OpenAD_lin_236, __deriv__(T56), __deriv__(Y2))
      CALL sax(OpenAD_lin_239, __deriv__(T01), __deriv__(Y3))
      ...
      CALL sax(OpenAD_lin_245, __deriv__(T01), __deriv__(Y4))
      ...
      CALL sax(OpenAD_lin_251, __deriv__(T01), __deriv__(Y5))
      ...
      CALL sax(OpenAD_lin_231, __deriv__(T01), __deriv__(Y1))
