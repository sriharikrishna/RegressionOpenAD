...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_6 * OpenAD_Symbol_1)
        CALL sax(1 _w2f__i8,FLDNOW(3),OpenAD_Symbol_74)
        CALL saxpy(-1 _w2f__i8,FLDNOW(1),OpenAD_Symbol_74)
        CALL sax(OpenAD_Symbol_72,OpenAD_Symbol_74,DFLDDT(1))
     ...
     >  OpenAD_Symbol_20 * OpenAD_Symbol_15)
        CALL sax(1 _w2f__i8,FLDNOW(1),OpenAD_Symbol_77)
        CALL saxpy(-1 _w2f__i8,FLDNOW(2),OpenAD_Symbol_77)
        CALL sax(OpenAD_Symbol_75,OpenAD_Symbol_77,DFLDDT(2))
        ...
        CALL sax(1 _w2f__i8,FLDNOW(2),OpenAD_Symbol_79)
        CALL saxpy(-1 _w2f__i8,FLDNOW(3),OpenAD_Symbol_79)
        CALL sax(OpenAD_Symbol_78,OpenAD_Symbol_79,DFLDDT(3))
      ELSE
     ...
     >  OpenAD_Symbol_44 * OpenAD_Symbol_39)
        CALL sax(1 _w2f__i8,FLDNOW(2),OpenAD_Symbol_82)
        CALL saxpy(-1 _w2f__i8,FLDNOW(1),OpenAD_Symbol_82)
        CALL sax(OpenAD_Symbol_80,OpenAD_Symbol_82,DFLDDT(1))
     ...
     >  OpenAD_Symbol_58 * OpenAD_Symbol_53)
        CALL sax(1 _w2f__i8,FLDNOW(3),OpenAD_Symbol_85)
        CALL saxpy(-1 _w2f__i8,FLDNOW(2),OpenAD_Symbol_85)
        CALL sax(OpenAD_Symbol_83,OpenAD_Symbol_85,DFLDDT(2))
     ...
     > -1_w2f__i8)))
        CALL sax(1 _w2f__i8,FLDNOW(1),OpenAD_Symbol_87)
        CALL saxpy(-1 _w2f__i8,FLDNOW(3),OpenAD_Symbol_87)
        CALL sax(OpenAD_Symbol_86,OpenAD_Symbol_87,DFLDDT(3))
      ENDIF
      DO L = 1, 3, 1
