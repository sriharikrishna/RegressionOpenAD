...
C$OPENAD XXX Template ad_template.f
     ...
     >  UVELLOC * OpenAD_Symbol_11)
        ...
        OpenAD_acc_1 = (INT((-1_w2f__i8)) * OpenAD_Symbol_9 *
...
C       $OpenAD$ INLINE push(subst)
     ...
     >  UVELLOC * OpenAD_Symbol_25)
        ...
        OpenAD_acc_3 = (INT((-1_w2f__i8)) * OpenAD_Symbol_23 *
...
C       $OpenAD$ INLINE push_i(subst)
     ...
     >  UVELLOC * OpenAD_Symbol_49)
        ...
        OpenAD_acc_5 = (OpenAD_Symbol_51 * INT((-1_w2f__i8)) *
     >  OpenAD_Symbol_39)
        OpenAD_acc_6 = (INT((-1_w2f__i8)) * OpenAD_Symbol_47 *
...
C       $OpenAD$ INLINE push(subst)
     ...
     >  UVELLOC * OpenAD_Symbol_63)
        ...
        OpenAD_acc_7 = (OpenAD_Symbol_65 * INT((-1_w2f__i8)) *
     >  OpenAD_Symbol_53)
        OpenAD_acc_8 = (INT((-1_w2f__i8)) * OpenAD_Symbol_61 *
...
C       $OpenAD$ INLINE push(subst)
     ...
     > )
        ...
        OpenAD_acc_9 = (OpenAD_Symbol_71 * OpenAD_Symbol_67 * INT((
     > -1_w2f__i8)))
C       $OpenAD$ INLINE push(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_90, __deriv__(FLDNEW(INT(
     > OpenAD_Symbol_89))), __deriv__(DFLDDT(INT(OpenAD_Symbol_89))))
C       $OpenAD$ INLINE ZeroDeriv(subst)
        CALL ZeroDeriv(__deriv__(FLDNEW(INT(OpenAD_Symbol_89))))
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_84, __deriv__(DFLDDT(3)), __deriv__(
     > OpenAD_prop_2))
C       $OpenAD$ INLINE ZeroDeriv(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_85, __deriv__(DFLDDT(2)), __deriv__(
     > FLDNOW(2)))
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_86, __deriv__(DFLDDT(2)), __deriv__(
     > OpenAD_prop_1))
C       $OpenAD$ INLINE ZeroDeriv(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_87, __deriv__(DFLDDT(1)), __deriv__(
     > FLDNOW(1)))
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_88, __deriv__(DFLDDT(1)), __deriv__(
     > OpenAD_prop_0))
C       $OpenAD$ INLINE ZeroDeriv(subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_91, __deriv__(DFLDDT(3)), __deriv__(
     > OpenAD_prop_5))
C       $OpenAD$ INLINE ZeroDeriv(subst)
        CALL ZeroDeriv(__deriv__(DFLDDT(3)))
C       $OpenAD$ INLINE DecDeriv(subst,subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_92, __deriv__(DFLDDT(2)), __deriv__(
     > FLDNOW(2)))
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_93, __deriv__(DFLDDT(2)), __deriv__(
     > OpenAD_prop_4))
C       $OpenAD$ INLINE ZeroDeriv(subst)
        CALL ZeroDeriv(__deriv__(DFLDDT(2)))
C       $OpenAD$ INLINE DecDeriv(subst,subst)
...
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_94, __deriv__(DFLDDT(1)), __deriv__(
     > FLDNOW(1)))
C       $OpenAD$ INLINE Saxpy(subst,subst,subst)
        CALL Saxpy(OpenAD_Symbol_95, __deriv__(DFLDDT(1)), __deriv__(
     > OpenAD_prop_3))
C       $OpenAD$ INLINE ZeroDeriv(subst)
        CALL ZeroDeriv(__deriv__(DFLDDT(1)))
C       $OpenAD$ INLINE DecDeriv(subst,subst)
