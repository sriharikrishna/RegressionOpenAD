...
C$OPENAD XXX Template ad_template.f
     ...
     +bol_6*OpenAD_Symbol_1)
        ...
        CALL sax(OpenAD_Symbol_72,OpenAD_prop_0,DFLDDT(1))
     ...
     +mbol_20*OpenAD_Symbol_15)
        ...
        CALL sax(OpenAD_Symbol_74,OpenAD_prop_1,DFLDDT(2))
        CALL saxpy(OpenAD_Symbol_75,FLDNOW(2),DFLDDT(2))
        ...
        CALL sax(OpenAD_Symbol_76,OpenAD_prop_2,DFLDDT(3))
      ELSE
     ...
     +mbol_44*OpenAD_Symbol_39)
        ...
        CALL sax(OpenAD_Symbol_77,OpenAD_prop_3,DFLDDT(1))
        CALL saxpy(OpenAD_Symbol_78,FLDNOW(1),DFLDDT(1))
     ...
     +mbol_58*OpenAD_Symbol_53)
        ...
        CALL sax(OpenAD_Symbol_79,OpenAD_prop_4,DFLDDT(2))
        CALL saxpy(OpenAD_Symbol_80,FLDNOW(2),DFLDDT(2))
     ...
     +f__i8)))
        ...
        CALL sax(OpenAD_Symbol_81,OpenAD_prop_5,DFLDDT(3))
      ENDIF
      DO L = 1,3,1
