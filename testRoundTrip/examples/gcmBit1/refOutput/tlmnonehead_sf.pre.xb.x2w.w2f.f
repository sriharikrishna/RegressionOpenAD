...
C$OPENAD XXX Template ad_template.f
     ...
     > BULKMOD(I, J)))
          CALL saxpy(OpenAD_lin_22, __deriv__(S), __deriv__(BULKMOD(I,
     >  J)))
     ...
     >  J)))
          CALL saxpy(OpenAD_lin_31, __deriv__(S3O2), __deriv__(BULKMOD(
     > I, J)))
     ...
     >  J)))
          CALL saxpy(OpenAD_lin_17, __deriv__(T2), __deriv__(BULKMOD(I,
     >  J)))
          CALL saxpy(OpenAD_lin_19, __deriv__(T3), __deriv__(BULKMOD(I,
     >  J)))
          CALL saxpy(OpenAD_lin_21, __deriv__(T4), __deriv__(BULKMOD(I,
     >  J)))
          CALL saxpy(OpenAD_lin_15, __deriv__(T), __deriv__(BULKMOD(I,
     >  J)))
        END DO
      END DO
      END SUBROUTINE
