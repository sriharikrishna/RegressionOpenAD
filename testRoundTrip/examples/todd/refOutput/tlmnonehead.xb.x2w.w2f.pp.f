...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_48)
      ...
      CALL sax(OpenAD_Symbol_60,MATR(3),OBJ(1))
      CALL saxpy(OpenAD_Symbol_61,MATR(3),OBJ(1))
      CALL saxpy(OpenAD_Symbol_62,MATR(2),OBJ(1))
      CALL saxpy(OpenAD_Symbol_63,MATR(2),OBJ(1))
      CALL saxpy(OpenAD_Symbol_64,MATR(1),OBJ(1))
      CALL saxpy(OpenAD_Symbol_65,MATR(1),OBJ(1))
      CALL saxpy(OpenAD_Symbol_66,MATR(0),OBJ(1))
      CALL saxpy(OpenAD_Symbol_67,MATR(0),OBJ(1))
      CALL saxpy(OpenAD_Symbol_69,MATR(1),OBJ(1))
      CALL saxpy(OpenAD_Symbol_70,MATR(2),OBJ(1))
      CALL saxpy(OpenAD_Symbol_71,MATR(0),OBJ(1))
      CALL saxpy(OpenAD_Symbol_72,MATR(3),OBJ(1))
      END SUBROUTINE
