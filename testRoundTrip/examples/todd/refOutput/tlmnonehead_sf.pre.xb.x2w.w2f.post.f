...
C$OPENAD XXX Template ad_template.f
      ...
      CALL sax(-1_w2f__i8,X(1),OpenAD_Symbol_31)
      CALL saxpy(-1_w2f__i8,X(2),OpenAD_Symbol_31)
      ...
      CALL sax(-1_w2f__i8,X(4),OpenAD_Symbol_32)
      CALL saxpy(-1_w2f__i8,X(5),OpenAD_Symbol_32)
