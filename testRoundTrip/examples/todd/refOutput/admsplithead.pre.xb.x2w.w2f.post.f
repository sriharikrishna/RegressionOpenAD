...
C adjoint
      ...
      MATR(3)%d = MATR(3)%d+OBJ(1)%d*(OpenAD_Symbol_31)
      MATR(0)%d = MATR(0)%d+OBJ(1)%d*(OpenAD_Symbol_32)
      MATR(2)%d = MATR(2)%d+OBJ(1)%d*(OpenAD_Symbol_33)
      MATR(1)%d = MATR(1)%d+OBJ(1)%d*(OpenAD_Symbol_34)
      MATR(0)%d = MATR(0)%d+OBJ(1)%d*(OpenAD_Symbol_35)
      MATR(0)%d = MATR(0)%d+OBJ(1)%d*(OpenAD_Symbol_36)
      MATR(3)%d = MATR(3)%d+OBJ(1)%d*(OpenAD_Symbol_37)
      MATR(3)%d = MATR(3)%d+OBJ(1)%d*(OpenAD_Symbol_38)
      MATR(1)%d = MATR(1)%d+OBJ(1)%d*(OpenAD_Symbol_39)
      MATR(1)%d = MATR(1)%d+OBJ(1)%d*(OpenAD_Symbol_40)
      MATR(2)%d = MATR(2)%d+OBJ(1)%d*(OpenAD_Symbol_41)
      MATR(2)%d = MATR(2)%d+OBJ(1)%d*(OpenAD_Symbol_42)
      OBJ(1)%d = 0.0d0
      double_tape_pointer = double_tape_pointer-1
      OpenAD_Symbol_43 = double_tape(double_tape_pointer)
      OpenAD_prop_1%d = OpenAD_prop_1%d+MATR(3)%d*(OpenAD_Symbol_43)
      MATR(3)%d = 0.0d0
      ...
      OpenAD_prop_0%d = OpenAD_prop_0%d+MATR(1)%d*(OpenAD_Symbol_44)
      MATR(1)%d = 0.0d0
