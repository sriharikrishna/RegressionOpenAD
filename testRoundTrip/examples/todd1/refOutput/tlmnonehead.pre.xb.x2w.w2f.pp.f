...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_38 * OpenAD_Symbol_35)
      ...
      CALL sax(-1 _w2f__i8,X0,OpenAD_Symbol_162)
      CALL saxpy(-1 _w2f__i8,X1,OpenAD_Symbol_162)
      CALL saxpy(2.0D00,X2,OpenAD_Symbol_162)
      CALL sax(-1 _w2f__i8,X3,OpenAD_Symbol_163)
      CALL saxpy(-1 _w2f__i8,X4,OpenAD_Symbol_163)
      CALL saxpy(2.0D00,X5,OpenAD_Symbol_163)
      CALL sax(OpenAD_Symbol_2,OpenAD_Symbol_162,MATR1)
      CALL sax(OpenAD_Symbol_6,OpenAD_Symbol_163,MATR3)
      ...
      CALL sax(1 _w2f__i8,D03,F)
      CALL saxpy(1 _w2f__i8,D12,F)
      ...
      CALL setderiv(OpenAD_Symbol_172,LOC1)
      CALL sax(OpenAD_Symbol_53,F,G)
      CALL saxpy(OpenAD_Symbol_54,LOC2,G)
      CALL sax(OpenAD_Symbol_57,MATR0,ADJ_M0)
      CALL saxpy(OpenAD_Symbol_164,OpenAD_Symbol_172,ADJ_M0)
      CALL saxpy(OpenAD_Symbol_58,G,ADJ_M0)
      CALL saxpy(OpenAD_Symbol_59,MATR3,ADJ_M0)
      CALL sax(OpenAD_Symbol_61,MATR1,ADJ_M1)
      CALL saxpy(OpenAD_Symbol_165,OpenAD_Symbol_172,ADJ_M1)
      CALL saxpy(OpenAD_Symbol_166,G,ADJ_M1)
      CALL saxpy(OpenAD_Symbol_167,MATR2,ADJ_M1)
      CALL sax(OpenAD_Symbol_65,MATR2,ADJ_M2)
      CALL saxpy(OpenAD_Symbol_168,OpenAD_Symbol_172,ADJ_M2)
      CALL saxpy(OpenAD_Symbol_169,G,ADJ_M2)
      CALL saxpy(OpenAD_Symbol_170,MATR1,ADJ_M2)
      CALL sax(OpenAD_Symbol_69,MATR3,ADJ_M3)
      CALL saxpy(OpenAD_Symbol_171,OpenAD_Symbol_172,ADJ_M3)
      CALL saxpy(OpenAD_Symbol_70,G,ADJ_M3)
      CALL saxpy(OpenAD_Symbol_71,MATR0,ADJ_M3)
      CALL sax(OpenAD_Symbol_72,ADJ_M1,LOC1)
      CALL sax(1 _w2f__i8,ADJ_M0,G_OBJ1)
      CALL saxpy(-1 _w2f__i8,LOC1,G_OBJ1)
      CALL sax(2.0D00,LOC1,G_OBJ2)
      CALL sax(-1 _w2f__i8,ADJ_M0,G_OBJ0)
      CALL saxpy(-1 _w2f__i8,LOC1,G_OBJ0)
      ...
      CALL setderiv(OpenAD_Symbol_173,LOC2)
      CALL sax(OpenAD_Symbol_75,ADJ_M3,LOC1)
      CALL sax(1 _w2f__i8,ADJ_M2,G_OBJ4)
      CALL saxpy(-1 _w2f__i8,LOC1,G_OBJ4)
      CALL sax(2.0D00,LOC1,G_OBJ5)
      CALL sax(2.0D00,OpenAD_Symbol_173,LOC2)
      ...
      CALL sax(1 _w2f__i8,M02,OpenAD_Symbol_174)
      CALL saxpy(1 _w2f__i8,M13,OpenAD_Symbol_174)
      CALL sax(-1 _w2f__i8,ADJ_M2,G_OBJ3)
      CALL saxpy(-1 _w2f__i8,LOC1,G_OBJ3)
      ...
      CALL saxpy(OpenAD_Symbol_100,OpenAD_Symbol_174,D01)
      LOC1%v = (R11%v*THIRD)
      ...
      CALL sax(1 _w2f__i8,LOC1,G)
      CALL saxpy(1 _w2f__i8,R00,G)
      CALL sax(1 _w2f__i8,LOC1,H_OBJ1)
      CALL saxpy(-1 _w2f__i8,R00,H_OBJ1)
      CALL sax(1 _w2f__i8,D01,OpenAD_Symbol_175)
      CALL saxpy(OpenAD_Symbol_106,GG,OpenAD_Symbol_175)
      CALL saxpy(OpenAD_Symbol_107,M23,OpenAD_Symbol_175)
      CALL sax(OpenAD_Symbol_105,OpenAD_Symbol_175,F)
      CALL sax(1 _w2f__i8,F,H_OBJ0)
      CALL saxpy(1 _w2f__i8,G,H_OBJ0)
      CALL sax(1 _w2f__i8,G,H_OBJ3)
      CALL saxpy(-1 _w2f__i8,F,H_OBJ3)
      LOC1%v = (-(R11%v*TWO3RD))
      ...
      CALL sax(OpenAD_Symbol_176,R11,LOC1)
      CALL sax(1 _w2f__i8,LOC1,H_OBJ2)
      CALL saxpy(-1 _w2f__i8,F,H_OBJ2)
      CALL sax(1 _w2f__i8,F,H_OBJ4)
      CALL saxpy(1 _w2f__i8,LOC1,H_OBJ4)
      LOC1%v = (R00%v*THIRD)
      ...
      CALL sax(1 _w2f__i8,LOC1,G)
      CALL saxpy(1 _w2f__i8,R11,G)
      CALL sax(1 _w2f__i8,LOC1,H_OBJ16)
      CALL saxpy(-1 _w2f__i8,R11,H_OBJ16)
      CALL sax(1 _w2f__i8,D01,OpenAD_Symbol_177)
      CALL saxpy(OpenAD_Symbol_117,GG,OpenAD_Symbol_177)
      CALL saxpy(OpenAD_Symbol_118,M01,OpenAD_Symbol_177)
      CALL sax(OpenAD_Symbol_116,OpenAD_Symbol_177,F)
      CALL sax(1 _w2f__i8,F,H_OBJ15)
      CALL saxpy(1 _w2f__i8,G,H_OBJ15)
      CALL sax(1 _w2f__i8,G,H_OBJ18)
      CALL saxpy(-1 _w2f__i8,F,H_OBJ18)
      LOC1%v = (-(R00%v*TWO3RD))
      ...
      CALL sax(OpenAD_Symbol_178,R00,LOC1)
      CALL sax(1 _w2f__i8,LOC1,H_OBJ17)
      CALL saxpy(-1 _w2f__i8,F,H_OBJ17)
      CALL sax(1 _w2f__i8,F,H_OBJ19)
      CALL saxpy(1 _w2f__i8,LOC1,H_OBJ19)
      ...
      CALL sax(1 _w2f__i8,M01,OpenAD_Symbol_180)
      CALL saxpy(1 _w2f__i8,M23,OpenAD_Symbol_180)
      CALL sax(OpenAD_Symbol_124,LOC2,LOC1)
      CALL saxpy(OpenAD_Symbol_125,OpenAD_Symbol_180,LOC1)
      CALL sax(1 _w2f__i8,LOC1,R13)
      CALL saxpy(OpenAD_Symbol_126,GG,R13)
      CALL saxpy(OpenAD_Symbol_127,M02,R13)
      CALL sax(1 _w2f__i8,LOC1,R02)
      ...
      CALL sax(OpenAD_Symbol_179,R13,G)
      CALL sax(1 _w2f__i8,G,H_OBJ8)
      CALL saxpy(-1 _w2f__i8,F,H_OBJ8)
      CALL sax(1 _w2f__i8,F,H_OBJ11)
      CALL saxpy(1 _w2f__i8,G,H_OBJ11)
      F%v = (R12%v*TWOSQRT3)
      ...
      CALL setderiv(OpenAD_Symbol_181,G)
      CALL sax(OpenAD_Symbol_142,R12,F)
      CALL sax(1 _w2f__i8,OpenAD_Symbol_181,H_OBJ12)
      CALL saxpy(-1 _w2f__i8,F,H_OBJ12)
      CALL sax(1 _w2f__i8,F,H_OBJ13)
      CALL saxpy(1 _w2f__i8,OpenAD_Symbol_181,H_OBJ13)
      ...
      CALL setderiv(OpenAD_Symbol_182,G)
      CALL sax(1 _w2f__i8,R03,OpenAD_Symbol_183)
      CALL saxpy(1 _w2f__i8,R12,OpenAD_Symbol_183)
      CALL sax(OpenAD_Symbol_150,R02,G)
      CALL sax(OpenAD_Symbol_149,OpenAD_Symbol_183,F)
      CALL sax(1 _w2f__i8,OpenAD_Symbol_182,H_OBJ10)
      CALL saxpy(-1 _w2f__i8,F,H_OBJ10)
      CALL sax(1 _w2f__i8,F,H_OBJ6)
      CALL saxpy(1 _w2f__i8,OpenAD_Symbol_182,H_OBJ6)
      OpenAD_Symbol_152 = (R03%v-R12%v)
      F%v = (SQRT3*OpenAD_Symbol_152)
      OpenAD_Symbol_154 = SQRT3
      H_OBJ9%v = (G%v-F%v)
      H_OBJ7%v = (F%v+G%v)
      CALL sax(1 _w2f__i8,R03,OpenAD_Symbol_184)
      CALL saxpy(-1 _w2f__i8,R12,OpenAD_Symbol_184)
      CALL sax(OpenAD_Symbol_154,OpenAD_Symbol_184,F)
      CALL sax(1 _w2f__i8,G,H_OBJ9)
      CALL saxpy(-1 _w2f__i8,F,H_OBJ9)
      CALL sax(1 _w2f__i8,F,H_OBJ7)
