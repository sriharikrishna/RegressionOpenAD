...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_38 * OpenAD_Symbol_35)
      ...
      CALL sax(-1_w2f__i8, __deriv__(X0), __deriv__(OpenAD_Symbol_162))
      CALL saxpy(-1_w2f__i8, __deriv__(X1), __deriv__(OpenAD_Symbol_162
     > ))
      CALL saxpy(2.0D00, __deriv__(X2), __deriv__(OpenAD_Symbol_162))
      CALL sax(-1_w2f__i8, __deriv__(X3), __deriv__(OpenAD_Symbol_163))
      CALL saxpy(-1_w2f__i8, __deriv__(X4), __deriv__(OpenAD_Symbol_163
     > ))
     ...
     > (MATR3))
      ...
      CALL sax(1_w2f__i8, __deriv__(D03), __deriv__(F))
      CALL saxpy(1_w2f__i8, __deriv__(D12), __deriv__(F))
     ...
     >  __deriv__(ADJ_M3))
      ...
      CALL sax(1_w2f__i8, __deriv__(ADJ_M0), __deriv__(G_OBJ1))
      CALL saxpy(-1_w2f__i8, __deriv__(LOC1), __deriv__(G_OBJ1))
      CALL sax(2.0D00, __deriv__(LOC1), __deriv__(G_OBJ2))
      CALL sax(-1_w2f__i8, __deriv__(ADJ_M0), __deriv__(G_OBJ0))
      CALL saxpy(-1_w2f__i8, __deriv__(LOC1), __deriv__(G_OBJ0))
     ...
     >  __value__(M00))
      ...
      CALL sax(1_w2f__i8, __deriv__(ADJ_M2), __deriv__(G_OBJ4))
      CALL saxpy(-1_w2f__i8, __deriv__(LOC1), __deriv__(G_OBJ4))
      ...
      CALL sax(1_w2f__i8, __deriv__(M02), __deriv__(OpenAD_Symbol_174))
      CALL saxpy(1_w2f__i8, __deriv__(M13), __deriv__(OpenAD_Symbol_174
     > ))
      CALL sax(-1_w2f__i8, __deriv__(ADJ_M2), __deriv__(G_OBJ3))
      CALL saxpy(-1_w2f__i8, __deriv__(LOC1), __deriv__(G_OBJ3))
     ...
     > M23))
      ...
      CALL sax(1_w2f__i8, __deriv__(LOC1), __deriv__(G))
      CALL saxpy(1_w2f__i8, __deriv__(R00), __deriv__(G))
      CALL sax(1_w2f__i8, __deriv__(LOC1), __deriv__(H_OBJ1))
      CALL saxpy(-1_w2f__i8, __deriv__(R00), __deriv__(H_OBJ1))
      CALL sax(1_w2f__i8, __deriv__(D01), __deriv__(OpenAD_Symbol_175))
     ...
     >  __deriv__(F))
      CALL sax(1_w2f__i8, __deriv__(F), __deriv__(H_OBJ0))
      CALL saxpy(1_w2f__i8, __deriv__(G), __deriv__(H_OBJ0))
      CALL sax(1_w2f__i8, __deriv__(G), __deriv__(H_OBJ3))
      CALL saxpy(-1_w2f__i8, __deriv__(F), __deriv__(H_OBJ3))
      ...
      CALL sax(1_w2f__i8, __deriv__(LOC1), __deriv__(H_OBJ2))
      CALL saxpy(-1_w2f__i8, __deriv__(F), __deriv__(H_OBJ2))
      CALL sax(1_w2f__i8, __deriv__(F), __deriv__(H_OBJ4))
      CALL saxpy(1_w2f__i8, __deriv__(LOC1), __deriv__(H_OBJ4))
     ...
     > M01))
      ...
      CALL sax(1_w2f__i8, __deriv__(LOC1), __deriv__(G))
      CALL saxpy(1_w2f__i8, __deriv__(R11), __deriv__(G))
      CALL sax(1_w2f__i8, __deriv__(LOC1), __deriv__(H_OBJ16))
      CALL saxpy(-1_w2f__i8, __deriv__(R11), __deriv__(H_OBJ16))
      CALL sax(1_w2f__i8, __deriv__(D01), __deriv__(OpenAD_Symbol_177))
     ...
     >  __deriv__(F))
      CALL sax(1_w2f__i8, __deriv__(F), __deriv__(H_OBJ15))
      CALL saxpy(1_w2f__i8, __deriv__(G), __deriv__(H_OBJ15))
      CALL sax(1_w2f__i8, __deriv__(G), __deriv__(H_OBJ18))
      CALL saxpy(-1_w2f__i8, __deriv__(F), __deriv__(H_OBJ18))
      ...
      CALL sax(1_w2f__i8, __deriv__(LOC1), __deriv__(H_OBJ17))
      CALL saxpy(-1_w2f__i8, __deriv__(F), __deriv__(H_OBJ17))
      CALL sax(1_w2f__i8, __deriv__(F), __deriv__(H_OBJ19))
      CALL saxpy(1_w2f__i8, __deriv__(LOC1), __deriv__(H_OBJ19))
     ...
     >  __deriv__(LOC1))
      ...
      CALL sax(1_w2f__i8, __deriv__(G), __deriv__(H_OBJ8))
      CALL saxpy(-1_w2f__i8, __deriv__(F), __deriv__(H_OBJ8))
      CALL sax(1_w2f__i8, __deriv__(F), __deriv__(H_OBJ11))
      CALL saxpy(1_w2f__i8, __deriv__(G), __deriv__(H_OBJ11))
      ...
      CALL sax(1_w2f__i8, __deriv__(OpenAD_Symbol_181), __deriv__(
     > H_OBJ12))
      CALL saxpy(-1_w2f__i8, __deriv__(F), __deriv__(H_OBJ12))
      CALL sax(1_w2f__i8, __deriv__(F), __deriv__(H_OBJ13))
      CALL saxpy(1_w2f__i8, __deriv__(OpenAD_Symbol_181), __deriv__(
     > H_OBJ13))
      ...
      CALL sax(1_w2f__i8, __deriv__(R03), __deriv__(OpenAD_Symbol_183))
      CALL saxpy(1_w2f__i8, __deriv__(R12), __deriv__(OpenAD_Symbol_183
     > ))
      CALL sax(OpenAD_Symbol_150, __deriv__(R02), __deriv__(G))
      CALL sax(OpenAD_Symbol_149, __deriv__(OpenAD_Symbol_183),
     >  __deriv__(F))
      CALL sax(1_w2f__i8, __deriv__(OpenAD_Symbol_182), __deriv__(
     > H_OBJ10))
      CALL saxpy(-1_w2f__i8, __deriv__(F), __deriv__(H_OBJ10))
      CALL sax(1_w2f__i8, __deriv__(F), __deriv__(H_OBJ6))
      CALL saxpy(1_w2f__i8, __deriv__(OpenAD_Symbol_182), __deriv__(
     > H_OBJ6))
      ...
      CALL sax(1_w2f__i8, __deriv__(R03), __deriv__(OpenAD_Symbol_184))
      CALL saxpy(-1_w2f__i8, __deriv__(R12), __deriv__(
     > OpenAD_Symbol_184))
      CALL sax(OpenAD_Symbol_154, __deriv__(OpenAD_Symbol_184),
     >  __deriv__(F))
      CALL sax(1_w2f__i8, __deriv__(G), __deriv__(H_OBJ9))
      CALL saxpy(-1_w2f__i8, __deriv__(F), __deriv__(H_OBJ9))
      CALL sax(1_w2f__i8, __deriv__(F), __deriv__(H_OBJ7))
