...
C$OPENAD XXX Template ad_template.f
      ...
      OpenAD_tmp_0 = (__value__(X2) * 2.0D00 - __value__(X1) -
     >  __value__(X0))
      __value__(MATR1) = (SQRT3 * OpenAD_tmp_0)
      OpenAD_lin_1 = SQRT3
      __value__(MATR2) = (__value__(X4) - __value__(X3))
      OpenAD_tmp_1 = (__value__(X5) * 2.0D00 - __value__(X4) -
     >  __value__(X3))
     ...
     > LOC1))
      ...
      CALL sax(OpenAD_lin_138, __deriv__(OpenAD_prop_11), __deriv__(F))
