...
C adjoint
      ...
      G%d = G%d+H_OBJ9%d
      H_OBJ9%d = 0.0d0
      OpenAD_prop_11%d = OpenAD_prop_11%d+F%d*(OpenAD_Symbol_173)
      F%d = 0.0d0
      ...
      H_OBJ10%d = 0.0d0
      OpenAD_prop_10%d = OpenAD_prop_10%d+F%d*(OpenAD_Symbol_174)
      F%d = 0.0d0
      R02%d = R02%d+G%d*(OpenAD_Symbol_175)
      G%d = 0.0d0
      ...
      R02%d = R02%d+G%d*(OpenAD_Symbol_176)
      G%d = 0.0d0
      ...
      H_OBJ12%d = 0.0d0
      R12%d = R12%d+F%d*(OpenAD_Symbol_177)
      F%d = 0.0d0
      ...
      G%d = G%d+H_OBJ8%d
      H_OBJ8%d = 0.0d0
      R13%d = R13%d+G%d*(OpenAD_Symbol_178)
      G%d = 0.0d0
      R03%d = R03%d+F%d*(OpenAD_Symbol_179)
      F%d = 0.0d0
      M12%d = M12%d+R12%d*(OpenAD_Symbol_180)
      GG%d = GG%d+R12%d*(OpenAD_Symbol_181)
      LOC2%d = LOC2%d+R12%d*(OpenAD_Symbol_182)
      D12%d = D12%d+R12%d*(OpenAD_Symbol_183)
      R12%d = 0.0d0
      M03%d = M03%d+R03%d*(OpenAD_Symbol_184)
      GG%d = GG%d+R03%d*(OpenAD_Symbol_185)
      LOC2%d = LOC2%d+R03%d*(OpenAD_Symbol_186)
      D03%d = D03%d+R03%d*(OpenAD_Symbol_187)
      R03%d = 0.0d0
      M13%d = M13%d+R02%d*(OpenAD_Symbol_188)
      GG%d = GG%d+R02%d*(OpenAD_Symbol_189)
      LOC1%d = LOC1%d+R02%d
      R02%d = 0.0d0
      M02%d = M02%d+R13%d*(OpenAD_Symbol_190)
      GG%d = GG%d+R13%d*(OpenAD_Symbol_191)
      LOC1%d = LOC1%d+R13%d
      R13%d = 0.0d0
      OpenAD_prop_7%d = OpenAD_prop_7%d+LOC1%d*(OpenAD_Symbol_192)
      LOC2%d = LOC2%d+LOC1%d*(OpenAD_Symbol_193)
      LOC1%d = 0.0d0
      ...
      H_OBJ17%d = 0.0d0
      R00%d = R00%d+LOC1%d*(OpenAD_Symbol_194)
      LOC1%d = 0.0d0
      R00%d = R00%d+H_OBJ20%d*(OpenAD_Symbol_195)
      H_OBJ20%d = 0.0d0
      double_tape_pointer = double_tape_pointer-1
      ...
      F%d = F%d+H_OBJ15%d
      H_OBJ15%d = 0.0d0
      OpenAD_prop_6%d = OpenAD_prop_6%d+F%d*(OpenAD_Symbol_196)
      F%d = 0.0d0
      M01%d = M01%d+OpenAD_prop_6%d*(OpenAD_Symbol_197)
      GG%d = GG%d+OpenAD_prop_6%d*(OpenAD_Symbol_198)
      ...
      LOC1%d = LOC1%d+G%d
      G%d = 0.0d0
      R00%d = R00%d+LOC1%d*(OpenAD_Symbol_199)
      LOC1%d = 0.0d0
      double_tape_pointer = double_tape_pointer-1
      ...
      H_OBJ2%d = 0.0d0
      R11%d = R11%d+LOC1%d*(OpenAD_Symbol_200)
      LOC1%d = 0.0d0
      R11%d = R11%d+H_OBJ5%d*(OpenAD_Symbol_201)
      H_OBJ5%d = 0.0d0
      double_tape_pointer = double_tape_pointer-1
      ...
      F%d = F%d+H_OBJ0%d
      H_OBJ0%d = 0.0d0
      OpenAD_prop_5%d = OpenAD_prop_5%d+F%d*(OpenAD_Symbol_202)
      F%d = 0.0d0
      M23%d = M23%d+OpenAD_prop_5%d*(OpenAD_Symbol_203)
      GG%d = GG%d+OpenAD_prop_5%d*(OpenAD_Symbol_204)
      ...
      LOC1%d = LOC1%d+G%d
      G%d = 0.0d0
      R11%d = R11%d+LOC1%d*(OpenAD_Symbol_205)
      LOC1%d = 0.0d0
      double_tape_pointer = double_tape_pointer-1
      ...
      OpenAD_prop_4%d = OpenAD_prop_4%d+D01%d*(OpenAD_Symbol_206)
      LOC2%d = LOC2%d+D01%d*(OpenAD_Symbol_207)
      D01%d = 0.0d0
      M22%d = M22%d+R11%d*(OpenAD_Symbol_208)
      GG%d = GG%d+R11%d*(OpenAD_Symbol_209)
      LOC2%d = LOC2%d+R11%d*(OpenAD_Symbol_210)
      D11%d = D11%d+R11%d*(OpenAD_Symbol_211)
      R11%d = 0.0d0
      M33%d = M33%d+R00%d*(OpenAD_Symbol_212)
      GG%d = GG%d+R00%d*(OpenAD_Symbol_213)
      LOC2%d = LOC2%d+R00%d*(OpenAD_Symbol_214)
      D00%d = D00%d+R00%d*(OpenAD_Symbol_215)
      R00%d = 0.0d0
      ...
      MATR3%d = MATR3%d+M23%d*(OpenAD_Symbol_216)
      MATR2%d = MATR2%d+M23%d*(OpenAD_Symbol_217)
      M23%d = 0.0d0
      MATR3%d = MATR3%d+M13%d*(OpenAD_Symbol_218)
      MATR1%d = MATR1%d+M13%d*(OpenAD_Symbol_219)
      M13%d = 0.0d0
      MATR2%d = MATR2%d+M12%d*(OpenAD_Symbol_220)
      MATR1%d = MATR1%d+M12%d*(OpenAD_Symbol_221)
      M12%d = 0.0d0
      MATR2%d = MATR2%d+M02%d*(OpenAD_Symbol_222)
      MATR0%d = MATR0%d+M02%d*(OpenAD_Symbol_223)
      M02%d = 0.0d0
      MATR1%d = MATR1%d+M01%d*(OpenAD_Symbol_224)
      MATR0%d = MATR0%d+M01%d*(OpenAD_Symbol_225)
      M01%d = 0.0d0
      ...
      G_OBJ4%d = 0.0d0
      ADJ_M3%d = ADJ_M3%d+LOC1%d*(OpenAD_Symbol_226)
      LOC1%d = 0.0d0
      ...
      G_OBJ1%d = 0.0d0
      ADJ_M1%d = ADJ_M1%d+LOC1%d*(OpenAD_Symbol_227)
      LOC1%d = 0.0d0
      MATR0%d = MATR0%d+ADJ_M3%d*(OpenAD_Symbol_228)
      G%d = G%d+ADJ_M3%d*(OpenAD_Symbol_229)
      OpenAD_prop_2%d = OpenAD_prop_2%d+ADJ_M3%d*(OpenAD_Symbol_230)
      MATR3%d = MATR3%d+ADJ_M3%d*(OpenAD_Symbol_231)
      ADJ_M3%d = 0.0d0
      MATR1%d = MATR1%d+ADJ_M2%d*(OpenAD_Symbol_232)
      G%d = G%d+ADJ_M2%d*(OpenAD_Symbol_233)
      OpenAD_prop_2%d = OpenAD_prop_2%d+ADJ_M2%d*(OpenAD_Symbol_234)
      MATR2%d = MATR2%d+ADJ_M2%d*(OpenAD_Symbol_235)
      ADJ_M2%d = 0.0d0
      MATR2%d = MATR2%d+ADJ_M1%d*(OpenAD_Symbol_236)
      G%d = G%d+ADJ_M1%d*(OpenAD_Symbol_237)
      OpenAD_prop_2%d = OpenAD_prop_2%d+ADJ_M1%d*(OpenAD_Symbol_238)
      MATR1%d = MATR1%d+ADJ_M1%d*(OpenAD_Symbol_239)
      ADJ_M1%d = 0.0d0
      MATR3%d = MATR3%d+ADJ_M0%d*(OpenAD_Symbol_240)
      G%d = G%d+ADJ_M0%d*(OpenAD_Symbol_241)
      OpenAD_prop_2%d = OpenAD_prop_2%d+ADJ_M0%d*(OpenAD_Symbol_242)
      MATR0%d = MATR0%d+ADJ_M0%d*(OpenAD_Symbol_243)
      ADJ_M0%d = 0.0d0
      LOC2%d = LOC2%d+G%d*(OpenAD_Symbol_244)
      F%d = F%d+G%d*(OpenAD_Symbol_245)
      G%d = 0.0d0
      ...
      G%d = G%d+GG%d*(OpenAD_Symbol_246)
      GG%d = 0.0d0
      G%d = G%d+LOC2%d*(OpenAD_Symbol_247)
      LOC2%d = 0.0d0
      LOC1%d = LOC1%d+OBJ%d*(OpenAD_Symbol_248)
      F%d = F%d+OBJ%d*(OpenAD_Symbol_249)
      OBJ%d = 0.0d0
      G%d = G%d+LOC1%d*(OpenAD_Symbol_250)
      LOC1%d = 0.0d0
      D12%d = D12%d+F%d
      D03%d = D03%d+F%d
      F%d = 0.0d0
      M22%d = M22%d+D03%d*(OpenAD_Symbol_251)
      M11%d = M11%d+D03%d*(OpenAD_Symbol_252)
      D03%d = 0.0d0
      M33%d = M33%d+D12%d*(OpenAD_Symbol_253)
      M00%d = M00%d+D12%d*(OpenAD_Symbol_254)
      D12%d = 0.0d0
      MATR3%d = MATR3%d+M33%d*(OpenAD_Symbol_255)
      M33%d = 0.0d0
      MATR1%d = MATR1%d+M11%d*(OpenAD_Symbol_256)
      M11%d = 0.0d0
      ...
      M03%d = M03%d+G%d
      G%d = 0.0d0
      MATR2%d = MATR2%d+M12%d*(OpenAD_Symbol_257)
      MATR1%d = MATR1%d+M12%d*(OpenAD_Symbol_258)
      M12%d = 0.0d0
      MATR3%d = MATR3%d+M03%d*(OpenAD_Symbol_259)
      MATR0%d = MATR0%d+M03%d*(OpenAD_Symbol_260)
      M03%d = 0.0d0
      OpenAD_prop_1%d = OpenAD_prop_1%d+MATR3%d*(OpenAD_Symbol_261)
      MATR3%d = 0.0d0
      OpenAD_prop_0%d = OpenAD_prop_0%d+MATR1%d*(OpenAD_Symbol_262)
      MATR1%d = 0.0d0
      ...
      MATR2%d = MATR2%d+M22%d*(OpenAD_Symbol_263)
      M22%d = 0.0d0
      MATR0%d = MATR0%d+M00%d*(OpenAD_Symbol_264)
      M00%d = 0.0d0
      X3%d = X3%d-MATR2%d
      X4%d = X4%d+MATR2%d
      MATR2%d = 0.0d0
