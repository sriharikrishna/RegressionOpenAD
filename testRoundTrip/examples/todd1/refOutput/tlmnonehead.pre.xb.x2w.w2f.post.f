...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_38 * OpenAD_Symbol_35)
      ...
      CALL sax(-1_w2f__i8,X0,OpenAD_Symbol_162)
      CALL saxpy(-1_w2f__i8,X1,OpenAD_Symbol_162)
      CALL saxpy(2.0D00,X2,OpenAD_Symbol_162)
      CALL sax(-1_w2f__i8,X3,OpenAD_Symbol_163)
      CALL saxpy(-1_w2f__i8,X4,OpenAD_Symbol_163)
      ...
      CALL sax(1_w2f__i8,M03,G)
      CALL saxpy(-1_w2f__i8,M12,G)
      ...
      CALL sax(1_w2f__i8,D03,F)
      CALL saxpy(1_w2f__i8,D12,F)
      ...
      CALL sax(1_w2f__i8,ADJ_M0,G_OBJ1)
      CALL saxpy(-1_w2f__i8,LOC1,G_OBJ1)
      CALL sax(2.0D00,LOC1,G_OBJ2)
      CALL sax(-1_w2f__i8,ADJ_M0,G_OBJ0)
      CALL saxpy(-1_w2f__i8,LOC1,G_OBJ0)
      ...
      CALL sax(1_w2f__i8,ADJ_M2,G_OBJ4)
      CALL saxpy(-1_w2f__i8,LOC1,G_OBJ4)
      ...
      CALL sax(1_w2f__i8,M02,OpenAD_Symbol_174)
      CALL saxpy(1_w2f__i8,M13,OpenAD_Symbol_174)
      CALL sax(-1_w2f__i8,ADJ_M2,G_OBJ3)
      CALL saxpy(-1_w2f__i8,LOC1,G_OBJ3)
      ...
      CALL sax(1_w2f__i8,LOC1,G)
      CALL saxpy(1_w2f__i8,R00,G)
      CALL sax(1_w2f__i8,LOC1,H_OBJ1)
      CALL saxpy(-1_w2f__i8,R00,H_OBJ1)
      CALL sax(1_w2f__i8,D01,OpenAD_Symbol_175)
      ...
      CALL sax(1_w2f__i8,F,H_OBJ0)
      CALL saxpy(1_w2f__i8,G,H_OBJ0)
      CALL sax(1_w2f__i8,G,H_OBJ3)
      CALL saxpy(-1_w2f__i8,F,H_OBJ3)
      LOC1%v = (-(R11%v*TWO3RD))
      ...
      CALL sax(1_w2f__i8,LOC1,H_OBJ2)
      CALL saxpy(-1_w2f__i8,F,H_OBJ2)
      CALL sax(1_w2f__i8,F,H_OBJ4)
      CALL saxpy(1_w2f__i8,LOC1,H_OBJ4)
      LOC1%v = (R00%v*THIRD)
      ...
      CALL sax(1_w2f__i8,LOC1,G)
      CALL saxpy(1_w2f__i8,R11,G)
      CALL sax(1_w2f__i8,LOC1,H_OBJ16)
      CALL saxpy(-1_w2f__i8,R11,H_OBJ16)
      CALL sax(1_w2f__i8,D01,OpenAD_Symbol_177)
      ...
      CALL sax(1_w2f__i8,F,H_OBJ15)
      CALL saxpy(1_w2f__i8,G,H_OBJ15)
      CALL sax(1_w2f__i8,G,H_OBJ18)
      CALL saxpy(-1_w2f__i8,F,H_OBJ18)
      LOC1%v = (-(R00%v*TWO3RD))
      ...
      CALL sax(1_w2f__i8,LOC1,H_OBJ17)
      CALL saxpy(-1_w2f__i8,F,H_OBJ17)
      CALL sax(1_w2f__i8,F,H_OBJ19)
      CALL saxpy(1_w2f__i8,LOC1,H_OBJ19)
      ...
      CALL sax(1_w2f__i8,G,H_OBJ8)
      CALL saxpy(-1_w2f__i8,F,H_OBJ8)
      CALL sax(1_w2f__i8,F,H_OBJ11)
      CALL saxpy(1_w2f__i8,G,H_OBJ11)
      F%v = (R12%v*TWOSQRT3)
      ...
      CALL sax(1_w2f__i8,OpenAD_Symbol_181,H_OBJ12)
      CALL saxpy(-1_w2f__i8,F,H_OBJ12)
      CALL sax(1_w2f__i8,F,H_OBJ13)
      CALL saxpy(1_w2f__i8,OpenAD_Symbol_181,H_OBJ13)
      ...
      CALL sax(1_w2f__i8,R03,OpenAD_Symbol_183)
      CALL saxpy(1_w2f__i8,R12,OpenAD_Symbol_183)
      CALL sax(OpenAD_Symbol_150,R02,G)
      CALL sax(OpenAD_Symbol_149,OpenAD_Symbol_183,F)
      CALL sax(1_w2f__i8,OpenAD_Symbol_182,H_OBJ10)
      CALL saxpy(-1_w2f__i8,F,H_OBJ10)
      CALL sax(1_w2f__i8,F,H_OBJ6)
      CALL saxpy(1_w2f__i8,OpenAD_Symbol_182,H_OBJ6)
      OpenAD_Symbol_152 = (R03%v-R12%v)
      F%v = (SQRT3*OpenAD_Symbol_152)
      OpenAD_Symbol_154 = SQRT3
      H_OBJ9%v = (G%v-F%v)
      H_OBJ7%v = (F%v+G%v)
      CALL sax(1_w2f__i8,R03,OpenAD_Symbol_184)
      CALL saxpy(-1_w2f__i8,R12,OpenAD_Symbol_184)
      CALL sax(OpenAD_Symbol_154,OpenAD_Symbol_184,F)
      CALL sax(1_w2f__i8,G,H_OBJ9)
      CALL saxpy(-1_w2f__i8,F,H_OBJ9)
      CALL sax(1_w2f__i8,F,H_OBJ7)
