...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_38 * OpenAD_Symbol_35)
      ...
      CALL set_neg_deriv(OpenAD_Symbol_162,X0)
      CALL dec_deriv(OpenAD_Symbol_162,X1)
      CALL saxpy(2.0D00,X2,OpenAD_Symbol_162)
      CALL set_neg_deriv(OpenAD_Symbol_163,X3)
      CALL dec_deriv(OpenAD_Symbol_163,X4)
      ...
      CALL setderiv(OpenAD_Symbol_174,M02)
      CALL inc_deriv(OpenAD_Symbol_174,M13)
      ...
      CALL setderiv(OpenAD_Symbol_175,D01)
      ...
      CALL setderiv(OpenAD_Symbol_177,D01)
      ...
      CALL setderiv(OpenAD_Symbol_180,M01)
      CALL inc_deriv(OpenAD_Symbol_180,M23)
      ...
      CALL setderiv(H_OBJ12,OpenAD_Symbol_181)
      CALL dec_deriv(H_OBJ12,F)
      CALL setderiv(H_OBJ13,F)
      CALL inc_deriv(H_OBJ13,OpenAD_Symbol_181)
      ...
      CALL setderiv(OpenAD_Symbol_183,R03)
      CALL inc_deriv(OpenAD_Symbol_183,R12)
      CALL sax(OpenAD_Symbol_150,R02,G)
      CALL sax(OpenAD_Symbol_149,OpenAD_Symbol_183,F)
      CALL setderiv(H_OBJ10,OpenAD_Symbol_182)
      CALL dec_deriv(H_OBJ10,F)
      CALL setderiv(H_OBJ6,F)
      CALL inc_deriv(H_OBJ6,OpenAD_Symbol_182)
      OpenAD_Symbol_152 = (R03%v-R12%v)
      F%v = (SQRT3*OpenAD_Symbol_152)
      OpenAD_Symbol_154 = SQRT3
      H_OBJ9%v = (G%v-F%v)
      H_OBJ7%v = (F%v+G%v)
      CALL setderiv(OpenAD_Symbol_184,R03)
      CALL dec_deriv(OpenAD_Symbol_184,R12)
