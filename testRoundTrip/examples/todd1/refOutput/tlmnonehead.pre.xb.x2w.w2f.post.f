...
C$OPENAD XXX Template ad_template.f
     ...
     >  OpenAD_Symbol_325)
      ...
      CALL saxpy(1 _w2f__i8,OpenAD_Symbol_333,H_OBJ12)
      CALL sax(OpenAD_Symbol_142,R12,H_OBJ13)
      CALL saxpy(1 _w2f__i8,OpenAD_Symbol_333,H_OBJ13)
      ...
      CALL saxpy(1 _w2f__i8,OpenAD_Symbol_336,H_OBJ10)
      CALL sax(OpenAD_Symbol_149,R03,H_OBJ6)
      CALL saxpy(OpenAD_Symbol_149,R12,H_OBJ6)
      CALL saxpy(1 _w2f__i8,OpenAD_Symbol_336,H_OBJ6)
